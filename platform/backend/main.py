...
from routes import auth_routes, chat_routes, file_routes, session_routes, ws_routes, event_routes, approval_routes, model_routes, search_routes, plugin_routes, log_routes, debug_routes, health_routes
