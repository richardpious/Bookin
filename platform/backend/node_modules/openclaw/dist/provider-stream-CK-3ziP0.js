...
import { A as resolveProviderStreamFn } from "./provider-runtime-Cp-fJ4cK.js";
import { c as hasCopilotVisionInput, o as buildCopilotDynamicHeaders } from "./copilot-dynamic-headers-CVy4X1Kj.js";
import { n as resolveProviderEndpoint } from "./provider-attribution-87u0i3T-.js";
import { r as getModelProviderRequestTransport } from "./provider-request-config-DECw01pI.js";
import { t as MALFORMED_STREAMING_FRAGMENT_ERROR_MESSAGE } from "./assistant-error-format-CuUvHfKt.js";
import { o as calculateCost } from "./sanitize-unicode-8KnR9CZq.js";
import { c as registerApiProvider, o as getApiProvider } from "./stream-To8o5poZ.js";
import { n as getEnvApiKey } from "./env-api-keys-B9iQniXh.js";
import { n as parseStreamingJson } from "./json-parse-BXBkuUPf.js";
import { a as coerceTransportToolCallArguments, c as failTransportStream, d as sanitizeNonEmptyTransportPayloadText, f as sanitizeTransportPayloadText, i as createOpenAIResponsesTransportStreamFn, l as finalizeTransportStream, n as createAzureOpenAIResponsesTransportStreamFn, o as createEmptyTransportUsage, p as transformTransportMessages, r as createOpenAICompletionsTransportStreamFn, s as createWritableTransportEventStream, u as mergeTransportHeaders, y as buildGuardedModelFetch } from "./openai-transport-stream-N4q_7Mj8.js";
import { r as getModelProviderLocalService } from "./provider-local-service-BclndmaL.js";
import { n as applyAnthropicPayloadPolicyToParams, r as resolveAnthropicPayloadPolicy } from "./anthropic-payload-policy-BSsyaQ2H.js";
import { t as parseJsonObjectPreservingUnsafeIntegers } from "./json-unsafe-integers-DeDExjxp.js";
...
function isClaudeOpus47OrNewerModel(modelId) {
	return modelId.includes("opus-4-8") || modelId.includes("opus-4.8") || modelId.includes("opus-4-7") || modelId.includes("opus-4.7");
}
			...
			for (const block of msg.content) {
				...
				if (block.type === "thinking") {
					...
					if (!block.thinkingSignature || block.thinkingSignature.trim().length === 0) blocks.push({
						...
						const thinking = block.thinkingSignature === "reasoning_content" ? sanitizeTransportPayloadText(block.thinking) : block.thinking;
...
//#endregion
export { prepareTransportAwareSimpleModel as a, createOpenClawTransportStreamFnForModel as i, buildTransportAwareSimpleStreamFn as n, resolveTransportAwareSimpleApi as o, createBoundaryAwareStreamFnForModel as r, ensureCustomApiRegistered as s, registerProviderStreamForModel as t };
