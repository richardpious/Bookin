...
function describeSessionsSpawnTool(options) {
	const baseDescription = [
		options?.acpAvailable === false ? "Spawn clean child session; default `runtime=\"subagent\"`." : "Spawn clean child session; default `runtime=\"subagent\"`; set `runtime=\"acp\"` explicitly for ACP.",
