...
import { a as resolveMemorySlotDecision, i as resolveEffectivePluginActivationState, r as normalizePluginsConfigWithResolver } from "./manifest-registry-BSpfEroo.js";
import "./scan-paths-BJFKmVji.js";
import { i as resolveOpenClawMetadata, n as resolveHookInvocationPolicy, t as parseFrontmatter } from "./frontmatter-BAT5HzL-.js";
...
function discoverWorkspaceHookEntries(workspaceDir, opts) {
	...
	const extraDirs = normalizeTrimmedStringList(opts?.config?.hooks?.internal?.load?.extraDirs ?? []);
