...
import { n as hasBinary } from "./config-eval-ChP59_kG.js";
import { t as resolveSkillSource } from "./source-AqgLPEPN.js";
import { a as resolveSkillsInstallPreferences, i as resolveSkillConfig, n as isConfigPathTruthy, r as resolveBundledAllowlist, t as isBundledSkillAllowed } from "./config-Di7-ku4u.js";
import { p as loadSkillsFromDirSafe, s as loadWorkspaceSkillEntries } from "./workspace-CrAPndhs.js";
import { t as evaluateEntryRequirementsForCurrentPlatform } from "./entry-status-BX3E73pG.js";
import { a as resolveClawHubSkillStatusLinkSync, n as readClawHubSkillsLockfileStatusSync, s as resolveLocalSkillCardStatusSync } from "./clawhub-CZ8cBKOU.js";
...
function buildSkillStatus(entry, config, prefs, eligibility, bundledNames, agentSkillFilter, workspaceDir, clawhubLockRead) {
...
function buildWorkspaceSkillStatus(workspaceDir, opts) {
	...
	return {
		...
		agentSkillFilter,
		skills: skillEntries.map((entry) => buildSkillStatus(entry, opts?.config, prefs, opts?.eligibility, bundledContext.names, agentSkillFilter, workspaceDir, clawhubLockRead))
	};
}
//#endregion
