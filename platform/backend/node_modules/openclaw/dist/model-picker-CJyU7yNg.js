...
import { i as resolveAgentModelPrimaryValue, n as normalizeAgentModelRefForConfig, r as resolveAgentModelFallbackValues, t as normalizeAgentModelMapForConfig } from "./model-input-CET5RLn0.js";
...
import { r as normalizeConfiguredProviderCatalogModelId, t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-DKdSOt8D.js";
...
import { i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-CvzOxDnC.js";
import "./auth-profiles-AKuhPu9Q.js";
import { i as buildModelAliasIndex, r as buildConfiguredModelCatalog, v as resolveConfiguredModelRef, x as resolveModelRefFromString } from "./model-selection-shared-DIfscIiX.js";
import { n as modelKey, r as normalizeModelRef } from "./model-selection-normalize-DUxQN8bc.js";
import "./model-selection-D0756MDv.js";
import { i as runProviderCatalog, n as normalizePluginDiscoveryResult, r as resolveRuntimePluginDiscoveryProviders, t as groupPluginDiscoveryProvidersByOrder } from "./provider-discovery-BdkRZRhS.js";
import { n as createProviderAuthResolver, t as createProviderApiKeyResolver } from "./models-config.providers.secrets-CEg5Q2fF.js";
import { n as loadModelCatalog } from "./model-catalog-DtvFscuH.js";
import { r as createProviderAuthChecker } from "./model-provider-auth-DqfvEx96.js";
import { a as createLazyRuntimeSurface } from "./lazy-runtime-D-7_JraP.js";
import { n as t } from "./i18n-eLAkCRYg.js";
import { i as formatTokenK } from "./shared-Cx7BK4jP.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-NIZe-31L.js";
import { t as createModelPickerVisibleProviderPredicate } from "./model-picker-visibility-DzVys-Rr.js";
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-CmhvSoJ3.js";
import { r as resolveProviderCatalogPluginIdsForFilter } from "./list.provider-catalog-pgYV_dTf.js";
...
function resolveModelRouteHint(provider) {
	...
	if (normalized === "openai-codex") return "legacy Codex OAuth route";
}
...
function createPreferredProviderMatcher(params) {
	...
	return (entryProvider) => {
		...
		const value = !!preferredOwnerPluginIdSet && !!resolveOwningPluginIdsForProviderRef({
...
async function promptDefaultModel(params) {
	...
	const resolveConfiguredDisplayLabel = async () => {
		if (!normalizeProviderId(resolved.provider)) return configuredRaw || resolvedKey;
	...
	if (loadCatalog && browseCatalogOnDemand && allowKeep && (!preferredProvider || normalizeProviderId(resolved.provider) === preferredProvider)) {
		const options = [{
			value: KEEP_VALUE,
