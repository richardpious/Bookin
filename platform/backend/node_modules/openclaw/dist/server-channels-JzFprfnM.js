...
import { i as listChannelPlugins, r as getLoadedChannelPluginOrigin, t as getChannelPlugin } from "./registry-BjxDvA5W.js";
import { n as resolveChannelApprovalCapability } from "./plugins-vwMXgDxy.js";
...
import { r as resetDirectoryCache } from "./target-resolver-UFAReHv1.js";
import { t as CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "./approval-handler-adapter-runtime-uo1rB4v-.js";
import { a as isExecApprovalChannelRuntimeTerminalStartError } from "./approval-native-runtime-BFsx4mGS.js";
import { n as createChannelApprovalHandlerFromCapability } from "./approval-handler-runtime-8Tfe9dKJ.js";
...
import { n as withPluginHttpRouteRegistry } from "./http-registry-DNCsTeTt.js";
			...
			tasks: accountIds.map((id) => async () => {
				...
				try {
					...
					const trackedPromise = Promise.resolve().then(async () => {
						if (opts.deferAccountStartUntil) await waitForDeferredAccountStart(opts.deferAccountStartUntil, abort.signal);
