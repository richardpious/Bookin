...
import { Q as splitSetupEntries, f as createStandardChannelSetupStatus, g as createTopLevelChannelGroupPolicySetter, m as createTopLevelChannelDmPolicy, p as createTopLevelChannelAllowFromSetter, v as mergeAllowFromEntries } from "./setup-wizard-helpers-CiI5tXVx.js";
import "./setup-BMs6FJgk.js";
import "./setup-tools-Ccw0Gmgu.js";
import { _ as hasConfiguredMSTeamsCredentials, b as saveDelegatedTokens, r as formatUnknownError, y as resolveMSTeamsCredentials } from "./errors-BHyVJmPn.js";
import { c as resolveMSTeamsUserAllowlist, o as parseMSTeamsTeamEntry, s as resolveMSTeamsChannelAllowlist } from "./resolve-allowlist-CqSjqiJx.js";
	...
	finalize: async (params) => {
		...
		if (finalCreds?.type === "secret") {
			if (await params.prompter.confirm({
				...
				try {
					const { loginMSTeamsDelegated } = await import("./oauth-BZ22X1aV.js");
