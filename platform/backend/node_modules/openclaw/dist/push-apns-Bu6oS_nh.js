...
import { o as signDevicePayload, r as loadOrCreateDeviceIdentity } from "./device-identity-DtGZ-JTk.js";
import { t as normalizeHostname } from "./hostname-BH0Sas5a.js";
import { n as connectApnsHttp2Session, t as APNS_HTTP2_CANCEL_CODE } from "./push-apns-http2-BZfw4u2z.js";
...
function resolveApnsRelayConfigFromEnv(env = process.env, gatewayConfig, options = {}) {
	...
	const baseUrl = explicitBaseUrl ?? (normalizedRegistrationOrigin?.value === "https://ios-push-relay.openclaw.ai" ? "https://ios-push-relay.openclaw.ai" : void 0);
