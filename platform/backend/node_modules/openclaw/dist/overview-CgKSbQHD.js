import { d as resolveGatewayPort, s as resolveConfigPath } from "./paths-BQQu4M8v.js";
...
import { c as resolveDefaultAgentId, t as listAgentEntries } from "./agent-scope-config-CaXAl7-j.js";
import { u as readConfigFileSnapshot } from "./io-By9euW-h.js";
import "./config-Bzaup9wC.js";
import { i as resolveOpenClawReferencePaths, n as OPENCLAW_SOURCE_URL, t as OPENCLAW_DOCS_URL } from "./docs-path-DyXQ-M1b.js";
...
async function loadCrestodianOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-BFQSeMzC.js")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
