...
import { d as resolveGatewayPort, s as resolveConfigPath, y as resolveStateDir } from "./paths-BQQu4M8v.js";
import { n as VERSION } from "./version-BjFOZC7j.js";
import { a as trimToUndefined } from "./credential-planner-CT8O1NBo.js";
import "./credentials-Cn06nNty.js";
import { f as isLoopbackIpAddress } from "./ip-Y63B6JB6.js";
...
import { a as isGatewayConnectAssemblyError, n as GatewayClient, u as loadDeviceAuthToken } from "./client-5XIBFtwk.js";
import { r as loadOrCreateDeviceIdentity } from "./device-identity-DtGZ-JTk.js";
import { t as loadGatewayTlsRuntime } from "./gateway-DeyQV17O.js";
import { o as redactSensitiveUrlLikeString } from "./redact-sensitive-url-BoCSmt1u.js";
import "./message-channel-7236hqCk.js";
import { a as resolveSafeTimeoutDelayMs, i as resolvePreauthHandshakeTimeoutMs } from "./timeouts-oBZQTUc7.js";
...
import { n as resolveGatewayCredentialsWithSecretInputs } from "./credentials-secret-inputs-BNZ1OWMx.js";
import { t as canSkipGatewayConfigLoad } from "./explicit-connection-policy-B_Sx8n2Q.js";
import { a as isGatewayMethodClassified, t as CLI_DEFAULT_OPERATOR_SCOPES, u as resolveLeastPrivilegeOperatorScopesForMethod } from "./method-scopes-PftUEdXY.js";
...
function hasStoredOperatorDeviceAuthToken(deviceIdentity) {
	...
	try {
		return Boolean(gatewayCallDeps.loadDeviceAuthToken({
...
async function executeGatewayRequestWithScopes(params) {
	const { opts, scopes, url, token, password, tlsFingerprint, preauthHandshakeTimeoutMs, timeoutMs, safeTimerTimeoutMs, deviceIdentity } = params;
...
async function callGatewayWithScopes(opts, scopes) {
	...
	const deviceIdentity = opts.deviceIdentity === void 0 ? resolveDeviceIdentityForGatewayCall({
		opts,
		url,
		token,
		password
...
//#endregion
export { callGatewayCli as a, ensureExplicitGatewayAuth as c, isGatewayTransportError as d, randomIdempotencyKey as f, callGateway as i, formatGatewayTransportErrorJson as l, testing as m, GatewayTransportError as n, callGatewayLeastPrivilege as o, resolveExplicitGatewayAuth as p, buildGatewayConnectionDetails as r, callGatewayScoped as s, GatewayCredentialsRequiredError as t, isGatewayCredentialsRequiredError as u };
