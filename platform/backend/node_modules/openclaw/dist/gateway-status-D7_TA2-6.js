...
import { l as readBestEffortConfig } from "./io-By9euW-h.js";
...
import { i as resolveWideAreaDiscoveryDomain } from "./widearea-dns-DbUDsIDl.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-CL1tkDIz.js";
import { n as buildGatewayDiscoveryTarget, r as serializeGatewayDiscoveryBeacon } from "./gateway-discovery-targets-Dr7HkvAs.js";
import { t as pickGatewaySelfPresence } from "./gateway-presence-DYQNrDSw.js";
import { a as isScopeLimitedProbeFailure, c as renderTargetHeader, d as resolveTargets, f as sanitizeSshTarget, i as isProbeReachable, l as resolveAuthForTarget, n as extractConfigSummary, o as parseTimeoutMs, p as summarizeGatewayProbeCapability, r as isPostConnectProbeFailure, s as renderProbeSummaryLine, t as buildNetworkHints, u as resolveProbeBudgetMs } from "./helpers--wT_K8cZ.js";
...
function readModelPricingDegradedDetail(health) {
	if (!health || typeof health !== "object") return null;
	const modelPricing = health.modelPricing;
	if (!modelPricing || typeof modelPricing !== "object") return null;
	const record = modelPricing;
	if (record.state !== "degraded") return null;
	return typeof record.detail === "string" && record.detail.trim() ? record.detail.trim() : "pricing bootstrap or refresh failed";
}
...
const sshConfigModuleLoader = createLazyImportLoader(() => import("./ssh-config-CaYSFQ9L.js"));
const sshTunnelModuleLoader = createLazyImportLoader(() => import("./ssh-tunnel-BVuaMMau.js"));
