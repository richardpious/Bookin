...
import { d as parseStrictFiniteNumber, i as asFiniteNumberInRange } from "./number-coercion-DjYijOzx.js";
import { c as isRecord } from "./utils-DlHt_n1Q.js";
import { d as normalizeSecretInputString, s as hasConfiguredSecretInput, u as normalizeResolvedSecretInputString } from "./types.secrets-CuOz9KrZ.js";
import { n as privateFileStoreSync } from "./private-file-store-CKzSdUro.js";
import { u as isPrivateIpAddress } from "./ssrf-_PxmDk0r.js";
...
import "./secret-input-BDqwHsdT.js";
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, c as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-C6sqrjsE.js";
import "./ssrf-runtime-C5GYV25C.js";
import "./provider-http-65KY4eRc.js";
import { t as getMSTeamsRuntime } from "./runtime-api-wg477mns.js";
import { c as createMSTeamsHttpError, n as refreshMSTeamsDelegatedTokens } from "./oauth.token-CQpA67rf.js";
...
async function loadSdkModules() {
	sdkAppPromise ??= Promise.all([import("./dist-CmqLk4zC.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-BR4Mqu88.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([apps, api]) => ({
		App: apps.App,
...
//#endregion
export { tryBuildGraphSharesUrlForSharedLink as $, normalizeBotFrameworkServiceUrl as A, extractHtmlFromAttachment as B, createMSTeamsExpressAdapter as C, ensureUserAgentHeader as D, buildUserAgent as E, GRAPH_ROOT as F, isUrlAllowed as G, inferPlaceholder as H, IMG_SRC_RE as I, resolveAttachmentFetchPolicy as J, normalizeContentType as K, applyAuthorizationHeaderForUrl as L, resolveMSTeamsSdkCloudOptions as M, validateMSTeamsProactiveServiceUrlBoundary as N, describeBotFrameworkServiceUrlHost as O, ATTACHMENT_TAG_RE as P, safeHostForUrl as Q, encodeGraphShareId as R, readAccessToken as S, loadMSTeamsSdkWithAuth as T, isDownloadableAttachment as U, extractInlineImageCandidates as V, isLikelyImageAttachment as W, resolveRequestUrl as X, resolveMediaSsrfPolicy as Y, safeFetchWithPolicy as Z, hasConfiguredMSTeamsCredentials as _, searchGraphUsers as a, saveDelegatedTokens as b, fetchGraphAbsoluteUrl as c, listTeamsByName as d, normalizeQuery as f, resolveGraphToken as g, postGraphJson as h, isRevokedProxyError as i, tryNormalizeBotFrameworkServiceUrl as j, isAllowedBotFrameworkServiceUrl as k, fetchGraphJson as l, postGraphBetaJson as m, formatMSTeamsSendErrorHint as n, deleteGraphRequest as o, patchGraphJson as p, readNestedString as q, formatUnknownError as r, escapeOData as s, classifyMSTeamsSendError as t, listChannelsForTeam as u, loadDelegatedTokens as v, createMSTeamsTokenProvider as w, resolveMSTeamsStorePath as x, resolveMSTeamsCredentials as y, estimateBase64DecodedBytes as z };
