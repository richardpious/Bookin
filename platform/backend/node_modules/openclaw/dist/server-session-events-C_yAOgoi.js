...
import { c as readSessionMessageCountAsync, t as attachOpenClawTranscriptMeta } from "./session-utils.fs-clE0lv0B.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-WFl2ftAf.js";
import { c as loadSessionEntry, m as resolveGatewaySessionStoreTarget, s as loadGatewaySessionRow } from "./session-utils-CpM0p9QS.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-CKaXEZxf.js";
import { r as projectChatDisplayMessage } from "./chat-display-projection-CaLduUyF.js";
...
async function handleTranscriptUpdateBroadcast(params, update) {
	...
	if (messageSeq === void 0) {
		...
		messageSeq = entry?.sessionId ? asPositiveSafeInteger(await readSessionMessageCountAsync(entry.sessionId, storePath, entry.sessionFile)) : void 0;
	}
