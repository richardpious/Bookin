...
import { a as createProviderHttpError, f as readProviderJsonObjectResponse } from "./provider-http-errors-BEw8ykZh.js";
...
import { r as sanitizeAndNormalizeEmbedding } from "./embeddings-C9YA6RhB.js";
import { C as withRemoteHttpResponse, S as buildRemoteBaseUrlPolicy, o as debugEmbeddingsLog } from "./memory-core-host-engine-embeddings-DyeyMyeY.js";
import { n as resolveMemorySecretInputString } from "./secret-input-DJirly1z.js";
...
async function createGeminiEmbeddingProvider(options) {
	...
	const embedBatch = async (texts, options) => {
		return await embedBatchInputs(texts.map((text) => ({ text })), options);
	};
	return {
		provider: {
			id: "gemini",
