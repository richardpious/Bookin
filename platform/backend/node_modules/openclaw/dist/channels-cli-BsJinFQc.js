...
import { t as normalizeWindowsArgv } from "./windows-argv-BmImcFTu.js";
...
import { l as formatUnsupportedChannelActionMessage } from "./error-format-ZFU1PhmU.js";
...
import { a as normalizeChannelId, i as listChannelPlugins } from "./registry-BjxDvA5W.js";
...
import { t as formatCliChannelOptions } from "./channel-options-gnUyZ_zv.js";
...
const channelsCommandsLoader = createLazyImportLoader(() => import("./channels-C07sZRPb.js"));
const bundledPackageChannelMetadataLoader = createLazyImportLoader(() => import("./bundled-package-channel-metadata-h3ad8yj-.js"));
...
async function registerChannelsCli(program, argv = process.argv, options = {}) {
	...
	const addCommand = channels.command("add").description("Add or update a channel account").addHelpText("after", () => `\n${theme.heading("Examples:")}\n${formatHelpExamples([
