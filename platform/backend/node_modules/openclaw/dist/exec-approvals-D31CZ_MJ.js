...
import { o as resolveRequiredHomeDir, t as expandHomePrefix } from "./home-dir-B1vnNUyG.js";
...
import { a as resolveAllowAlwaysPatternEntries, l as analyzeShellCommand } from "./exec-approvals-allowlist-BnEOHiHh.js";
...
function commandRequiresSecurityAuditSuppressionApproval(params) {
	...
	if (sawSegmentMention) {
		...
		if (!rawAnalysis.ok) return textMentionsSecurityAuditSuppressions(params.command);
		for (const segment of rawAnalysis.segments) if (textMentionsSecurityAuditSuppressions(`${segment.raw} ${segment.argv.join(" ")}`) && !isReadOnlySecurityAuditSuppressionInspection(segment.argv)) return true;
		if (textMentionsSecurityAuditSuppressions(removeParsedSegmentText(params.command, rawAnalysis.segments))) return true;
		return false;
	}
...
//#endregion
export { resolveExecApprovals as A, recordAllowlistMatchesUse as C, requiresExecApproval as D, requireValidExecTarget as E, resolveExecModePolicy as F, resolveExecPolicyForMode as I, restoreExecApprovalsSnapshot as L, resolveExecApprovalsPath as M, resolveExecApprovalsSocketPath as N, resolveExecApprovalAllowedDecisions as O, resolveExecModeFromPolicy as P, saveExecApprovals as R, readExecApprovalsSnapshot as S, requestExecApprovalViaSocket as T, normalizeExecHost as _, addAllowlistEntry as a, normalizeExecTarget as b, ensureExecApprovals as c, loadExecApprovals as d, maxAsk as f, normalizeExecAsk as g, normalizeExecApprovals as h, EXEC_TARGET_VALUES as i, resolveExecApprovalsFromFile as j, resolveExecApprovalRequestAllowedDecisions as k, hasDurableExecApproval as l, minSecurity as m, DEFAULT_EXEC_APPROVAL_DECISIONS as n, addDurableCommandApproval as o, mergeExecApprovalsSocketDefaults as p, DEFAULT_EXEC_APPROVAL_TIMEOUT_MS as r, commandRequiresSecurityAuditSuppressionApproval as s, DEFAULT_EXEC_APPROVAL_ASK_FALLBACK as t, isExecApprovalDecisionAllowed as u, normalizeExecMode as v, recordAllowlistUse as w, persistAllowAlwaysPatterns as x, normalizeExecSecurity as y, requestJsonlSocket as z };
