...
import { n as createOutboundSendDepsFromCliSource, t as CLI_OUTBOUND_SEND_FACTORY } from "./outbound-send-mapping-Cn6QTuqa.js";
...
function resolveKnownChannelId(raw) {
	return normalizeChannelId(raw) ?? void 0;
}
...
function createDefaultDeps() {
	...
	const resolveSender = (channelId) => createLazySender(channelId, async () => {
		const { createChannelOutboundRuntimeSend } = await import("./channel-outbound-send-BF30UweL.js");
