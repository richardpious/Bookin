import { i as buildBaseOptions, n as transformMessages, o as calculateCost, s as clampThinkingLevel, t as sanitizeSurrogates } from "./sanitize-unicode-8KnR9CZq.js";
import { t as AssistantMessageEventStream } from "./event-stream-C9Fn8W_T.js";
...
import { i as resolveCloudflareBaseUrl, n as hasCopilotVisionInput, r as isCloudflareProvider, t as buildCopilotDynamicHeaders } from "./github-copilot-headers-zVCJiu45.js";
import { t as clampOpenAIPromptCacheKey } from "./openai-prompt-cache-D8Qty_Hp.js";
...
function buildParams(model, context, options, compat = getCompat(model), cacheRetention = resolveCacheRetention(options?.cacheRetention)) {
	...
	const params = {
		...
		messages,
		stream: true,
		prompt_cache_key: model.baseUrl.includes("api.openai.com") && cacheRetention !== "none" || cacheRetention === "long" && compat.supportsLongCacheRetention ? clampOpenAIPromptCacheKey(options?.promptCacheKey ?? options?.sessionId) : void 0,
...
//#endregion
export { streamOpenAICompletions as n, streamSimpleOpenAICompletions as r, convertMessages as t };
