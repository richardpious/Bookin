...
import { r as resolveAgentModelFallbackValues } from "./model-input-CET5RLn0.js";
import { a as resolveAgentEffectiveModelPrimary, u as resolveAgentModelFallbacksOverride } from "./agent-scope-BeI1SY1H.js";
import { c as parseAgentSessionKey, r as isCronRunSessionKey } from "./session-key-utils-CdfsDYvz.js";
import { l as normalizeAgentId, u as normalizeMainKey } from "./session-key-CJf5_zWs.js";
...
import { i as listThinkingLevelOptions } from "./thinking-Cq-IXzst.js";
import { d as resolveAvatarMime, i as isAvatarHttpUrl, l as isWorkspaceRelativeAvatarPath, o as isPathWithinRoot, r as isAvatarDataUrl, t as AVATAR_MAX_BYTES } from "./avatar-policy-BPKiTIGP.js";
import { E as projectPluginSessionExtensionsSync } from "./loader-wybWjJVr.js";
import { n as resolveAgentMainSessionKey } from "./main-session-BxJmPEXx.js";
import { a as resolveStoredSessionKeyForAgentStore, i as resolveSessionStoreKey, r as resolveSessionStoreAgentId } from "./session-store-key-Df5Sssw0.js";
import { s as normalizeSessionDeliveryFields } from "./delivery-context.shared-h0ups4YH.js";
import { u as resolveStorePath } from "./paths-CBJPLq30.js";
import { h as getSessionStoreCacheVersion, t as loadSessionStore } from "./store-load-BHiTqlRK.js";
import { t as buildGroupDisplayName } from "./group-7YTGeHRJ.js";
...
import "./combined-store-gateway-CilBPi5j.js";
import "./sessions-BN2mnV-J.js";
import { S as findModelCatalogEntry, l as inferUniqueProviderFromConfiguredModels, v as resolveConfiguredModelRef, w as modelSupportsInput } from "./model-selection-shared-DIfscIiX.js";
import { i as parseModelRef } from "./model-selection-normalize-DUxQN8bc.js";
...
import { i as normalizeStoredOverrideModel, s as resolveDefaultModelForAgent, u as resolvePersistedSelectedModelRef } from "./model-selection-D0756MDv.js";
import "./model-catalog-DtvFscuH.js";
import { d as readSessionTitleFieldsFromTranscript, f as readSessionTitleFieldsFromTranscriptAsync, s as readRecentSessionUsageFromTranscript } from "./session-utils.fs-clE0lv0B.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-KJS9QHF1.js";
import { a as lookupContextTokens, o as resolveContextTokensForModel } from "./context-CjLHH2E3.js";
import { A as getSubagentSessionRuntimeMs, M as resolveSubagentSessionStatus, j as getSubagentSessionStartedAt, k as shouldKeepSubagentRunChildLink } from "./subagent-registry-state-NsqwJ7zy.js";
import { a as isSubagentRunLive, i as getSessionDisplaySubagentRunByChildSessionKey, n as countActiveDescendantRuns, s as listSubagentRunsForController, t as buildSubagentRunReadIndex } from "./subagent-registry-read-B2qwYVA2.js";
import { a as resolveModelCostConfig, t as estimateUsageCost } from "./usage-format-Ddra24Lg.js";
...
function loadSessionEntry(sessionKey, opts) {
	...
	const store = loadSessionStore(storePath, opts?.clone === false ? { clone: false } : void 0);
...
function loadGatewaySessionRow(sessionKey, options) {
	...
	const { cfg, storePath, store, entry, canonicalKey } = loadSessionEntry(sessionKey, { clone: false });
...
function listSessionsFromStore(params) {
	...
	const { entries, totalCount, limitApplied, offset, nextOffset, hasMore } = selectSessionEntries({
		...
		opts,
		now,
		rowContext: typeof opts.spawnedBy === "string" && opts.spawnedBy.length > 0 || Boolean(normalizeOptionalString(opts.search)) ? getRowContext() : void 0,
