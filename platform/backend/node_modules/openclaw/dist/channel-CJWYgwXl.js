...
import { s as hasConfiguredSecretInput } from "./types.secrets-CuOz9KrZ.js";
...
import { i as resolveSessionFilePath, u as resolveStorePath } from "./paths-CBJPLq30.js";
...
import { i as createActionGate } from "./common-COS7PQnH.js";
import { i as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-h3merl20.js";
...
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-o_D7C15R.js";
...
import { E as projectConfigAccountIdWarningCollector, g as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-BHf_hSRR.js";
...
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-CiI5tXVx.js";
...
import "./account-resolution-HdjE1wCV.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-C9w9gv4K.js";
import { d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-DBuL-HPa.js";
import "./channel-status-xWbTzVy0.js";
import "./channel-config-primitives-CdBeBfAO.js";
...
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-CUQP_hRs.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-0lfSMq9J.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, m as isRecord$1, n as inspectFeishuCredentials, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-gN-DDJtv.js";
import { n as createFeishuSendReceipt } from "./send-result-DiWJi1GJ.js";
import { i as listFeishuDirectoryPeers, r as listFeishuDirectoryGroups, t as buildFeishuPresentationCard } from "./presentation-card-Drc81o__.js";
import { t as messageActionTargetAliases } from "./security-audit-hQCz6I2j.js";
import { s as resolveFeishuGroupToolPolicy } from "./policy-Dy4i6zy8.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-DBvm4E_P.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-BDycHoX8.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-CRNxBviX.js";
...
async function runScanToCreate(prompter, domain) {
	const { beginAppRegistration, initAppRegistration, pollAppRegistration, printQrCode } = await import("./app-registration-BFUzbupG.js");
	try {
...
async function runNewAppFlow(params) {
	...
	if (scanResult) {
		...
		if (appId && appSecretProbeValue) {
			const { getAppOwnerOpenId } = await import("./app-registration-BFUzbupG.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, accountId, configured }) => {
			...
			if (configured && account.configured) try {
				const { probeFeishu } = await import("./probe-CcYkhN7l.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-DQFmrKIu.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-CqGgWENi.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-B5WoSBtp.js");
