...
import { f as parseStrictInteger, m as parseStrictPositiveInteger } from "./number-coercion-DjYijOzx.js";
...
import { i as normalizeEnvVarKey, o as sanitizeHostExecEnv } from "./host-env-security-B90drdeB.js";
import { f as resolveGatewayServiceDescription, h as resolveLegacyGatewayLaunchAgentLabels, t as GATEWAY_LAUNCH_AGENT_LABEL, u as resolveGatewayLaunchAgentLabel } from "./constants-BOOZFRBo.js";
import { r as resolveHomeDir, t as resolveGatewayStateDir } from "./paths-d5v1FQxC.js";
import { l as formatPortDiagnostics, o as inspectPortUsage } from "./ports-B8kDN2an.js";
import { t as cleanStaleGatewayProcessesSync } from "./restart-stale-pids-BRk5J1_8.js";
import { t as execFileUtf8 } from "./exec-file-BJp6VFBs.js";
import { a as resolveGatewaySupervisorLogPaths, n as renderPosixRestartLogSetup } from "./restart-logs-DuwjWR_h.js";
import { i as writeFormattedLines, n as formatLine, r as toPosixPath, t as parseKeyValueOutput } from "./runtime-parse-CT7i2xgI.js";
...
function isOpenClawUpdateLaunchdLabel(label) {
...
function parseLaunchctlListOpenClawUpdateJobs(output) {
	...
	for (const rawLine of output.split(/\r?\n/)) {
		...
		if (!label.startsWith(OPENCLAW_UPDATE_LAUNCHD_LABEL_PREFIX)) continue;
...
//#endregion
export { stageLaunchAgent as _, isLaunchAgentListed as a, launchAgentPlistExists as c, readLaunchAgentProgramArguments as d, readLaunchAgentRuntime as f, restartLaunchAgent as g, resolveLaunchAgentPlistPath as h, installLaunchAgent as i, parseLaunchctlListOpenClawUpdateJobs as l, repairLaunchAgentBootstrap as m, disableOpenClawUpdateLaunchdJob as n, isLaunchAgentLoaded as o, removeOpenClawUpdateLaunchdJob as p, findStaleOpenClawUpdateLaunchdJobs as r, isOpenClawUpdateLaunchdLabel as s, disableCurrentOpenClawUpdateLaunchdJob as t, parseLaunchctlPrint as u, stopLaunchAgent as v, uninstallLaunchAgent as y };
