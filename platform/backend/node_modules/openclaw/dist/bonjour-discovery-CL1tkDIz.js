...
import { t as isTailnetIPv4 } from "./tailnet-CyU_ckBA.js";
...
async function discoverGatewayBeacons(opts = {}) {
	...
	const domains = normalizeStringEntries(domainsRaw.length > 0 ? domainsRaw : defaultDomains).map((d) => d.endsWith(".") ? d : `${d}.`);
	try {
		if (platform === "darwin") {
