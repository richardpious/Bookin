...
import { d as PluginApprovalResolutions } from "./command-registration-BWsYSY_K.js";
import { r as hasGlobalHooks } from "./hook-runner-global-BdHeqZIb.js";
import { t as stableStringify } from "./stable-stringify-TfJ9A6yH.js";
import { m as normalizeToolName } from "./tool-policy-CY4w5sXw.js";
import { f as requestDeferredPluginToolApproval, m as runBeforeToolCallHook, r as cancelDeferredPluginToolApproval, s as hasBeforeToolCallPolicy } from "./agent-tools.before-tool-call-CcOZYWx4.js";
...
import { i as runAgentHarnessBeforeAgentFinalizeHook } from "./lifecycle-hook-helpers-CtUIwz_O.js";
...
function rememberNativeHookRelayPermissionAllowAlways(key, now = Date.now()) {
	...
	permissionAllowAlwaysApprovals.set(key, { expiresAtMs: now + PERMISSION_ALLOW_ALWAYS_TTL_MS });
...
function pruneNativeHookRelayPermissionAllowAlways(now = Date.now()) {
	for (const [key, entry] of permissionAllowAlwaysApprovals) if (entry.expiresAtMs <= now) permissionAllowAlwaysApprovals.delete(key);
}
