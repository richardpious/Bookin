...
import { i as loadPluginManifest, n as PLUGIN_MANIFEST_FILENAME, o as resolvePackageExtensionEntries } from "./manifest-DaiqPlf0.js";
import { c as toSafeImportPath, n as getCachedPluginModuleLoader, t as createPluginModuleLoaderCache } from "./plugin-module-loader-cache-Cm0F2kLN.js";
import { t as buildPluginLoaderAliasMap } from "./sdk-alias-BPp2p_OO.js";
import { t as unwrapDefaultModuleExport } from "./module-export-COvD9dVR.js";
import { n as getToolPluginMetadata } from "./tool-plugin-BR3CWL-I.js";
...
async function runPluginsInitCommand(id, opts) {
...
export default defineToolPlugin({
  ...
  description: ${jsStringLiteral(`Add ${name} tools to OpenClaw.`)},
  tools: (tool) => [
    tool({
      name: "echo",
...
//#endregion
export { runPluginsBuildCommand, runPluginsInitCommand, runPluginsValidateCommand };
