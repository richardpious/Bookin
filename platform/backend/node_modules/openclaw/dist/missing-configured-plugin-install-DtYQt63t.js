...
import { c as readLegacyNpmPluginDeclaration } from "./discovery-B31QTAmU.js";
import { p as resolveUserPath } from "./utils-DlHt_n1Q.js";
import { n as VERSION } from "./version-BjFOZC7j.js";
import { l as loadInstalledPluginIndex } from "./installed-plugin-index-store-CXA8VPyK.js";
import { t as parseClawHubPluginSpec } from "./clawhub-spec-C8ZBPi5A.js";
import { i as isOpenClawOrgNpmSpec, s as parseRegistryNpmSpec } from "./npm-registry-spec-EtjA4w_n.js";
import { a as resolveDefaultPluginNpmDir, o as resolvePluginInstallDir, r as resolveDefaultPluginExtensionsDir, s as resolvePluginNpmPackageDir } from "./install-paths-P7XUTgg_.js";
import { n as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-B_NZbZil.js";
import { a as listOfficialExternalPluginCatalogEntries, c as resolveOfficialExternalPluginInstall, l as resolveOfficialExternalPluginLabel, s as resolveOfficialExternalPluginId } from "./official-external-plugin-catalog-gltTeu6n.js";
import { t as buildNpmResolutionInstallFields } from "./installs-DyaqDVZ-.js";
import { s as writePersistedInstalledPluginIndexInstallRecords } from "./installed-plugin-index-records-B68pYawc.js";
import { n as resolveWebSearchInstallCatalogEntry } from "./web-search-install-catalog-i_SxQx-n.js";
import { s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-DfXtj3dh.js";
import { n as listExplicitlyDisabledChannelIdsForConfig, r as listPotentialConfiguredChannelIds } from "./config-presence-B2zF7nja.js";
import { h as resolveConfiguredChannelPresencePolicy } from "./channel-plugin-ids-Di5PV7SC.js";
import { a as installPluginFromNpmSpec } from "./install-wil4fGpe.js";
import { r as installPluginFromClawHub, t as CLAWHUB_INSTALL_ERROR_CODE } from "./clawhub-CZvVv4cS.js";
import { r as listChannelPluginCatalogEntries } from "./catalog-B4lcqhLF.js";
import { l as resolveRegistryUpdateChannel, s as normalizeUpdateChannel } from "./update-channels-nKAynEOl.js";
import { t as buildClawHubPluginInstallRecordFields } from "./clawhub-install-records-Dv-7kghM.js";
import { n as resolveNpmInstallSpecsForUpdateChannel, t as resolveClawHubInstallSpecsForUpdateChannel } from "./install-channel-specs-ByTL5JuI.js";
import { i as updateNpmInstalledPlugins } from "./update-BWNjEkxO.js";
import { n as collectConfiguredRuntimePluginIds, t as CONFIGURED_RUNTIME_PLUGIN_INSTALL_CANDIDATES } from "./configured-runtime-plugin-installs-dgUz3lL6.js";
import { t as resolveProviderInstallCatalogEntries } from "./provider-install-catalog-CUfHvXE4.js";
import { c as shouldDeferConfiguredPluginInstallRepair, i as isLegacyPackageUpdateDoctorPass, o as isPostCoreConvergencePass } from "./update-phase-D2Gf6c_8.js";
...
function collectConfiguredPluginIds(cfg) {
...
async function repairMissingPluginInstalls(params) {
	...
	const missingRecordedPluginIds = Object.keys(records).filter((pluginId) => !deferredPluginIds.has(pluginId) && !officialReplacementPluginIds.has(pluginId) && Object.hasOwn(nextRecords, pluginId) && !bundledPluginsById.has(pluginId) && (params.pluginIds.has(pluginId) && (!knownIds.has(pluginId) || isInstalledRecordMissingOnDisk(nextRecords[pluginId], env)) || configuredPluginIdsWithStaleDescriptors.has(pluginId) || installedPluginIdsWithRepairablePackageDiagnostics.has(pluginId)));
