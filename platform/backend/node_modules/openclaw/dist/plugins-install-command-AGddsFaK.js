...
import { s as tracePluginLifecyclePhaseAsync } from "./discovery-B31QTAmU.js";
...
import { r as resolveDefaultPluginExtensionsDir } from "./install-paths-P7XUTgg_.js";
import { n as defaultRuntime } from "./runtime-yzlkhCoS.js";
import "./clawhub-eHNqclD3.js";
import { c as resolveOfficialExternalPluginInstall, n as getOfficialExternalPluginCatalogEntryForPackage, s as resolveOfficialExternalPluginId, t as getOfficialExternalPluginCatalogEntry } from "./official-external-plugin-catalog-gltTeu6n.js";
...
import { t as findBundledPluginSource } from "./bundled-sources-D0tWdEVW.js";
import { i as resolvePinnedNpmInstallRecordForCli, n as persistPluginInstall, t as persistHookPackInstall } from "./plugins-install-persist-CBYOanUq.js";
import { a as installPluginFromNpmSpec, i as installPluginFromNpmPackArchive, o as installPluginFromPath, t as PLUGIN_INSTALL_ERROR_CODE } from "./install-wil4fGpe.js";
import { a as resolveOfficialExternalNpmPackageTrust, i as resolveOfficialExternalInstallPlanBeforeNpm, r as resolveBundledInstallPlanForNpmFailure, t as resolveBundledInstallPlanBeforeNpm } from "./plugin-install-plan-C5WoKrDc.js";
import { a as formatPluginInstallWithHookFallbackError, c as parseNpmPackPrefixPath, l as parseNpmPrefixSpec, n as createHookPackInstallLogger, r as createPluginInstallLogger } from "./plugins-command-helpers-BL30aYUI.js";
...
import { o as collectChannelDoctorStaleConfigMutations } from "./channel-doctor-WJwGO4kw.js";
import { n as installHooksFromPath, t as installHooksFromNpmSpec } from "./install-D0anZYJg.js";
import { r as resolveMarketplaceInstallShortcut, t as installPluginFromMarketplace } from "./marketplace-BAebN0q2.js";
import { r as resolvePluginInstallRequestContext, t as resolvePluginInstallInvalidConfigPolicy } from "./plugin-install-config-policy-Dn2Wt7Ku.js";
...
function isAllowedPluginRecoveryIssue(issue, request) {
	...
	return issue.path === `channels.${pluginId}` && issue.message === `unknown channel id: ${pluginId}` || issue.path === "plugins.load.paths" && typeof issue.message === "string" && issue.message.includes("plugin path not found") || issue.path === "plugins" && typeof issue.message === "string" && issue.message.includes("requires compiled runtime output") || issue.path === `plugins.entries.${pluginId}` && typeof issue.message === "string" && issue.message.includes("requires compiled runtime output") || issue.path === "tools.web.search.provider" && typeof issue.message === "string" && issue.message.includes(`plugin "${pluginId}"`);
}
