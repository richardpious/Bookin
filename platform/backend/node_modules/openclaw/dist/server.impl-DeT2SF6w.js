...
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-B-C-u8eW.js";
import { m as parseStrictPositiveInteger, y as resolveIntegerOption } from "./number-coercion-DjYijOzx.js";
import { a as normalizeStateDirEnv, i as isNixMode } from "./paths-BQQu4M8v.js";
import { _ as uniqueStrings } from "./string-normalization-B8G0vlWE.js";
import { _ as sleep } from "./utils-DlHt_n1Q.js";
import { o as emitDiagnosticsTimelineEvent, s as isDiagnosticsTimelineEnabled } from "./plugin-metadata-snapshot-E7-VfWD1.js";
import { t as clearPluginMetadataLifecycleCaches } from "./plugin-metadata-lifecycle-BqWfg4Sp.js";
import { E as runWithDiagnosticTraceContext, _ as createDiagnosticTraceContext, c as isDiagnosticsEnabled, m as setDiagnosticsEnabledForProcess } from "./diagnostic-events-CNGydBWO.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-Blo0_rG4.js";
import { S as setCurrentPluginMetadataSnapshot } from "./plugin-registry-ChAglW1O.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-DhFvfS89.js";
import { t as isContainerEnvironment } from "./container-environment-CNsJSTpY.js";
import { _ as resolveRequestClientIp, i as isLoopbackHost, m as resolveGatewayListenHosts } from "./net-ziAus6sd.js";
import { a as createAuthRateLimiter } from "./auth-rate-limit-Bzh1zP1i.js";
import { n as resolveGatewayAuth } from "./auth-resolve-DdAjlmrG.js";
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-DdBhe_0j.js";
import { A as applyConfigOverrides, c as promoteConfigSnapshotToLastKnownGood, i as getRuntimeConfig, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-By9euW-h.js";
import { v as setRuntimeConfigSnapshot } from "./runtime-snapshot-D93_HOsR.js";
import { n as isRestartEnabled } from "./commands.flags-DfmpOAvt.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-DeyQV17O.js";
import { n as createCoreGatewayMethodDescriptors, r as isCoreGatewayMethodClassified, s as listCoreGatewayMethodNames, t as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./core-descriptors-B9yUgJ17.js";
...
import { h as setPreRestartDeferralCheck, m as setGatewaySigusr1RestartPolicy } from "./restart-5nDaAeZf.js";
import { n as readGatewayRestartHandoffSync } from "./restart-handoff-CqlfBc5a.js";
import { d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry } from "./runtime-BjnrbaLv.js";
import { i as createPluginGatewayMethodDescriptors, n as createGatewayMethodRegistry, t as createGatewayMethodDescriptorsFromHandlers } from "./registry-BQNtQhdh.js";
import { i as resolveMainSessionKey } from "./main-session-BxJmPEXx.js";
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-9B2VTqqn.js";
import "./sessions-BN2mnV-J.js";
import { a as enqueueSystemEvent } from "./system-events-Br-JdvCt.js";
import { b as startDiagnosticHeartbeat, x as stopDiagnosticHeartbeat } from "./diagnostic-w1vyIc20.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-C4T_uTKE.js";
import { u as getActiveEmbeddedRunCount } from "./run-state-CEI7vFgP.js";
import { l as getTotalQueueSize } from "./command-queue-CEKftuSQ.js";
import { o as resolveCronStorePath } from "./store-ged8z1Y5.js";
import { a as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-state-DQeWLTXc.js";
import { o as setFallbackGatewayContextResolver } from "./server-plugins-qi9voc5q.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-CaTZukRA.js";
import { c as recordGatewayRestartTraceDetail, d as resumeGatewayRestartTraceFromHandoff, i as finishGatewayRestartTrace, l as recordGatewayRestartTraceSpan, n as collectGatewayProcessMemoryUsageMb, u as resumeGatewayRestartTraceFromEnv } from "./restart-trace-CgBhUjAl.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-DkbKZvAw.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-BoneJR2Q.js";
...
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-CJgq7Rnr.js";
import { t as createDefaultDeps } from "./deps-CoFdmf-Y.js";
import { c as setDefaultSecurityHeaders, r as sendGatewayAuthFailure } from "./http-common-CwhGjb6n.js";
import { t as GatewayLockError } from "./gateway-lock-CQtNAMgg.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DK96hUTt.js";
...
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-COFviwtU.js";
...
import { a as createToolEventRecipientRegistry, n as createChatRunState } from "./server-chat-state-B4ta4USz.js";
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-BKJXhSn0.js";
import { t as resolveGatewayPluginConfig } from "./runtime-plugin-config-Cw9e0yRU.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-DoGY94v9.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-BR4_5TnE.js";
import { n as isProtectedPluginRoutePathFromContext, r as resolvePluginRoutePathContext } from "./route-match-DdHHDhWl.js";
import { n as shouldEnforceGatewayAuthForPluginPath } from "./route-auth-2fSSQYKc.js";
import { t as findMatchingPluginNodeCapabilityRoute } from "./route-capability-JvhTvVhw.js";
...
function createLazyGatewayCronState(params) {
	...
	const load = async () => {
		...
		loading ??= import("./server-cron-Caezxfyu.js").then(({ buildGatewayCronService }) => {
			loaded = {
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-ubCGkgrH.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-DljA2UeC.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-B3sNCwMc.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-ddJH9V94.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-DAb-wKP6.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-CFQp2Ygn.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-UfISLcRT.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-CTiR3qEM.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-EzvNutQ0.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-DShl5aVG.js");
	return toolsInvokeHttpModulePromise;
}
function getPluginNodeCapabilityAuthModule() {
	pluginNodeCapabilityAuthModulePromise ??= import("./plugin-node-capability-auth-qo0THRNh.js");
	return pluginNodeCapabilityAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-Bj1-D_Jy.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-JyE4-mem.js");
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-BKv5iYlI.js");
		...
		const handlePluginRequest = async (req, res, pathContext, dispatchContext) => {
			...
			if (!loadedPluginRequestHandler) {
				const { createGatewayPluginRequestHandler } = await import("./plugins-http-fknJrCeJ.js");
		...
		const handlePluginUpgrade = async (req, socket, head, pathContext, dispatchContext) => {
			...
			if (!loadedPluginUpgradeHandler) {
				const { createGatewayPluginUpgradeHandler } = await import("./plugins-http-fknJrCeJ.js");
...
async function resetModelCatalogCacheForTest() {
	const { resetModelCatalogCacheForTest } = await import("./server-model-catalog-CPpFtM5A.js");
...
function loadGatewayStartupEarlyModule() {
	gatewayStartupEarlyModulePromise ??= import("./server-startup-early-BOhJYVj7.js");
	return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
	gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-QDsxyKXR.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-CBqi4-bE.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
function getStartupChannelRuntime() {
	cachedStartupChannelRuntimePromise ??= import("./channel-runtime-contexts-DSGgF6V2.js").then(({ createChannelRuntimeContextRegistry }) => ({ runtimeContexts: createChannelRuntimeContextRegistry() }));
	return cachedStartupChannelRuntimePromise;
}
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-4aiSjb43.js");
...
const loadGatewayModelCatalog = async (...args) => {
	gatewayModelCatalogModulePromise ??= import("./server-model-catalog-CPpFtM5A.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-CSBNunf6.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-CvcCKm1O.js");
	return runSetupWizard(...args);
};
async function startGatewayServer(port = 18789, opts = {}) {
	normalizeStateDirEnv(process.env);
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-D93DIIA2.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-BUDgV8bK.js");
	let startupPluginsModulePromise = null;
	const loadStartupPluginsModule = () => {
		startupPluginsModulePromise ??= import("./server-startup-plugins-D_H2cpj9.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-B0cDvLSx.js");
	...
	const { createChannelManager } = await import("./server-channels-JzFprfnM.js");
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-DovZQApS.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, { startGatewayRuntimeServices }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-CpkBf_bp.js"), import("./server-runtime-startup-services-DQsjVOCb.js")]));
		...
		const { execApprovalManager, pluginApprovalManager, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
			const [{ createGatewayAuxHandlers }, { coreGatewayHandlers }] = await Promise.all([import("./server-aux-handlers-BcQOWgC6.js"), import("./server-methods-CYUClo_p.js")]);
			return {
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-BW0lwP8r.js"),
				import("./server-plugin-bootstrap-LMoo7JGw.js"),
				import("./services-DViTSACM.js")
			]);
		...
		const gatewayRequestContext = await startupTrace.measure("gateway.request-context", async () => {
			const { createGatewayRequestContext } = await import("./server-request-context-DrlcKs-I.js");
		...
		if (!minimalTestGateway) {
			if (runtimePluginsLoaded && deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-LMoo7JGw.js");
		...
		const [{ attachGatewayWsHandlers }, { listPluginNodeCapabilities }] = await startupTrace.measure("gateway.ws-imports", () => Promise.all([import("./server-ws-runtime-DPH87r7H.js"), import("./route-capability-BX66WOI0.js")]));
		...
		const loadScheduledServicesModule = () => {
			scheduledServicesModulePromise ??= import("./server-runtime-services-d_D0Opi0.js");
		...
		activateScheduledServicesWhenReady();
		const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-4pMoRutv.js");
