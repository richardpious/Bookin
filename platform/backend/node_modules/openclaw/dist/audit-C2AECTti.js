...
import { s as resolveConfigPath, y as resolveStateDir } from "./paths-BQQu4M8v.js";
...
import { a as inspectPathPermissions, i as formatPermissionRemediation, r as formatPermissionDetail } from "./permissions-ya3cPkFH.js";
...
import { i as normalizeTrustedSafeBinDirs, o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-DhmCkPW8.js";
import { i as resolveSandboxConfigForAgent } from "./config-BKz2zzZH.js";
import { l as isInterpreterLikeAllowlistPattern } from "./risks-DUUficc3.js";
import { d as loadExecApprovals, f as maxAsk, j as resolveExecApprovalsFromFile, m as minSecurity } from "./exec-approvals-D31CZ_MJ.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-B2Vo6A-F.js";
import { r as collectCoreInsecureOrDangerousFlags } from "./dangerous-config-flags-current-Dzsdybe1.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-DEOXC79n.js";
...
import { t as resolveGatewayAuthTokenSourceConflict } from "./auth-token-source-conflict-BT31OgU_.js";
import { t as collectExecFilesystemPolicyDriftHits } from "./exec-filesystem-policy-DhhwQnVL.js";
...
async function loadReadOnlyChannelPlugins() {
	readOnlyChannelPluginsModulePromise ??= import("./read-only-DbAMbKzT.js");
...
function collectExecRuntimeFindings(cfg) {
	...
	if (claudePermissionModeHits.length > 0 && yoloExecScopeIds.length > 0) findings.push({
		...
		remediation: "Restrict OpenClaw tools.exec.security/tools.exec.ask, or remove the Claude --permission-mode override."
	});
