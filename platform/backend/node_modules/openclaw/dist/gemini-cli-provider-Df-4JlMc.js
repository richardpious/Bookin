...
import { r as fetchGeminiUsage } from "./provider-usage-D9kJuaS0.js";
import { r as parseGoogleUsageToken, t as formatGoogleOauthApiKey } from "./oauth-token-shared-CoMPC_uM.js";
import { t as GOOGLE_GEMINI_PROVIDER_HOOKS } from "./provider-hooks-DcS8W63c.js";
import { n as resolveGoogleGeminiForwardCompatModel, t as isModernGoogleModel } from "./provider-models-Dx-26sU4.js";
...
function buildGoogleGeminiCliProvider() {
	return {
		...
		refreshOAuth: async (cred) => {
			const { refreshGeminiCliOAuthToken } = await import("./extensions/google/oauth.runtime.js");
