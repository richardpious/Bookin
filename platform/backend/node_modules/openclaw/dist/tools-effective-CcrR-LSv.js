...
import { a as resolveAgentDir, n as listAgentIds, o as resolveAgentWorkspaceDir } from "./agent-scope-config-CaXAl7-j.js";
import { a as logWarn, t as logDebug } from "./logger-9dl1njHh.js";
import { g as resolveRuntimeConfigCacheKey } from "./runtime-snapshot-D93_HOsR.js";
import "./config-Bzaup9wC.js";
import { Ri as ErrorCodes, Un as validateToolsEffectiveParams, t as formatValidationErrors, zi as errorShape } from "./src-S72EdpgG.js";
import { n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-BjnrbaLv.js";
...
import { c as loadSessionEntry, v as resolveSessionModelRef } from "./session-utils-CpM0p9QS.js";
import { l as resolveSessionMcpConfigSummary, s as peekSessionMcpRuntime } from "./agent-bundle-mcp-runtime-n24dxm4C.js";
import { t as buildBundleMcpToolsFromCatalog } from "./agent-bundle-mcp-materialize-BvdX-mc8.js";
...
import { n as resolveEffectiveToolInventoryRuntimeModelContext, r as buildEffectiveToolInventoryGroups, t as resolveEffectiveToolInventory } from "./tools-effective-inventory-B0ZRGCla.js";
//#region src/agents/tools-effective-mcp-inventory.ts
const BUNDLE_MCP_PLUGIN_ID = "bundle-mcp";
function resolveMcpToolLabel(tool) {
...
function disambiguateLabels(entries) {
	...
	return entries.map((entry) => {
		...
		return {
			...entry,
			label: `${entry.label} (${entry.pluginId ?? entry.id})`
		};
	});
}
