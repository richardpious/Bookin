...
import { n as parseTcpPort } from "./tcp-port-BZQpVl6Z.js";
import { i as formatErrorMessage } from "./errors-AAwmFBlx.js";
import { _ as uniqueStrings, d as normalizeTrimmedStringList, l as normalizeStringEntries } from "./string-normalization-B8G0vlWE.js";
import { p as resolveThreadSessionKeys$1 } from "./session-key-CJf5_zWs.js";
import { Nn as record, Rn as string, Tn as object, Xn as union, Zn as unknown } from "./schemas-Del5uzR8.js";
...
import { t as countOutboundMedia, u as isReasoningReplyPayload } from "./reply-payload-swpu2tGD.js";
import { n as createDebugProxyWebSocketAgent, r as resolveDebugProxySettings } from "./env-CE6Ioijc.js";
...
import { k as resolveChannelStreamingPreviewToolProgress, s as formatChannelProgressDraftLineForEntry } from "./streaming-Bv78t77e.js";
...
import { n as captureWsEvent } from "./runtime-BymPI_-h.js";
import "./proxy-capture-Cag43gJA.js";
import "./routing-Dn3BGi2k.js";
import { i as formatInboundFromLabel$1 } from "./envelope-D38xWWa-.js";
...
import { d as ssrfPolicyFromPrivateNetworkOptIn, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-C6sqrjsE.js";
import "./ssrf-runtime-C5GYV25C.js";
import { t as registerPluginHttpRoute } from "./http-registry-DNCsTeTt.js";
import "./gateway-runtime-CNSNLq8Z.js";
import { t as buildModelsProviderData } from "./commands-models-DcmPRC6d.js";
import "./extension-shared-C-2MGtWA.js";
	...
	const unregisterInteractions = registerPluginHttpRoute({
		...
		handler: createMattermostInteractionHandler({
			...
			dispatchButtonClick: async (opts) => {
				...
				if (!channelInfo?.type) {
					logVerboseMessage(`mattermost: drop interaction dispatch (cannot resolve channel type for ${opts.channelId})`);
					return;
				}
				const kind = mapMattermostChannelTypeToChatType(channelInfo.type);
