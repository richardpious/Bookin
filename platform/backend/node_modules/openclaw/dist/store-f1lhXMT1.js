...
import { r as sanitizeUntrustedFileName, t as writeSiblingTempFile } from "./sibling-temp-Bp8wzam_.js";
import { i as readLocalFileSafely$1 } from "./secure-temp-dir-XAWcZnE2.js";
import { d as resolveConfigDir } from "./utils-DlHt_n1Q.js";
import { t as fileStore } from "./file-store-DaShIbht.js";
import "./fs-safe-advanced-CBe_wA_B.js";
import { g as resolvePinnedHostname } from "./ssrf-_PxmDk0r.js";
import { t as retainSafeHeadersForCrossOriginRedirect } from "./redirect-headers-22x4fu-r.js";
import { n as detectMime, r as extensionForMime } from "./mime-TnUOZVhx.js";
import { n as extnameFromAnyPath, r as nameFromAnyPath, t as basenameFromAnyPath } from "./file-name-r4prf02z.js";
...
async function saveMediaSource(source, headers, subdir = "", maxBytes = MAX_BYTES) {
	...
	if (looksLikeUrl(source)) {
		const saved = await retryAfterRecreatingDir(dir, () => writeSiblingTempFile({
			dir,
			mode: MEDIA_FILE_MODE,
			tempPrefix: `.${baseId}`,
