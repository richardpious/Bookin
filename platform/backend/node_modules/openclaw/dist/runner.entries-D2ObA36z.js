...
import { g as sortUniqueStrings, l as normalizeStringEntries } from "./string-normalization-B8G0vlWE.js";
import { m as FsSafeError } from "./path-BlG8lhgR.js";
import { S as safeFileURLToPath, r as writeExternalFileWithinRoot, v as assertNoWindowsNetworkPath, w as pathExists } from "./fs-safe-DYWmA8_q.js";
import { r as openLocalFileSafely } from "./secure-temp-dir-XAWcZnE2.js";
import { l as resolveEffectivePluginActivationState, n as createPluginActivationSource, s as normalizePluginsConfig } from "./config-state-Cz5agD6j.js";
import { t as isPluginEnabledByDefaultForPlatform } from "./default-enablement-CT7_t1ee.js";
...
import { t as buildRandomTempFilePath } from "./temp-download-CBbcJddF.js";
...
import { i as runExec } from "./exec-DuIacDCM.js";
import { a as loadManifestContractSnapshot } from "./manifest-contract-eligibility-DfXtj3dh.js";
import { n as resolveBundledPluginCompatibleLoadValues } from "./activation-context-f7pKcNCq.js";
import { r as fetchWithSsrFGuard } from "./fetch-guard-BhIEUTw7.js";
import "./local-file-access-CBe_wA_B.js";
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-TnUOZVhx.js";
import { i as mergeModelProviderRequestOverrides, l as sanitizeConfiguredModelProviderRequest, u as sanitizeConfiguredProviderRequest } from "./provider-request-config-DECw01pI.js";
import { n as estimateBase64DecodedBytes, t as canonicalizeBase64 } from "./base64-D03BM6T6.js";
import { C as runFfmpeg, s as convertHeicToJpeg } from "./media-services-v2ADmdnV.js";
import { i as readRemoteMediaBuffer, n as MediaFetchError, s as parseMediaContentLength } from "./fetch-CwUUBT5O.js";
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-DEbcUBWg.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-CVrDuklB.js";
import { n as normalizeMediaProviderId, t as normalizeMediaExecutionProviderId } from "./provider-id-CHswGupa.js";
import { t as describeImageWithModel } from "./image-runtime-DTxuW0kT.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, n as DEFAULT_MAX_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-Bx3qZVXM.js";
import { a as resolvePrompt, n as resolveMaxBytes, r as resolveMaxChars, s as resolveTimeoutMs } from "./resolve-CXTlDR-U.js";
import { n as providerOperationRetryConfig } from "./operation-retry-BuJKbGdZ.js";
import "./temp-path-Di9pB6DF.js";
import { n as executeWithApiKeyRotation, t as collectProviderApiKeysForExecution } from "./api-key-rotation-BfTbomXS.js";
import { t as applyTemplate } from "./templating-CLmjS51i.js";
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-9PPXMjbi.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-CVXGomjW.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-Ca9W9gjp.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio",
			workspaceDir: params.workspaceDir
