...
import { f as stripRuntimeContextCustomMessages } from "./internal-runtime-context-hfmw8MFR.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId, r as createQueuedTaskRun, u as startTaskRunByRunId } from "./detached-task-runtime-Dbps45ky.js";
import { n as sleepWithAbort } from "./backoff-BQ4uO4hX.js";
import { c as getQueueSize, d as isGatewayDraining, i as enqueueCommandInLane, n as GatewayDrainingError } from "./command-queue-CEKftuSQ.js";
import { l as findActiveSessionTask } from "./openclaw-tools-C1FG9NMc.js";
import { t as log } from "./logger-XoMf1uta.js";
import { g as resolveContextEngineCapabilities, n as buildAfterTurnRuntimeContextFromUsage, t as buildAfterTurnRuntimeContext } from "./attempt.prompt-helpers-BENv5V3t.js";
import { r as resolveSessionLane } from "./lanes-CVttd5qX.js";
import { c as updateTaskNotifyPolicyForOwner, i as findTaskByRunIdForOwner, n as cancelTaskByIdForOwner } from "./task-owner-access-BHCFwUAb.js";
import { n as rewriteTranscriptEntriesInSessionManager, t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-BoBMYnet.js";
...
async function disposeDeferredMaintenanceContextEngine(contextEngine) {
	try {
		...
		log.warn("context engine dispose failed after deferred maintenance", { errorMessage: formatErrorMessage(err) });
	}
}
...
//#endregion
export { finalizeHarnessContextEngineTurn as a, runContextEngineMaintenance as c, buildHarnessContextEngineRuntimeContextFromUsage as i, bootstrapHarnessContextEngine as n, isActiveHarnessContextEngine as o, buildHarnessContextEngineRuntimeContext as r, runHarnessContextEngineMaintenance as s, assembleHarnessContextEngine as t };
