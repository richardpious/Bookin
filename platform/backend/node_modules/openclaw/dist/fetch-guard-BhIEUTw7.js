...
import { c as shouldUseEnvHttpProxyForUrl, i as hasProxyEnvConfigured } from "./proxy-env-X5Pg2u1u.js";
import { t as getActiveManagedProxyLoopbackMode } from "./active-proxy-state-BBaqWhZo.js";
import { n as createHttp1EnvHttpProxyAgent, r as createHttp1ProxyAgent, t as createHttp1Agent } from "./undici-runtime-J6eEXVxH.js";
import { o as globalUndiciStreamTimeoutMs } from "./undici-global-dispatcher-CJimgdNq.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-Bu_m9NHA.js";
import { n as normalizeRequestInitHeadersForFetch, t as normalizeHeadersInitForFetch } from "./fetch-headers-D18pVzIl.js";
import { _ as resolvePinnedHostnameWithPolicy, a as createPinnedDispatcher, i as closeDispatcher, n as assertHostnameAllowedWithPolicy, p as matchesHostnameAllowlist, t as SsrFBlockedError, v as resolveSsrFPolicyForUrl } from "./ssrf-_PxmDk0r.js";
import { t as retainSafeHeadersForCrossOriginRedirect$1 } from "./redirect-headers-22x4fu-r.js";
import { r as isMockedFetch, t as fetchWithRuntimeDispatcher } from "./runtime-fetch-BN1w3I4P.js";
...
async function captureGuardedFetchExchange(params) {
	...
	const { captureHttpExchange, isDebugProxyGlobalFetchPatchInstalled } = await import("./runtime-gyNq6KXm.js");
	...
	while (true) {
		...
		try {
			...
			if (canUseTrustedEnvProxy) dispatcher = createHttp1EnvHttpProxyAgent(void 0, timeoutMs);
				...
				}) ? createPinnedDispatcher(pinned, params.dispatcherPolicy, policyForUrl, timeoutMs) : createHttp1EnvHttpProxyAgent(void 0, timeoutMs);
