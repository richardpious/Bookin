...
import { T as collectUniqueCommandDescriptors } from "./argv-htX0ehVt.js";
import { s as clampTimerTimeoutMs } from "./number-coercion-DjYijOzx.js";
...
import { t as resolveManifestActivationPluginIds } from "./activation-planner-BsDKVIOg.js";
import { c as loadOpenClawPlugins, s as loadOpenClawPluginCliRegistry } from "./loader-wybWjJVr.js";
import { F as createEmptyPluginRegistry } from "./runtime-BjnrbaLv.js";
import { i as resolvePluginRuntimeLoadContext, r as createPluginRuntimeLoaderLogger, t as buildPluginRuntimeLoadOptions } from "./load-context-CUMIxKGA.js";
import { randomUUID } from "node:crypto";
//#region src/plugins/cli-gateway-nodes-runtime.ts
function resolvePluginCliNodeInvokeGatewayTimeoutMs(timeoutMs) {
	return typeof timeoutMs === "number" && Number.isFinite(timeoutMs) && timeoutMs > 0 ? clampTimerTimeoutMs(timeoutMs + 5e3) : void 0;
}
