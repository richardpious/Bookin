...
import { b as readStringParam, g as readPositiveIntegerParam, v as readStringArrayParam } from "./common-COS7PQnH.js";
import { a as wrapWebContent } from "./external-content-DjKXXY5B.js";
import "./string-coerce-runtime-Ccm67Pxa.js";
import { _ as resolveSiteName, b as withTrustedWebSearchEndpoint, c as normalizeToIsoDate, d as readCachedSearchPayload, f as readConfiguredSecretString, g as resolveSearchTimeoutSeconds, h as resolveSearchCount, i as buildSearchCacheKey, m as resolveSearchCacheTtlMs, o as isoToPerplexityDate, p as readProviderEnvValue, s as normalizeFreshness, v as throwWebSearchApiError, x as writeCachedSearchPayload } from "./web-search-provider-common-CkaWHSsz.js";
import "./provider-web-search-DKVvnHZC.js";
import { a as isDirectPerplexityBaseUrl, i as inferPerplexityBaseUrlFromApiKey, n as PERPLEXITY_DIRECT_BASE_URL, t as DEFAULT_PERPLEXITY_BASE_URL } from "./perplexity-web-search-provider.shared-Cx3v9Hhq.js";
...
async function readPerplexityJsonResponse(response, label) {
	try {
...
async function runPerplexitySearchApi(params) {
	...
	return withTrustedWebSearchEndpoint({
		...
		return ((await readPerplexityJsonResponse(res, "Perplexity Search")).results ?? []).map((entry) => ({
...
async function runPerplexitySearch(params) {
	...
	return withTrustedWebSearchEndpoint({
		...
		const data = await readPerplexityJsonResponse(res, "Perplexity");
		return {
