...
import { Et as array, Nn as record, Rn as string, Tn as object, Zn as unknown, wn as number } from "./schemas-Del5uzR8.js";
import { r as fetchWithSsrFGuard } from "./fetch-guard-BhIEUTw7.js";
import { C as resolveChannelStreamingChunkMode, S as resolveChannelStreamingBlockEnabled, m as resolveChannelPreviewStreamMode, x as resolveChannelStreamingBlockCoalesce } from "./streaming-Bv78t77e.js";
import "./runtime-env-C4kD-NUM.js";
import "./string-coerce-runtime-Ccm67Pxa.js";
import { c as resolveMergedAccountConfig, i as hasConfiguredAccountValue, t as createAccountListHelpers } from "./account-helpers-BSPsbBAx.js";
...
const MattermostPostSchema = object({
	id: string(),
	user_id: string().nullable().optional(),
	channel_id: string().nullable().optional(),
	message: string().nullable().optional(),
	file_ids: array(string()).nullable().optional(),
	type: string().nullable().optional(),
	root_id: string().nullable().optional(),
	create_at: number().nullable().optional(),
	props: record(string(), unknown()).nullable().optional()
}).passthrough();
