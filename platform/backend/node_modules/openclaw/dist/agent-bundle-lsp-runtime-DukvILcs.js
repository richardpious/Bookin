...
import { o as sanitizeHostExecEnv } from "./host-env-security-B90drdeB.js";
...
import { n as loadEnabledBundleLspConfig } from "./bundle-lsp-D4QEDCgX.js";
import { n as resolveStdioMcpServerLaunchConfig, t as describeStdioMcpServerLaunchConfig } from "./mcp-stdio-CxRxhC__.js";
...
function parseLspMessages(buffer) {
	...
	while (true) {
		...
		const match = remaining.subarray(0, headerEnd).toString("ascii").match(/Content-Length:\s*(\d+)/i);
		if (!match) {
