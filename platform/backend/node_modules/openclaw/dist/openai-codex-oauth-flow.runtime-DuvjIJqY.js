...
import { n as resolveCodexAuthIdentity } from "./openai-codex-auth-identity-C7EgCyxJ.js";
import { n as throwIfOAuthLoginAborted, r as withOAuthLoginAbort, t as createOAuthLoginCancelledError } from "./openai-codex-oauth-abort.runtime.js";
import { n as oauthSuccessHtml, t as oauthErrorHtml } from "./openai-codex-oauth-page.runtime.js";
import { n as generatePKCE } from "./openai-codex-pkce.runtime.js";
//#region extensions/openai/openai-codex-oauth-flow.runtime.ts
/**
...
async function promptForAuthorizationCode(onPrompt, state) {
	const parsed = parseAuthorizationInput(await onPrompt({ message: "Paste the authorization code (or full redirect URL):" }));
...
function formatMissingTokenResponseFields(json) {
	...
	if (parseStrictPositiveInteger(json.expires_in) === void 0) missing.push("expires_in");
	return missing.join(", ");
}
function resolveTokenExpiresAt(expiresIn, nowMs = Date.now()) {
	const seconds = parseStrictPositiveInteger(expiresIn);
	return seconds === void 0 ? void 0 : nowMs + seconds * 1e3;
}
