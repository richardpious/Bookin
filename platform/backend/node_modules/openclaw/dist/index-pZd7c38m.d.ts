import { O as ToolResultMessage, _ as SimpleStreamOptions, a as AssistantMessageEventStreamContract, c as ImageContent, d as Model, i as AssistantMessageEvent, n as Api, s as Context, x as TextContent } from "./types-CBQ0-JNc.js";
import { n as PluginMetadataSnapshot } from "./plugin-metadata-snapshot.types-W4G1uOj7.js";
import { Br as ThinkingLevel, Cr as AgentEvent, Dr as AgentState, Er as AgentMessage, Mr as AgentToolUpdateCallback, Or as AgentTool, Vr as ToolExecutionMode, _ as CompactionSettings, _t as CustomMessage, g as CompactionResult, h as CompactionPreparation, jr as AgentToolResult, zr as StreamFn } from "./index-CGp_nQb_.js";
import { t as Agent } from "./index-D_CSjqBk.js";
import { M as SettingsManager, d as SourceInfo, i as Skill, u as ResourceDiagnostic, y as PathMetadata } from "./session-DhbOdKu0.js";
import { _ as SessionManager, d as SessionEntry, l as ReadonlySessionManager, n as CompactionEntry, t as BranchSummaryEntry } from "./session-manager-BEiQgexU.js";
import { i as OAuthProviderInterface, n as OAuthLoginCallbacks$1, r as OAuthProviderId, t as OAuthCredentials$1 } from "./types-CpYULTuR.js";
...
declare function compact(preparation: CompactionPreparation, model: Model, apiKey: string | undefined, headers?: Record<string, string>, customInstructions?: string, signal?: AbortSignal, thinkingLevel?: ThinkingLevel, streamFn?: StreamFn): Promise<CompactionResult>;
//#endregion
...
//#endregion
//#region src/agents/sessions/tools/truncate.d.ts
/**
 ...
 */
declare function findExactModelReferenceMatch(modelReference: string, availableModels: Model[]): Model | undefined;
 ...
 */
declare function parseModelPattern(pattern: string, availableModels: Model[], options?: {
 ...
 */
declare function restoreModelFromSession(savedProvider: string, savedModelId: string, currentModel: Model | undefined, shouldPrintMessages: boolean, modelRegistry: ModelRegistry): Promise<{
  model: Model | undefined;
  fallbackMessage: string | undefined;
}>;
//#endregion
export { createGrepToolDefinition as $, BashExecutorOptions as $i, RegisteredCommand as $n, BashToolDetails as $r, BeforeAgentStartEventResult as $t, createAllToolDefinitions as A, AuthStorageData as Ai, GetActiveToolsHandler as An, ToolExecutionUpdateEvent as Ar, loadProjectContextFiles as At, createWriteTool as B, compact as Bi, LsToolCallEvent as Bn, WidgetPlacement as Br, SwitchSessionHandler as Bt, CreateAgentSessionResult as C, ResolvedRequestAuth as Ci, ExtensionRuntime as Cn, SetThinkingLevelHandler as Cr, PromptOptions as Ct, ToolName as D, AuthStatus as Di, ExtensionWidgetOptions as Dn, ToolDefinition as Dr, DefaultResourceLoaderOptions as Dt, ToolDef as E, AuthCredential as Ei, ExtensionUIDialogOptions as En, ToolCallEventResult as Er, DefaultResourceLoader as Et, createReadOnlyTools as F, AppKeybinding as Fi, GrepToolResultEvent as Fn, TreePreparation as Fr, ExtensionRunner as Ft, createReadToolDefinition as G, GenerateBranchSummaryOptions as Gi, MessageStartEvent as Gn, isBashToolResult as Gr, AfterProviderResponseEvent as Gt, ReadOperations as H, prepareCompaction as Hi, MessageEndEvent as Hn, WriteToolCallEvent as Hr, discoverAndLoadExtensions as Ht, createTool as I, KeybindingsManager$1 as Ii, InputEvent as In, TurnEndEvent as Ir, ForkHandler as It, createLsTool as J, EventBus as Ji, ModelSelectSource as Jn, isGrepToolResult as Jr, AppendEntryHandler as Jt, LsOperations as K, collectEntriesForBranchSummary as Ki, MessageUpdateEvent as Kn, isEditToolResult as Kr, AgentEndEvent as Kt, createToolDefinition as L, ReadonlyFooterDataProvider as Li, InputEventResult as Ln, TurnStartEvent as Lr, NavigateTreeHandler as Lt, createCodingToolDefinitions as M, InMemoryAuthStorageBackend as Mi, GetCommandsHandler as Mn, ToolRenderResultOptions as Mr, wrapRegisteredTool as Mt, createCodingTools as N, OAuthCredential as Ni, GetThinkingLevelHandler as Nn, ToolResultEvent as Nr, wrapRegisteredTools as Nt, ToolsOptions as O, AuthStorage as Oi, FindToolCallEvent as On, ToolExecutionEndEvent as Or, ResourceExtensionPaths as Ot, createReadOnlyToolDefinitions as P, PluginModelCatalogMetadataSnapshot as Pi, GrepToolCallEvent as Pn, ToolResultEventResult as Pr, ExtensionErrorListener as Pt, createGrepTool as Q, SlashCommandSource as Qi, ReadToolResultEvent as Qn, isWriteToolResult as Qr, BeforeAgentStartEvent as Qt, WriteOperations as R, ExecOptions as Ri, InputSource as Rn, UserBashEvent as Rr, NewSessionHandler as Rt, CreateAgentSessionOptions as S, ProviderConfigInput as Si, ExtensionHandler as Sn, SetModelHandler as Sr, ParsedSkillBlock as St, Tool as T, ApiKeyCredential as Ti, ExtensionUIContext as Tn, ToolCallEvent as Tr, parseSkillBlock as Tt, ReadToolOptions as U, BranchSummaryResult as Ui, MessageRenderOptions as Un, WriteToolResultEvent as Ur, loadExtensionFromFactory as Ut, createWriteToolDefinition as V, generateSummary as Vi, LsToolResultEvent as Vn, WorkingIndicatorOptions as Vr, createExtensionRuntime as Vt, createReadTool as W, CollectEntriesResult as Wi, MessageRenderer as Wn, defineTool as Wr, loadExtensions as Wt, GrepOperations as X, createEventBus as Xi, ProviderModelConfig as Xn, isReadToolResult as Xr, BashToolCallEvent as Xt, createLsToolDefinition as Y, EventBusController as Yi, ProviderConfig as Yn, isLsToolResult as Yr, AutocompleteProviderFactory as Yt, GrepToolOptions as Z, SlashCommandInfo as Zi, ReadToolCallEvent as Zn, isToolCallEventType as Zr, BashToolResultEvent as Zt, AgentSessionServices as _, truncateHead as _i, ExtensionContextActions as _n, SessionShutdownEvent as _r, AgentSessionEvent as _t, findExactModelReferenceMatch as a, GrepToolDetails as ai, ContextUsage as an, SendMessageHandler as ar, EditOperations as at, createAgentSessionFromServices as b, BuildSystemPromptOptions as bi, ExtensionFactory as bn, SetActiveToolsHandler as br, ExtensionBindings as bt, resolveCliModel as c, LsToolInput as ci, EditToolCallEvent as cn, SessionBeforeCompactResult as cr, createEditToolDefinition as ct, AgentSessionRuntime as d, WriteToolInput as di, Extension as dn, SessionBeforeSwitchEvent as dr, BashToolOptions as dt, BashResult as ea, BashToolInput as ei, BeforeProviderRequestEvent as en, RegisteredTool as er, FindOperations as et, CreateAgentSessionRuntimeFactory as f, DEFAULT_MAX_BYTES as fi, ExtensionAPI as fn, SessionBeforeSwitchResult as fr, createBashTool as ft, AgentSessionRuntimeDiagnostic as g, formatSize as gi, ExtensionContext as gn, SessionEvent as gr, AgentSessionConfig as gt, createAgentSessionRuntime as h, TruncationResult as hi, ExtensionCommandContextActions as hn, SessionCompactEvent as hr, AgentSession as ht, ScopedModel as i, getAgentDir as ia, FindToolInput as ii, ContextEventResult as in, ResourcesDiscoverResult as ir, withFileMutationQueue as it, createAllTools as j, FileAuthStorageBackend as ji, GetAllToolsHandler as jn, ToolInfo as jr, PromptTemplate as jt, allToolNames as k, AuthStorageBackend as ki, FindToolResultEvent as kn, ToolExecutionStartEvent as kr, ResourceLoader as kt, resolveModelScope as l, ReadToolDetails as li, EditToolResultEvent as ln, SessionBeforeForkEvent as lr, BashSpawnContext as lt, SessionImportFileNotFoundError as m, TruncationOptions as mi, ExtensionCommandContext as mn, SessionBeforeTreeResult as mr, createLocalBashOperations as mt, ParsedModelResult as n, BashOperations as na, EditToolInput as ni, CompactOptions as nn, ResolvedCommand as nr, createFindTool as nt, findInitialModel as o, GrepToolInput as oi, CustomToolCallEvent as on, SendUserMessageHandler as or, EditToolOptions as ot, CreateAgentSessionRuntimeResult as p, DEFAULT_MAX_LINES as pi, ExtensionActions as pn, SessionBeforeTreeEvent as pr, createBashToolDefinition as pt, LsToolOptions as q, generateBranchSummary as qi, ModelSelectEvent as qn, isFindToolResult as qr, AgentStartEvent as qt, ResolveCliModelResult as r, VERSION as ra, FindToolDetails as ri, ContextEvent as rn, ResourcesDiscoverEvent as rr, createFindToolDefinition as rt, parseModelPattern as s, LsToolDetails as si, CustomToolResultEvent as sn, SessionBeforeCompactEvent as sr, createEditTool as st, InitialModelResult as t, executeBashWithOperations as ta, EditToolDetails as ti, BeforeProviderRequestEventResult as tn, ReplacedSessionContext as tr, FindToolOptions as tt, restoreModelFromSession as u, ReadToolInput as ui, EditorFactory as un, SessionBeforeForkResult as ur, BashSpawnHook as ut, CreateAgentSessionFromServicesOptions as v, truncateLine as vi, ExtensionError as vn, SessionStartEvent as vr, AgentSessionEventListener as vt, createAgentSession as w, clearApiKeyCache as wi, ExtensionShortcut as wn, TerminalInputHandler as wr, SessionStats as wt, createAgentSessionServices as x, ModelRegistry as xi, ExtensionFlag as xn, SetLabelHandler as xr, ModelCycleResult as xt, CreateAgentSessionServicesOptions as y, truncateTail as yi, ExtensionEvent as yn, SessionTreeEvent as yr, AgentSessionWriteLockRunner as yt, WriteToolOptions as z, ExecResult as zi, LoadExtensionsResult as zn, UserBashEventResult as zr, ShutdownHandler as zt };