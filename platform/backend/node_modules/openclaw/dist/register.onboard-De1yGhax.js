...
import { a as resolveManifestProviderOnboardAuthFlags } from "./provider-auth-choices-BrHVLAR0.js";
import { r as formatAuthChoiceChoicesForCli } from "./auth-choice-options-BIVVLEpt.js";
import { t as CORE_ONBOARD_AUTH_FLAGS } from "./onboard-core-auth-flags-CINE1eGu.js";
...
function registerOnboardCommand(program) {
	...
	command.action(async (opts, commandRuntime) => {
		const { defaultRuntime } = await import("./runtime-DRhjCMq8.js");
		await runCommandWithRuntime(defaultRuntime, async () => {
			...
			const { setupWizardCommand } = await import("./onboard-C_AKkFBZ.js");
