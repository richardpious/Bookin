import { s as normalizeSortedUniqueStringEntries } from "./string-normalization-B8G0vlWE.js";
import { f as safeRealpathSync, i as isPathInside } from "./path-BlG8lhgR.js";
import { t as discoverOpenClawPlugins } from "./discovery-B31QTAmU.js";
import { o as resolveCompatibilityHostVersion } from "./version-BjFOZC7j.js";
import { t as isBlockedObjectKey } from "./prototype-keys-gIgii6VQ.js";
import "./bundle-manifest-Cidh29dy.js";
import { t as clearPluginMetadataLifecycleCaches } from "./plugin-metadata-lifecycle-BqWfg4Sp.js";
import { m as writeJson, o as tryReadJson, p as tryReadJsonSync } from "./json-files-ruLzKqUC.js";
import { r as hasKind } from "./slots-DT22cOei.js";
import { c as resolveEffectiveEnableState, l as resolveEffectivePluginActivationState, s as normalizePluginsConfig } from "./config-state-Cz5agD6j.js";
import { t as isPluginEnabledByDefaultForPlatform } from "./default-enablement-CT7_t1ee.js";
import { t as describePluginInstallSource } from "./install-source-info-BHN13xAi.js";
import { c as resolveInstalledPluginIndexStorePath, r as loadInstalledPluginIndexInstallRecordsSync, t as clearLoadInstalledPluginIndexInstallRecordsCache } from "./installed-plugin-index-record-reader-B_NZbZil.js";
import { t as loadPluginManifestRegistry } from "./manifest-registry-BSpfEroo.js";
import { At as boolean, Et as array, Nn as record, Rn as string, Tn as object, Xn as union, Zn as unknown, dn as literal, wn as number } from "./schemas-Del5uzR8.js";
import { n as saveJsonFile } from "./json-file-1JPGtZNU.js";
import { n as safeParseWithSchema } from "./zod-parse-B4dzFRWI.js";
...
async function readPersistedInstalledPluginIndex(options = {}) {
	return parseInstalledPluginIndex(await tryReadJson(resolveInstalledPluginIndexStorePath(options)));
}
function readPersistedInstalledPluginIndexSync(options = {}) {
	return parseInstalledPluginIndex(tryReadJsonSync(resolveInstalledPluginIndexStorePath(options)));
}
...
//#endregion
export { getPluginCompatRecord as _, refreshPersistedInstalledPluginIndexSync as a, isInstalledPluginEnabled as c, collectPluginManifestCompatCodes as d, hasOptionalMissingPluginManifestFile as f, hashJson as g, fileSignatureMatches as h, refreshPersistedInstalledPluginIndex as i, loadInstalledPluginIndex as l, resolveInstalledPluginIndexPolicyHash as m, readPersistedInstalledPluginIndex as n, writePersistedInstalledPluginIndex as o, extractPluginInstallRecordsFromInstalledPluginIndex as p, readPersistedInstalledPluginIndexSync as r, getInstalledPluginRecord as s, inspectPersistedInstalledPluginIndex as t, loadInstalledPluginIndexWithDiscovery as u };
