import { i as OpenClawConfig } from "./types.openclaw-FkxG7fk3.js";
import { M as MemoryCitationsMode } from "./types.tools-BMOhx4BN.js";
import { c as ImageContent } from "./types-CBQ0-JNc.js";
import { o as ModelCompatConfig } from "./types.models-Dpw7Xleu.js";
import { _ as PromptImageOrderEntry, a as SourceReplyDeliveryMode } from "./types-D4HaPNnq2.js";
import { Er as AgentMessage, Mr as AgentToolUpdateCallback, Or as AgentTool, jr as AgentToolResult } from "./index-CGp_nQb_.js";
import { Aa as ContextEngineRuntimeContext, Bi as NormalizedUsage, Dr as CodexAppServerExtensionFactory, Er as CodexAppServerExtensionContext, Gr as AgentToolResultMiddlewareEvent, Hi as AgentRuntimePlan, La as TranscriptRewriteResult, Li as EmbeddedRunAttemptParams, Ms as ProviderRuntimeModel, Ns as ProviderRuntimePluginHandle, Ri as EmbeddedRunAttemptResult, Sa as ContextEngine, Ui as BuildAgentRuntimePlanParams, Ur as AgentToolResultMiddleware, Wr as AgentToolResultMiddlewareContext, Xr as OpenClawAgentToolResult, Zi as requestDeferredPluginToolApproval, _s as ExecToolDefaults, ka as ContextEnginePromptCacheInfo, kr as CodexAppServerToolResultEvent, qi as ToolOutcomeObserver, ss as EmbeddedRunTrigger, xa as CompactResult, ya as AssembleResult, zi as PreemptiveCompactionRoute } from "./types-BQnYToyl.js";
import { d as InboundEventKind } from "./templating-D_GiW21h.js";
import { n as SkillSnapshot } from "./types-e2DzUtW5.js";
import { s as SandboxFsBridge } from "./backend-handle.types-D7afWmft.js";
...
import { s as AuthProfileStore } from "./types-qgn2mJGT.js";
import { Dr as ToolDefinition } from "./index-pZd7c38m.js";
import { t as SubsystemLogger } from "./subsystem-CfQVin8T.js";
import { t as ModelAuthMode } from "./model-auth-BOl4YOFn.js";
import { P as PluginHookContextWindowSource, X as PluginHookLlmOutputEvent, Y as PluginHookLlmInputEvent, d as PluginHookBeforeAgentFinalizeEvent, l as PluginHookAgentContext, u as PluginHookAgentEndEvent } from "./hook-types-Cyy3i-Xg.js";
import { t as OperatorScope } from "./operator-scopes-ijAvkvEk.js";
import { s as EmbeddedAgentQueueMessageOptions } from "./runs-DFwO7RZL.js";
import { t as ProcessToolDefaults } from "./bash-tools.process-BKy5qLNB.js";
import { M as SandboxContext } from "./sandbox-DpjfK4TB.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-Bx3RWzKR.js";
...
declare function createOpenClawCodingTools(options?: {
  ...
  sessionId?: string; /** Stable run identifier for this agent invocation. */
  runId?: string; /** Diagnostic trace context for hook/log correlation during this run. */
  ...
  currentChannelId?: string; /** Normalized conversation id exposed to tool hooks. Defaults to currentChannelId. */
  hookChannelId?: string; /** Current thread timestamp for auto-threading (Slack). */
  currentThreadTs?: string; /** Current inbound message id for action fallbacks (e.g. Telegram react). */
  currentMessageId?: string | number; /** Group id for channel-level tool policy resolution. */
  ...
  runtimeToolAllowlist?: string[]; /** If true, the model has native vision capability */
  ...
  recordToolPrepStage?: (name: string) => void; /** Live observer called after wrapped tool outcomes are recorded. */
  onToolOutcome?: ToolOutcomeObserver; /** Runtime-only resolved skill paths that the read tool may load under workspaceOnly. */
...
//#endregion
export { createOpenClawCodingTools as $, buildHarnessContextEngineRuntimeContextFromUsage as A, LoadCodexBundleMcpThreadConfigParams as At, hasSandboxBindReadonlyHostShadows as B, formatPrePromptPrecheckLog as C, buildNativeHookRelayCommand as Ct, assembleHarnessContextEngine as D, resolveNativeHookRelayDeferredToolApproval as Dt, resolveCompactionTimeoutMs as E, registerNativeHookRelay as Et, createCodexAppServerToolResultExtensionRunner as F, RuntimeToolSchemaDiagnostic as G, normalizeProviderToolSchemas as H, resolveAgentHarnessBeforePromptBuildResult as I, logAgentRuntimeToolDiagnostics as J, inspectRuntimeToolInputSchemas as K, runAgentHarnessAfterCompactionHook as L, isActiveHarnessContextEngine as M, runHarnessContextEngineMaintenance as N, bootstrapHarnessContextEngine as O, testing as Ot, createAgentToolResultMiddlewareRunner as P, resolveEmbeddedAttemptToolConstructionPlan as Q, runAgentHarnessBeforeCompactionHook as R, estimateRenderedLlmBoundaryTokenPressure as S, NativeHookRelayRegistrationHandle as St, compactContextEngineWithSafetyTimeout as T, invokeNativeHookRelay as Tt, RuntimeToolInputSchemaJson as U, resolveWritableSandboxBindHostRoots as V, RuntimeToolInputSchemaProjection as W, disposeRegisteredAgentHarnesses as X, normalizeAgentRuntimeTools as Y, applyEmbeddedAttemptToolsAllow as Z, runAgentHarnessAfterToolCallHook as _, runAgentCleanupStep as _t, classifyAgentHarnessTerminalOutcome as a, filterToolResultMediaUrls as at, PREEMPTIVE_OVERFLOW_ERROR_TEXT as b, NativeHookRelayProcessResponse as bt, inferToolMetaFromArgs as c, formatToolAggregate as ct, awaitAgentHarnessAgentEndHook as d, selectDefaultNodeFromList as dt, buildEmbeddedAttemptToolRunContext as et, getAgentHarnessHookRunner as f, NodeListNode as ft, runAgentHarnessLlmOutputHook as g, log as gt, runAgentHarnessLlmInputHook as h, buildAgentRuntimePlan as ht, ToolProgressDetailMode as i, extractToolResultMediaArtifact as it, finalizeHarnessContextEngineTurn as j, buildHarnessContextEngineRuntimeContext as k, CodexBundleMcpThreadConfig as kt, loadCodexBundleMcpThreadConfig as l, listNodes as lt, runAgentHarnessBeforeAgentFinalizeHook as m, classifyEmbeddedAgentRunResultForModelFallback as mt, AgentHarnessTerminalOutcomeInput as n, resolveAttemptFsWorkspaceOnly as nt, detectAndLoadAgentHarnessPromptImages as o, isMessagingTool as ot, runAgentHarnessAgentEndHook as p, callGatewayTool as pt, projectRuntimeToolInputSchema as q, TOOL_PROGRESS_OUTPUT_MAX_CHARS as r, supportsModelTools as rt, formatToolProgressOutput as s, isMessagingToolSendAction as st, AgentHarnessTerminalOutcomeClassification as t, resolveAttemptSpawnWorkspaceDir as tt, queueAgentHarnessMessage as u, resolveNodeIdFromList as ut, runAgentHarnessBeforeMessageWriteHook as v, buildAgentHookContextChannelFields as vt, shouldPreemptivelyCompactBeforePrompt as w, hasNativeHookRelayInvocation as wt, PreemptiveCompactionDecision as x, NativeHookRelayProvider as xt, LlmBoundaryTokenPressure as y, NativeHookRelayEvent as yt, hasSandboxBindContainerPathAliases as z };