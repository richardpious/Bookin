import { c as normalizeOptionalString, o as normalizeNullableString } from "./string-coerce-DKw2K5wM.js";
...
function detectToolCallLoop(state, toolName, params, config, scope) {
	...
	if (!knownPollTool && resolvedConfig.detectors.genericRepeat && noProgressStreak >= resolvedConfig.criticalThreshold) {
