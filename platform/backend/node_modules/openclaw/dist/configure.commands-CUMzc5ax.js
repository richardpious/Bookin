import { c as normalizeOptionalString, p as readStringValue } from "./string-coerce-DKw2K5wM.js";
import { d as resolveGatewayPort, t as CONFIG_PATH } from "./paths-BQQu4M8v.js";
...
import { b as isPlainObject, g as shortenHomePath, p as resolveUserPath } from "./utils-DlHt_n1Q.js";
import { c as isSecretRef, l as isValidEnvSecretRefId } from "./types.secrets-CuOz9KrZ.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint } from "./auth-install-policy-B1jG2vqC.js";
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-_EUbsUBb.js";
...
import { s as resolvePluginContributionOwners } from "./plugin-registry-ChAglW1O.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-C5rLdYLT.js";
import { s as resolveDefaultSecretProviderAlias } from "./ref-contract-C46R_Xj3.js";
import { a as findTailscaleBinary } from "./tailscale-dAGBIFra.js";
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-By9euW-h.js";
import { t as sanitizeTerminalText } from "./safe-text-J_0sTthZ.js";
import { t as ConfigMutationConflictError } from "./mutate-DajLmhPa.js";
import { t as resolveGatewayInstallToken } from "./gateway-install-token-3JnIRkYf.js";
import { t as randomToken } from "./random-token-hQenuzDT.js";
import "./config-Bzaup9wC.js";
import { i as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-CCe-eBpT.js";
import { o as formatPortRangeHint } from "./error-format-ZFU1PhmU.js";
import { t as parsePort } from "./parse-port-DXMHNkZA.js";
import { n as listChatChannels } from "./chat-meta-CeXhGpdc.js";
import { t as resolveControlUiLinks } from "./control-ui-links-DvI8AQXt.js";
import { n as ensureAuthProfileStore } from "./store-CvzOxDnC.js";
import "./auth-profiles-AKuhPu9Q.js";
import "./workspace-BF52cjJK.js";
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-DTOeJgCP.js";
import { r as withProgress } from "./progress-Dr4m3lDw.js";
...
import { r as logConfigUpdated } from "./logging-C6Djgptg.js";
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-CxhwUu3W.js";
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-BelfoDhi.js";
import { a as outro, c as text, i as intro, n as CONFIGURE_WIZARD_SECTIONS, o as parseConfigureWizardSections, r as confirm, s as select, t as CONFIGURE_SECTION_OPTIONS } from "./configure.shared-lpUmbAfX.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DK96hUTt.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-C8vbyd8K.js";
import { n as applyAuthChoice } from "./auth-choice-lqNgFJZs.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-COaGUY9h.js";
import { i as setupChannels } from "./onboard-channels-D28WrmBP.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-B1iPBk9A.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DWdXCuXM.js";
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-CmhvSoJ3.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-CJyU7yNg.js";
import { t as applyPrimaryModel } from "./provider-model-primary-BJda4U5R.js";
import { t as promptCustomApiConfig } from "./onboard-custom-0sZf5kwt.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-Csvimba4.js";
import { n as formatHealthCheckFailure } from "./health-format-zLvQJsxG.js";
import { i as healthCommand } from "./health-qBnQetbg.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-m8VfgqNW.js";
import { t as setupSkills } from "./onboard-skills-C1C_Q_dQ.js";
...
async function promptGatewayConfig(cfg, runtime) {
	...
	if (authMode === "token") if (guardCancel(await select({
		...
		gatewayTokenForCalls = normalizeGatewayTokenInput(guardCancel(await text({
			message: "Gateway token (blank to generate)",
			initialValue: randomToken()
		}), runtime)) || randomToken();
		gatewayToken = gatewayTokenForCalls;
	}
	if (authMode === "password") gatewayPassword = normalizeOptionalString(guardCancel(await text({
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-BbjbmpEc.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-DzTyHWKc.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-CM1IZMVV.js");
