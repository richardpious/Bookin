...
import "./sandbox-paths-B5_QhWlv.js";
import { n as loadActivatedBundledPluginPublicSurfaceModuleSync } from "./facade-runtime-Bf_cVz6v.js";
...
import { n as normalizeContainerPath$1, r as relativePathEscapesContainerRoot, t as isPathInsideContainerRoot } from "./path-utils-xVgZ1OBw.js";
import { t as buildDockerExecArgs } from "./bash-tools.shared-Dnp1uHWO.js";
import { a as execDocker, i as ensureSandboxContainer, n as dockerContainerState, o as execDockerRaw, y as isExistingWorkspaceSkillMountSource } from "./docker-BGTdf1FD.js";
import { t as parseSshTarget } from "./ssh-tunnel-DBjIWXyu.js";
...
var RemoteShellSandboxFsBridge = class {
	...
	getRemoteProtectedSkillRoots() {
		const workspaceContainerRoot = normalizeContainerPath(this.runtime.remoteWorkspaceDir);
		const agentContainerRoot = normalizeContainerPath(this.runtime.remoteAgentWorkspaceDir);
		const roots = [path.posix.join(workspaceContainerRoot, "skills"), path.posix.join(workspaceContainerRoot, ".agents", "skills")];
		if (path.resolve(this.sandbox.agentWorkspaceDir) !== path.resolve(this.sandbox.workspaceDir)) roots.push(path.posix.join(agentContainerRoot, "skills"), path.posix.join(agentContainerRoot, ".agents", "skills"));
		return roots;
	}
...
//#endregion
export { resolveWritableRenameTargetsForBridge as C, buildPinnedWritePlan as D, buildPinnedRenamePlan as E, dockerSandboxBackendManager as O, resolveWritableRenameTargets as S, buildPinnedRemovePlan as T, uploadDirectoryToSshTarget as _, getSandboxBackendManager as a, parseSandboxStatSize as b, buildExecRemoteCommand as c, buildValidatedExecRemoteCommand as d, createSshSandboxSessionFromConfigText as f, shellEscape as g, runSshSandboxCommand as h, getSandboxBackendFactory as i, runDockerSandboxShellCommand as k, buildRemoteCommand as l, disposeSshSandboxSession as m, startBrowserBridgeServer as n, registerSandboxBackend as o, createSshSandboxSessionFromSettings as p, stopBrowserBridgeServer as r, requireSandboxBackendFactory as s, BROWSER_BRIDGES as t, buildSshSandboxArgv as u, createRemoteShellSandboxFsBridge as v, buildPinnedMkdirpPlan as w, createWritableRenameTargetResolver as x, parseSandboxStatMtimeMs as y };
