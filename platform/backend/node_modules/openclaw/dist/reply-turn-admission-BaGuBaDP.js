...
import { C as hasSessionAutoModelFallbackProvenance, i as markAutoFallbackPrimaryProbe, n as entryMatchesAutoFallbackPrimaryProbe, p as resolveAutoFallbackPrimaryProbe, t as clearAutoFallbackPrimaryProbeSelection } from "./agent-scope-BeI1SY1H.js";
import { n as defaultRuntime } from "./runtime-yzlkhCoS.js";
import { c as isDiagnosticsEnabled } from "./diagnostic-events-CNGydBWO.js";
import { t as createSubsystemLogger } from "./subsystem-Blo0_rG4.js";
import { r as logVerbose } from "./globals-Dc2qfZst.js";
import { o as resolveMessageChannel } from "./message-channel-normalize-mFW26rOU.js";
import { i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-7236hqCk.js";
import { u as resolveOpenAIRuntimeProvider } from "./openai-codex-routing-Cc71DT_j.js";
...
import { i as emitAgentEvent, l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-BuYtWSh4.js";
import { d as updateSessionStore } from "./store-Dh6bWvq_.js";
import { n as resolveGroupSessionKey } from "./group-7YTGeHRJ.js";
import "./sessions-BN2mnV-J.js";
import { x as resolveModelRefFromString } from "./model-selection-shared-DIfscIiX.js";
import { t as isCliProvider } from "./model-selection-cli-DLGT03Zv.js";
import { l as resolvePersistedOverrideModelRef } from "./model-selection-D0756MDv.js";
...
import { a as createReplyOperation, n as ReplyRunAlreadyActiveError, p as replyRunRegistry } from "./reply-run-registry-BYXDUcCT.js";
import { d as logSessionTurnCreated } from "./diagnostic-w1vyIc20.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripLeadingSilentToken } from "./tokens-BpOBzvOi.js";
import { c as shouldPreserveUserFacingSessionStateForInputProvenance } from "./input-provenance-DHJ0e-Wv.js";
import { o as resolveContextTokensForModel } from "./context-CjLHH2E3.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-CEKftuSQ.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-Cv2MCfJA.js";
import { d as isContextOverflowError, g as isLikelyContextOverflowError, u as isCompactionFailureError, y as isTransientHttpError } from "./errors-t09uTJ5G.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-swpu2tGD.js";
import { a as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-DdKzTF-r.js";
import "./selection-BMP-JCML.js";
import { d as stripHeartbeatToken } from "./heartbeat-dtJ8QRZo.js";
import { i as isRenderablePayload, t as applyReplyTagsToPayload } from "./reply-payloads-C0o4TQUs.js";
import "./embedded-agent-helpers-xBQcYQq8.js";
import { p as parseReplyDirectives } from "./payloads-CsNPmG7g.js";
import { f as LiveSessionModelSwitchError, o as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-DRgKirrj.js";
import { l as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-Bmy8FbCd.js";
import { h as isMessagingToolSendAction } from "./embedded-agent-subscribe.tools-mYHOvfka.js";
import { n as clearCliSession, r as getCliSessionBinding } from "./cli-session-BhuUNiMB.js";
import { t as runEmbeddedAgent } from "./embedded-agent-DqJgypM_.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-Bj5pXeSL.js";
import { n as buildAgentRuntimeOutcomePlan } from "./build-Y5Hb2lde.js";
import { i as resolveSilentReplyPolicy, n as isReplyProfilerEnabled, r as resolveCurrentTurnImages } from "./reply-timing-tracker-Cck3RAyz.js";
import { c as resolveRunAuthProfile, o as resolveQueuedReplyRuntimeConfig, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-ClDL4k5O.js";
import { t as runCliAgent } from "./cli-runner-C49sHxKb.js";
...
import { n as createBlockReplyContentKey } from "./block-reply-pipeline-Cd7X8NkH.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-tbbCQFSF.js";
...
function keepCliSessionBindingOnlyWhenReused(params) {
	...
	if (returnedSessionId) params.onDroppedReplacement?.();
	return {
		...params.result,
		meta: {
			...params.result.meta,
...
function buildMissingApiKeyFailureText(message) {
	...
	if (provider === "openai-codex") return "⚠️ The session is pointing at a stale OpenAI Codex auth route. Run `openclaw doctor --fix` to repair Codex model/session routes, restart the gateway if doctor asks, then try again. If doctor has nothing to repair or the error persists, re-auth with `openclaw models auth login --provider openai-codex` or run `openclaw configure`.";
