...
function isMessageReceivedEvent(event) {
	...
	const context = getHookContext(event);
	if (!context) return false;
	return hasStringContextField(context, "from") && hasStringContextField(context, "content") && hasStringContextField(context, "channelId");
}
function isMessageSentEvent(event) {
	if (!isHookEventTypeAndAction(event, "message", "sent")) return false;
	const context = getHookContext(event);
	if (!context) return false;
	return hasStringContextField(context, "to") && hasStringContextField(context, "content") && hasStringContextField(context, "channelId") && hasBooleanContextField(context, "success");
}
