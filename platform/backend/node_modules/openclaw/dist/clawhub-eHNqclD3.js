...
import { n as createTempDownloadTarget } from "./temp-download-CBbcJddF.js";
...
function normalizePluginApiVersionForComparator(version, target) {
	...
	return shouldPreservePluginApiPrereleaseFloor(target) ? version : normalizeCalVerCorrectionForPluginApi(version);
}
...
const OPENCLAW_CALVER_STABLE_CORRECTION_PATTERN = /^[vV]?(\d{4}\.\d{1,2}\.\d{1,2})(?:-\d+|-(?:alpha|beta|rc)\.\d+)$/i;
const OPENCLAW_CALVER_NUMERIC_CORRECTION_PATTERN = /^[vV]?(\d{4}\.\d{1,2}\.\d{1,2})-\d+$/;
function normalizeCalVerNumericCorrectionForPluginApi(pluginApiVersion) {
...
//#endregion
export { searchClawHubPackages as _, fetchClawHubPackageDetail as a, fetchClawHubSkillDetail as c, normalizeClawHubSha256Hex as d, normalizeClawHubSha256Integrity as f, satisfiesPluginApiRange as g, satisfiesGatewayMinimum as h, fetchClawHubPackageArtifact as i, fetchClawHubSkillSecurityVerdicts as l, resolveLatestVersionFromPackage as m, downloadClawHubPackageArchive as n, fetchClawHubPackageVersion as o, resolveClawHubBaseUrl as p, downloadClawHubSkillArchive as r, fetchClawHubSkillCard as s, ClawHubRequestError as t, fetchClawHubSkillVerification as u, searchClawHubSkills as v };
