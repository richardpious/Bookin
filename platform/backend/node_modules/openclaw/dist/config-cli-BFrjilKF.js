import { c as normalizeOptionalString, f as normalizeStringifiedOptionalString } from "./string-coerce-DKw2K5wM.js";
import { m as parseStrictPositiveInteger } from "./number-coercion-DjYijOzx.js";
import "./parse-finite-number-D6V1jzY2.js";
import { t as CONFIG_PATH } from "./paths-BQQu4M8v.js";
...
import { l as normalizeStringEntries, v as uniqueValues } from "./string-normalization-B8G0vlWE.js";
import { g as shortenHomePath } from "./utils-DlHt_n1Q.js";
import { l as isValidEnvSecretRefId, m as resolveSecretInputRef, o as coerceSecretRef } from "./types.secrets-CuOz9KrZ.js";
import { n as normalizeAgentModelRefForConfig, t as normalizeAgentModelMapForConfig } from "./model-input-CET5RLn0.js";
...
import { t as parseConfigPathArrayIndex } from "./path-array-index-DfinFp_j.js";
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-CwMproYl.js";
import { a as isValidFileSecretRefId, c as secretRefKey, i as isValidExecSecretRefId, l as validateExecSecretRefId, o as isValidSecretProviderAlias, r as formatExecSecretRefIdValidationMessage } from "./ref-contract-C46R_Xj3.js";
import { a as resolveSecretRefValue } from "./resolve-BB3PkFpN.js";
import { n as info, o as success, t as danger } from "./globals-Dc2qfZst.js";
import { S as collectUnsupportedSecretRefPolicyIssues, T as validateConfigObjectRawWithPlugins, W as AUTO_MANAGED_CONFIG_META_PATHS, u as readConfigFileSnapshot } from "./io-By9euW-h.js";
import { n as formatConfigIssueLines, o as normalizeConfigIssues } from "./issue-format-c8ezaSew.js";
import { n as isPluginPackagingRuntimeOutputInvalidConfigSnapshot } from "./recovery-policy-CKSxWKv4.js";
import { r as normalizeConfiguredProviderCatalogModelId } from "./model-ref-shared-DKdSOt8D.js";
import { w as SecretProviderSchema } from "./zod-schema.core-Blo_HNrk.js";
import { i as replaceConfigFile } from "./mutate-DajLmhPa.js";
import "./config-Bzaup9wC.js";
import { s as formatStrictJsonParseFailure } from "./error-format-ZFU1PhmU.js";
import { n as formatPluginPackagingRuntimeOutputRecoveryHint } from "./config-recovery-hints-n4Y-uJdz.js";
import { n as redactConfigObject } from "./redact-snapshot-B4Fp0zuB.js";
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-LOr5ULb1.js";
import { n as setCommandJsonMode } from "./json-mode-BjEgCm3k.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-SlVUIhfW.js");
