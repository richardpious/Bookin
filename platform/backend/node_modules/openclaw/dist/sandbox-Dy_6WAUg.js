...
import { o as asSafeIntegerInRange } from "./number-coercion-DjYijOzx.js";
...
import { t as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-default-BYXB4T7J.js";
...
import { c as splitSandboxBindSpec, s as resolveSandboxHostPathViaExistingAncestor } from "./network-mode-Db8zA3iG.js";
import "./config-Bzaup9wC.js";
import { f as isSameSsrFPolicy } from "./ssrf-_PxmDk0r.js";
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-B5_QhWlv.js";
import { c as DEFAULT_USER_FILENAME, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-BF52cjJK.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT, x as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, y as SANDBOX_BROWSER_IMAGE_CONTRACT_EPOCH } from "./constants-CZs5rTJW.js";
import { n as isToolAllowed } from "./tool-policy-D1JBnztS.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-BKz2zzZH.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BQYHVOio.js";
import { n as normalizeContainerPath, r as relativePathEscapesContainerRoot, t as isPathInsideContainerRoot } from "./path-utils-xVgZ1OBw.js";
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, d as ensureBrowserControlAuth, f as resolveBrowserControlAuth, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-CwrJG_PU.js";
import { A as removeRegistryEntry, C as resolveSandboxWorkspaceDir, D as readBrowserRegistry, M as updateRegistry, N as computeSandboxBrowserConfigHash, O as readRegistry, S as resolveSandboxScopeKey, _ as appendWorkspaceMountArgs, a as execDocker, b as resolveReadOnlyWorkspaceSkillMounts, c as isDockerDaemonUnavailable, g as appendReadOnlyWorkspaceSkillMountArgs, j as updateBrowserRegistry, k as removeBrowserRegistryEntry, l as readDockerContainerEnvVar, m as resolveDockerEnvPolicyEpoch, n as dockerContainerState, p as readDockerPort, s as formatDockerDaemonUnavailableError, t as buildSandboxCreateArgs, u as readDockerContainerLabel, v as formatReadOnlyWorkspaceSkillMountHashState, w as slugifySessionKey, x as resolveSandboxAgentId } from "./docker-BGTdf1FD.js";
import { n as validateNetworkMode } from "./validate-sandbox-security-Dh5aBAGT.js";
import { D as buildPinnedWritePlan, E as buildPinnedRenamePlan, O as dockerSandboxBackendManager, T as buildPinnedRemovePlan, a as getSandboxBackendManager, b as parseSandboxStatSize, k as runDockerSandboxShellCommand, n as startBrowserBridgeServer, r as stopBrowserBridgeServer, s as requireSandboxBackendFactory, t as BROWSER_BRIDGES, w as buildPinnedMkdirpPlan, y as parseSandboxStatMtimeMs } from "./browser-bridges-B3dSrI5N.js";
...
function issueNoVncObserverToken(params) {
	...
	const ttlMs = asSafeIntegerInRange(params.ttlMs, {
		min: 1,
		max: MAX_NOVNC_TOKEN_TTL_MS
	}) ?? NOVNC_TOKEN_TTL_MS;
	...
	if (workspaceDir === sandboxWorkspaceDir) {
		...
		if (cfg.workspaceAccess !== "rw") try {
			const [{ syncSkillsToWorkspace }, { getRemoteSkillEligibility }, { canExecRequestNode }] = await Promise.all([
				import("./workspace-DVZYMBJ4.js"),
				import("./remote-D_NaZbkm.js"),
				import("./exec-defaults-CSP8p6la.js")
			]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-DUk6WkCH.js")).maybePruneSandboxes(cfg);
