...
import { u as normalizeMainKey } from "./session-key-CJf5_zWs.js";
...
import { a as normalizeChannelId } from "./registry-BjxDvA5W.js";
...
import { c as loadSessionEntry, l as migrateAndPruneGatewaySessionStoreKey, p as resolveGatewayModelSupportsImages, v as resolveSessionModelRef } from "./session-utils-CpM0p9QS.js";
...
import { i as deleteMediaBuffer } from "./store-f1lhXMT1.js";
...
import { i as resolveOutboundTarget } from "./targets-BH4keFNV.js";
import { c as updatePairedNodeMetadata } from "./node-pairing-CA7DcJUi.js";
import { n as agentCommandFromIngress } from "./agent-command-C00yVU8b.js";
import { t as formatForLog } from "./ws-log-CJgq7Rnr.js";
import { _ as updatePairedDeviceMetadata } from "./device-pairing-C5JfsLW6.js";
import "./agent-DA9EdrCd.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-BTAJetUA.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-tZn_oTmG.js";
import { a as registerApnsRegistration } from "./push-apns-Bu6oS_nh.js";
...
const handleNodeEvent = async (ctx, nodeId, evt, opts) => {
	switch (evt.event) {
		...
		case "exec.denied": {
			...
			const reason = sanitizeInboundSystemTags((normalizeOptionalString(obj.reason) ?? "").replace(/[()]/g, ""));
			let text = "";
