...
import { n as resolvePreferredOpenClawTmpDir, t as POSIX_OPENCLAW_TMP_DIR } from "./tmp-openclaw-dir-C60hWKdY.js";
...
import { a as inspectPortConnections, l as formatPortDiagnostics, o as inspectPortUsage } from "./ports-B8kDN2an.js";
import "./config-Bzaup9wC.js";
import { i as resolveGatewayService } from "./service-CCe-eBpT.js";
import { c as pickProbeHostForBind, o as normalizeListenerAddress, s as parsePortFromArgs } from "./shared-UhnIgKX3.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-LItyvuPW.js";
import { r as resolveBestEffortGatewayBindHostForDisplay, t as inspectBestEffortPrimaryTailnetIPv4 } from "./network-discovery-display-Bp7IfPiS.js";
...
const gatewayProbeAuthModuleLoader = createLazyImportLoader(() => import("./probe-auth-C8u7-HV-.js"));
const daemonInspectModuleLoader = createLazyImportLoader(() => import("./inspect-BocO5Oem.js"));
const launchdModuleLoader = createLazyImportLoader(() => import("./launchd-F_v9WWTe.js"));
const serviceAuditModuleLoader = createLazyImportLoader(() => import("./service-audit-ChzvHbUw.js"));
const gatewayTlsModuleLoader = createLazyImportLoader(() => import("./gateway-B__Evi8G.js"));
const daemonProbeModuleLoader = createLazyImportLoader(() => import("./probe-DvNDowo9.js"));
const restartHealthModuleLoader = createLazyImportLoader(() => import("./restart-health-DbtdMehD.js"));
...
async function gatherDaemonStatus(opts) {
	...
	const staleUpdateLaunchdJobs = opts.deep && process.platform === "darwin" ? await loadLaunchdModule().then(({ findStaleOpenClawUpdateLaunchdJobs }) => findStaleOpenClawUpdateLaunchdJobs()).catch(() => []) : [];
