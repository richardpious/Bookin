...
import { n as isSingleUseReplyToMode } from "./reply-reference-DFEnLjwn.js";
import { a as hasReplyPayloadContent } from "./payload-Cpx3heIy.js";
...
function normalizeOutboundReplyPayload$1(payload) {
	return {
		...
		presentation: readObjectValue(payload.presentation),
		interactive: readObjectValue(payload.interactive),
		channelData: readObjectValue(payload.channelData),
