...
import { t as pruneMapToMaxSize } from "./map-size-uFq9BGIH.js";
import { a as isRequestBodyLimitError, c as requestBodyErrorToText, o as readJsonBodyWithLimit, s as readRequestBodyWithLimit } from "./http-body-C2KvNhn8.js";
//#region src/plugin-sdk/webhook-numeric-options.ts
function resolveWebhookIntegerOption(value, fallback, params) {
...
function createWebhookInFlightLimiter(options) {
	const maxInFlightPerKey = resolveWebhookIntegerOption(options?.maxInFlightPerKey, WEBHOOK_IN_FLIGHT_DEFAULTS.maxInFlightPerKey, { min: 1 });
	const maxTrackedKeys = resolveWebhookIntegerOption(options?.maxTrackedKeys, WEBHOOK_IN_FLIGHT_DEFAULTS.maxTrackedKeys, { min: 1 });
...
//#endregion
export { createWebhookInFlightLimiter as a, readWebhookBodyOrReject as c, beginWebhookRequestPipelineOrReject as i, resolveWebhookIntegerOption as l, WEBHOOK_IN_FLIGHT_DEFAULTS as n, isJsonContentType as o, applyBasicWebhookRequestGuards as r, readJsonWebhookBodyOrReject as s, WEBHOOK_BODY_READ_DEFAULTS as t };
