...
import { _ as uniqueStrings, g as sortUniqueStrings, l as normalizeStringEntries } from "./string-normalization-B8G0vlWE.js";
import { w as pathExists } from "./fs-safe-DYWmA8_q.js";
import { u as pathExists$1 } from "./utils-DlHt_n1Q.js";
import { i as resolveGatewayInstallEntrypoint } from "./gateway-entrypoint-BKe5gzkF.js";
import { t as movePathWithCopyFallback } from "./replace-file-C7_Inj8B.js";
import { a as readJsonIfExists } from "./json-files-ruLzKqUC.js";
import { a as parseSemver } from "./runtime-guard-DLdnBLFm.js";
...
import { n as applyPosixNpmScriptShellEnv, r as createNpmFreshnessBypassArgs, t as applyNpmFreshnessBypassEnv } from "./npm-install-env-DHRrBEi1.js";
import { u as trimLogTail } from "./restart-sentinel-C2iY3lrL.js";
import { t as applyPathPrepend } from "./path-prepend-C1I3sJQT.js";
import { a as isBetaTag, n as DEV_BRANCH, o as isStableTag, r as channelToNpmTag } from "./update-channels-nKAynEOl.js";
import { n as readPackageName, r as readPackageVersion } from "./package-json-BI7u5J9F.js";
import { n as compareSemverStrings, s as detectPackageManager } from "./update-check-DqzyOmmE.js";
import { a as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-DK96hUTt.js";
...
async function withPackageDistInventoryFsSlot(context, task) {
	while (context.activeFsOps >= context.fsConcurrency) await new Promise((resolve) => context.waiters.push(resolve));
...
function findBlockingGitFailure(steps) {
	return steps.find((step, index) => step.exitCode !== 0 && !isSupersededInstallFailure(step, steps) && !isSupersededTargetRefFailure(step, steps.slice(index + 1)));
}
function isSupersededTargetRefFailure(step, followingSteps) {
	...
	if (!isTargetRefProbe && !isTargetTagFetch) return false;
