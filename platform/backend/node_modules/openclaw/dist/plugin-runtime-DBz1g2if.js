...
import { C as claimPluginInteractiveCallbackDedupe, T as releasePluginInteractiveCallbackDedupe, w as commitPluginInteractiveCallbackDedupe, x as resolvePluginInteractiveNamespaceMatch } from "./command-registration-BWsYSY_K.js";
import "./hook-runner-global-BdHeqZIb.js";
import "./gateway-request-scope-B9qYB9tg.js";
...
import "./commands-BCn4RB8m.js";
import "./http-registry-DNCsTeTt.js";
...
async function dispatchPluginInteractiveHandler(params) {
	...
	try {
		...
		const shouldExposeResult = !!resolved && typeof resolved === "object" && Object.keys(resolved).some((key) => key !== "handled");
		return {
			matched: true,
