...
import { f as readLoggingConfig, p as shouldSkipMutatingLoggingConfigRead, r as redactSecrets, s as redactSensitiveText } from "./redact-Ba9lUINf.js";
...
import { C as isValidDiagnosticTraceFlags, S as isValidDiagnosticSpanId, n as emitDiagnosticEvent, w as isValidDiagnosticTraceId, x as getActiveDiagnosticTraceContext } from "./diagnostic-events-CNGydBWO.js";
...
function attachDiagnosticEventTransport(logger) {
	logger.attachTransport((logObj) => {
		try {
			emitDiagnosticEvent(buildDiagnosticLogRecord(redactLogRecordForTransport(logObj)));
		} catch {}
	});
}
...
//#endregion
export { normalizeLogLevel as _, getResolvedLoggerSettings as a, setLoggerConfigLoaderForTests as c, toPinoLikeLogger as d, formatLocalIsoWithOffset as f, levelToMinLevel as g, ALLOWED_LOG_LEVELS as h, getLogger as i, setLoggerOverride as l, resolveEnvLogLevelOverride as m, DEFAULT_LOG_FILE as n, isFileLogLevelEnabled as o, formatTimestamp as p, getChildLogger as r, resetLogger as s, DEFAULT_LOG_DIR as t, testApi as u, tryParseLogLevel as v };
