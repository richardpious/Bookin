...
import { i as readCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolvePositiveTimeoutSeconds, u as writeCache } from "./web-shared-Cv7-bRWh.js";
...
function resolveTavilyExtractTimeoutSeconds(override) {
	return resolvePositiveTimeoutSeconds(override, 60);
}
//#endregion
...
async function readTavilyJsonResponse(response, label) {
	try {
...
//#endregion
export { runTavilySearch as n, testing as r, runTavilyExtract as t };
