import { n as normalizeAgentModelRefForConfig } from "./model-input-CET5RLn0.js";
...
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-DKdSOt8D.js";
import { t as enablePluginInConfig } from "./enable-DcBk9n3x.js";
import "./auth-profiles-AKuhPu9Q.js";
import { s as upsertAuthProfileWithLock } from "./profiles-HRf9hc-n.js";
import "./workspace-BF52cjJK.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-CpwcR04k.js";
import { n as t } from "./i18n-eLAkCRYg.js";
import { n as openUrl } from "./browser-open-CSqiOr-7.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-BrHVLAR0.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-CUfHvXE4.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-BAwyWwvl.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-yFbEzcQS.js";
import { t as isRemoteEnvironment } from "./remote-env-tIWH7MeL.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-ndbz6myW.js");
		...
		const { ensureCopilotRuntimePluginForModelSelection } = await import("./copilot-runtime-plugin-install-BEVUNJVs.js");
