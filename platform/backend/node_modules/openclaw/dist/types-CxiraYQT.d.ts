import { _ as PromptImageOrderEntry, a as SourceReplyDeliveryMode, h as InputProvenance } from "./types-D4HaPNnq2.js";
import { gs as ExecElevatedDefaults, hs as ClientToolDefinition, ls as PromptMode, ms as AgentStreamParams, us as AgentInternalEvent } from "./types-BQnYToyl.js";
import { O as ChannelOutboundTargetMode } from "./types.core-v3pxNrAj.js";
...
type AgentCommandOpts = {
  ...
  runContext?: AgentRunContext; /** Internal trusted exec approval follow-up elevated defaults. */
  ...
  streamParams?: AgentStreamParams; /** Explicit workspace directory override (for subagents to inherit parent workspace). */
  ...
  cleanupCliLiveSessionOnRunEnd?: boolean; /** Internal local CLI callers can annotate result metadata before JSON/text output. */
...
//#endregion
export { AgentCommandOpts as n, AgentCommandResultMetaOverrides as r, AgentCommandIngressOpts as t };