...
import { s as resolveConfigPath } from "./paths-BQQu4M8v.js";
import { t as createLazyImportLoader } from "./lazy-promise-Djskx0qC.js";
import { n as defaultSlotIdForKey } from "./slots-DT22cOei.js";
...
import { t as resolveGatewayProbeTarget } from "./probe-target-Bbos3OEF.js";
...
import { t as pickGatewaySelfPresence } from "./gateway-presence-DYQNrDSw.js";
import { i as isProbeReachable } from "./helpers--wT_K8cZ.js";
import { existsSync } from "node:fs";
//#region src/commands/status.scan.shared.ts
const gatewayProbeModuleLoader = createLazyImportLoader(() => import("./status.gateway-probe-B_PwpVsQ.js"));
const probeGatewayModuleLoader = createLazyImportLoader(() => import("./probe-DY8p3rzz.js"));
const gatewayCallModuleLoader$1 = createLazyImportLoader(() => import("./call-BFQSeMzC.js"));
...
const statusAgentLocalModuleLoader = createLazyImportLoader(() => import("./status.agent-local-CAByG3X5.js"));
const statusUpdateModuleLoader = createLazyImportLoader(() => import("./status.update-BOF88WSd.js"));
const statusScanRuntimeModuleLoader = createLazyImportLoader(() => import("./status.scan.runtime.js"));
const gatewayCallModuleLoader = createLazyImportLoader(() => import("./call-BFQSeMzC.js"));
const statusSummaryModuleLoader = createLazyImportLoader(() => import("./status.summary-B28Kp3Kj.js"));
const channelPluginIdsModuleLoader = createLazyImportLoader(() => import("./channel-plugin-ids-CpnE96lh.js"));
const configModuleLoader = createLazyImportLoader(() => import("./config/config.js"));
const commandConfigResolutionModuleLoader = createLazyImportLoader(() => import("./command-config-resolution-B9RvKvB6.js"));
const commandSecretTargetsModuleLoader = createLazyImportLoader(() => import("./command-secret-targets-DuMqakfq.js"));
...
async function collectStatusScanOverview(params) {
	...
	const { coldStart, sourceConfig, resolvedConfig: cfg, secretDiagnostics } = await loadStatusScanCommandConfig({
		...
		allowMissingConfigFastPath: params.allowMissingConfigFastPath,
		readBestEffortConfig: async () => (await loadConfigModule()).readBestEffortConfig({ skipPluginValidation: params.skipConfigPluginValidation }),
