...
import { n as assertOkOrThrowHttpError, t as asObject, u as readProviderBinaryResponse } from "./provider-http-errors-BEw8ykZh.js";
	...
	return {
		...
		synthesize: async (req) => {
			...
			try {
				...
				return {
					audioBuffer: Buffer.from(await readProviderBinaryResponse(response, options.apiErrorLabel ?? `${options.label} TTS API error`, "audio")),
