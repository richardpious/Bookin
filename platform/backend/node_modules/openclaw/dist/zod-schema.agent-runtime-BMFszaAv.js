...
import { An as preprocess, At as boolean, Et as array, Nn as record, Rn as string, Tn as object, Xn as union, Zn as unknown, dn as literal, wn as number, yt as _enum } from "./schemas-Del5uzR8.js";
import { n as ZodIssueCode } from "./compat-bCpUj7Jq.js";
import { C as SecretInputSchema, D as ToolsLinksSchema, O as ToolsMediaSchema, c as GroupChatSchema, d as HumanDelaySchema, f as IdentitySchema, j as TtsConfigSchema } from "./zod-schema.core-Blo_HNrk.js";
import { t as sensitive } from "./zod-schema.sensitive-3GVmnUbm.js";
import { t as parseDurationMs } from "./parse-duration-CI8nUnt1.js";
import { a as isSandboxHostPathAbsolute, c as splitSandboxBindSpec, t as getBlockedNetworkModeReason } from "./network-mode-Db8zA3iG.js";
import { t as LEGACY_WEB_SEARCH_PROVIDER_CONFIG_KEYS } from "./web-search-legacy-provider-keys-Bi8ierOP.js";
...
const AgentContextLimitsSchema = object({
	...
	toolResultMaxChars: number().int().min(1).max(25e4).optional(),
...
const ToolSearchSchema = union([boolean(), object({
	enabled: boolean().optional(),
	mode: _enum(["code", "tools"]).optional(),
...
object({ runtime: string().optional() }).strict().optional();
...
const AgentEntrySchema = object({
	...
	fastModeDefault: boolean().optional(),
