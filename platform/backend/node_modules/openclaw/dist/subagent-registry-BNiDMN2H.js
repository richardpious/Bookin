...
import { c as readErrorName, i as formatErrorMessage } from "./errors-AAwmFBlx.js";
...
import { c as toSafeImportPath } from "./plugin-module-loader-cache-Cm0F2kLN.js";
...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-BuYtWSh4.js";
...
import { c as registerSessionMaintenancePreserveKeysProvider, t as loadSessionStore } from "./store-load-BHiTqlRK.js";
import { d as updateSessionStore } from "./store-Dh6bWvq_.js";
import "./sessions-BN2mnV-J.js";
import { n as resolveRequiredCompletionTerminalResult, r as resolveAgentTimeoutMs, t as resolveRequiredCompletionDeliveryFailureTerminalResult } from "./task-completion-contract-J-Ef4cSA.js";
import { n as extractTextFromChatContent } from "./chat-content-BNTcXm1Z.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId } from "./detached-task-runtime-Dbps45ky.js";
import { a as isSilentReplyText } from "./tokens-BpOBzvOi.js";
import { A as getSubagentSessionRuntimeMs, B as subagentRuns, F as SUBAGENT_ENDED_OUTCOME_TIMEOUT, I as SUBAGENT_ENDED_REASON_COMPLETE, L as SUBAGENT_ENDED_REASON_ERROR, M as resolveSubagentSessionStatus, N as SUBAGENT_ENDED_OUTCOME_ERROR, O as isStaleUnendedSubagentRun, P as SUBAGENT_ENDED_OUTCOME_KILLED, R as SUBAGENT_ENDED_REASON_KILLED, _ as countPendingDescendantRunsFromRuns, a as clearDeliveryState, b as listDescendantRunsForRequesterFromRuns, c as getDeliveryAttemptCount, d as isDeliverySuspended, f as normalizeSubagentRunState, h as countActiveRunsForSessionFromRuns, i as restoreSubagentRunsFromDisk, j as getSubagentSessionStartedAt, l as getDeliveryLastAttemptAt, m as countActiveDescendantRunsFromRuns, n as persistSubagentRunsToDisk, o as ensureCompletionState, r as persistSubagentRunsToDiskOrThrow, s as ensureDeliveryState, t as getSubagentRunsSnapshotForRead, u as getDeliveryLastError, v as getSubagentRunByChildSessionKeyFromRuns, x as listRunsForControllerFromRuns, z as SUBAGENT_TARGET_KIND_SUBAGENT } from "./subagent-registry-state-NsqwJ7zy.js";
import { d as retireSessionMcpRuntimeForSessionKey } from "./agent-bundle-mcp-runtime-n24dxm4C.js";
import "./agent-bundle-mcp-tools-DYx8xrZZ.js";
import { i as isBlockedLivenessState, n as isAbortedAgentStopReason, r as formatBlockedLivenessError } from "./run-termination-DzoWxvjU.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-BQdq1zsZ.js";
import { d as withSubagentOutcomeTiming, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-BHCne7dT.js";
import { n as removeInternalSessionEffectsTranscript } from "./internal-session-effects-BCTcHHqO.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-Cw2-_Up1.js"));
...
function createSubagentRunManager(params) {
	const waitForSubagentCompletion = async (runId, waitTimeoutMs, expectedEntry, capWaitToStoredDeadline = false) => {
		...
		try {
			...
			const waitError = waitAborted ? "subagent run terminated" : waitBlocked ? formatBlockedLivenessError(rawWaitError) : rawWaitError;
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-BfEJfoMT.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-Cw2-_Up1.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-BdYbXtkV.js").then(({ scheduleOrphanRecovery }) => {
