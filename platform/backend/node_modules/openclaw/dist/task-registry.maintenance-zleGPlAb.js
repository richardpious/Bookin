...
import { o as isPluginStateDatabaseOpen, s as sweepExpiredPluginStateEntries } from "./plugin-state-store-BGfjYxAA.js";
...
import { T as setTaskCleanupAfterById, U as CODEX_NATIVE_SUBAGENT_STALE_ERROR, W as isChildlessCodexNativeSubagentTask, b as markTaskTerminalById, c as hasActiveTaskForChildSessionKey, f as listTaskRecords, i as ensureTaskRegistryReady, r as deleteTaskRecordById, s as getTaskById, v as markTaskLostById, w as resolveTaskForLookupToken, x as maybeDeliverTaskTerminalUpdate } from "./task-registry-BIbw6MG4.js";
import { n as summarizeTaskRecords } from "./task-registry.summary-BwpoHlXv.js";
import { n as resolveTaskCleanupAfter, r as resolveTaskRetentionMs, t as resolveEffectiveTaskCleanupAfter } from "./task-retention-DxawMBrm.js";
import "./runtime-internal-CiE_ufD9.js";
import { d as tryRecoverTaskBeforeMarkLost, s as getDetachedTaskLifecycleRuntime } from "./detached-task-runtime-Dbps45ky.js";
import { t as getAcpSessionManager } from "./manager-B_67Qu_1.js";
import { n as readAcpSessionEntry, t as listAcpSessionEntries } from "./session-meta-BT3CQM3r.js";
import { i as isSubagentRecoveryWedgedEntry, r as formatSubagentRecoveryWedgedReason } from "./subagent-recovery-state-Chw_zLIZ.js";
import { r as isCronJobActive } from "./active-jobs-D4eKAY4b.js";
import { a as resolveCronRunLogPath, i as readCronRunLogEntriesSync } from "./run-log-DrBtB8zI.js";
import { o as resolveCronStorePath, r as loadCronStoreSync } from "./store-ged8z1Y5.js";
import { n as getSessionBindingService } from "./session-binding-service-DInWFDrJ.js";
import { a as summarizeTaskAuditFindings, n as listTaskAuditFindings, t as configureTaskAuditTaskProvider } from "./task-registry.audit-Z_ZqEQCW.js";
...
const CHILDLESS_CODEX_NATIVE_RECONCILE_GRACE_MS = 30 * 6e4;
...
function hasLostGraceExpired(task, now) {
	...
	const graceMs = isChildlessCodexNativeSubagentTask(task) ? CHILDLESS_CODEX_NATIVE_RECONCILE_GRACE_MS : TASK_RECONCILE_GRACE_MS;
...
function hasBackingSession(task, context) {
	...
	const childSessionKey = task.childSessionKey?.trim();
	if (!childSessionKey) return !isChildlessCodexNativeSubagentTask(task);
	if (task.runtime === "acp") {
...
function resolveTaskLostError(task, context) {
	if (isChildlessCodexNativeSubagentTask(task)) return CODEX_NATIVE_SUBAGENT_STALE_ERROR;
...
function getInspectableTaskAuditFindings() {
	return listTaskAuditFindings({ tasks: reconcileInspectableTasks() });
}
...
function explainActiveTaskRetention(params) {
	...
	if (params.task.runtime === "cron" && !taskRegistryMaintenanceRuntime.isCronRuntimeAuthoritative()) return {
		decision: "retained",
...
//#endregion
export { stopTaskRegistryMaintenanceForTests as _, getInspectableTaskRegistrySummary as a, previewTaskRegistryMaintenance as c, reconcileTaskRecordForOperatorInspection as d, resetTaskRegistryMaintenanceRuntimeForTests as f, stopTaskRegistryMaintenance as g, startTaskRegistryMaintenance as h, getInspectableTaskAuditSummary as i, reconcileInspectableTasks as l, setTaskRegistryMaintenanceRuntimeForTests as m, getInspectableActiveTaskRestartBlockers as n, getReconciledTaskById as o, runTaskRegistryMaintenance as p, getInspectableTaskAuditFindings as r, getTaskRegistryMaintenanceDiagnostics as s, configureTaskRegistryMaintenance as t, reconcileTaskLookupToken as u, sweepTaskRegistry as v };
