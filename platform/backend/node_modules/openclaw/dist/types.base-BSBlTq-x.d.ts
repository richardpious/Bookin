...
type WebWhatsAppConfig = {
  ...
  connectTimeoutMs?: number; /** Baileys query timeout in milliseconds. Default: 60000. */
...
//#endregion
export { SessionResetConfig as A, TextChunkMode as B, OutboundRetryConfig as C, SessionMaintenanceConfig as D, SessionConfig as E, SessionSendPolicyMatch as F, WebConfig as H, SessionSendPolicyRule as I, SessionThreadBindingsConfig as L, SessionScope as M, SessionSendPolicyAction as N, SessionMaintenanceMode as O, SessionSendPolicyConfig as P, SessionWriteLockConfig as R, MarkdownTableMode as S, ReplyToMode as T, WebReconnectConfig as U, TypingMode as V, WebWhatsAppConfig as W, GroupPolicy as _, ChannelPreviewStreamingConfig as a, LoggingConfig as b, ChannelStreamingConfig as c, ContextVisibilityMode as d, DiagnosticsCacheTraceConfig as f, DmScope as g, DmPolicy as h, ChannelDeliveryStreamingConfig as i, SessionResetMode as j, SessionResetByTypeConfig as k, ChannelStreamingPreviewConfig as l, DiagnosticsOtelConfig as m, BlockStreamingChunkConfig as n, ChannelStreamingBlockConfig as o, DiagnosticsConfig as p, BlockStreamingCoalesceConfig as r, ChannelStreamingCommandTextMode as s, AgentElevatedAllowFromConfig as t, ChannelStreamingProgressConfig as u, HumanDelayConfig as v, ReplyMode as w, MarkdownConfig as x, IdentityConfig as y, StreamingMode as z };