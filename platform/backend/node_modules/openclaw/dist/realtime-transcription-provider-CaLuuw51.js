...
import { t as createRealtimeTranscriptionWebSocketSession } from "./realtime-transcription-J8IWxyqM.js";
import { a as resolveOpenAIProviderConfigRecord, i as readRealtimeErrorDetail, o as trimToUndefined, r as createOpenAIRealtimeTranscriptionClientSecret } from "./realtime-provider-shared-_1i7iaXe.js";
...
function buildOpenAIRealtimeTranscriptionSessionCreateConfig(config) {
	return {
		type: "transcription",
		audio: { input: {
...
function buildOpenAIRealtimeTranscriptionSessionUpdateConfig(config) {
	return {
		type: "transcription",
		audio: { input: {
			format: { type: "audio/pcmu" },
