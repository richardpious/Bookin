...
import { t as parseInlineOptionToken } from "./inline-option-token-UnnAKQPE.js";
import { t as formatDocsLink } from "./links-CM5vg8_V.js";
import { r as theme, t as colorize } from "./theme-D58JpUfy.js";
import { l as normalizeStringEntries } from "./string-normalization-B8G0vlWE.js";
import { c as sanitizeSystemRunEnvOverrides, o as sanitizeHostExecEnv, t as inspectHostExecEnvOverrides } from "./host-env-security-B90drdeB.js";
import { t as sameFileIdentity } from "./file-identity-BKNyWMFA.js";
import { _ as resolveNodeSystemdServiceName, g as resolveNodeLaunchAgentLabel, l as formatNodeServiceDescription, v as resolveNodeWindowsTaskName } from "./constants-BOOZFRBo.js";
import { n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, s as resolveNodeProgramArguments, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-CDRp2bQO.js";
import { n as VERSION } from "./version-BjFOZC7j.js";
import { u as buildNodeServiceEnvironment } from "./runtime-paths-BK-7a2z8.js";
...
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-C5rLdYLT.js";
import { a as decodeWindowsOutputBuffer, o as resolveWindowsConsoleEncoding } from "./windows-command-SbCMKxJh.js";
import { a as logWarn } from "./logger-9dl1njHh.js";
import { i as getRuntimeConfig } from "./io-By9euW-h.js";
import { f as resolveApprovalAuditTrustPath, m as resolveCommandResolutionFromArgv, w as resolveExecutableFromPathEnv } from "./exec-safe-bin-trust-DhmCkPW8.js";
import { O as normalizeExecutableToken, S as unwrapKnownDispatchWrapperInvocation, d as unwrapKnownShellMultiplexerInvocation, f as POSIX_INLINE_COMMAND_FLAGS, g as resolveInlineCommandMatch, k as splitShellArgs, l as isShellWrapperInvocation, p as advancePosixInlineOptionScan, s as isBlockedShellWrapperCommand, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv, v as extractEnvAssignmentKeysFromDispatchWrappers } from "./shell-wrapper-resolution-Dq5e0a-7.js";
import "./config-Bzaup9wC.js";
import { n as formatInvalidConfigPort, r as formatInvalidPortOption } from "./error-format-ZFU1PhmU.js";
import { n as buildPlatformServiceStartHints, r as formatRuntimeStatus, t as buildPlatformRuntimeLogHints } from "./runtime-hints-Dra-0sad.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-UhnIgKX3.js";
import { t as parsePort } from "./parse-port-DXMHNkZA.js";
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES } from "./client-info-ErIekSPI.js";
import { n as GatewayClient } from "./client-5XIBFtwk.js";
import { r as loadOrCreateDeviceIdentity } from "./device-identity-DtGZ-JTk.js";
import { t as startGatewayClientWhenEventLoopReady } from "./client-start-readiness-iFIP_8nB.js";
import { t as ConnectErrorDetailCodes } from "./connect-error-details-BqV3wdWQ.js";
import { i as runServiceUninstall, n as runServiceStart, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-DTk-XANc.js";
...
import "./exec-wrapper-resolution-DGUmAqHc.js";
import { c as describeInterpreterInlineEval } from "./risks-DUUficc3.js";
import { c as analyzeArgvCommand, d as buildSafeBinsShellCommand, m as resolvePlannedSegmentArgv, n as evaluateShellAllowlist, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-BnEOHiHh.js";
import { A as resolveExecApprovals, C as recordAllowlistMatchesUse, D as requiresExecApproval, F as resolveExecModePolicy, I as resolveExecPolicyForMode, R as saveExecApprovals, S as readExecApprovalsSnapshot, c as ensureExecApprovals, f as maxAsk, h as normalizeExecApprovals, l as hasDurableExecApproval, m as minSecurity, o as addDurableCommandApproval, p as mergeExecApprovalsSocketDefaults, s as commandRequiresSecurityAuditSuppressionApproval, x as persistAllowAlwaysPatterns, z as requestJsonlSocket } from "./exec-approvals-D31CZ_MJ.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-B2Vo6A-F.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-DkbKZvAw.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-7UoO-Wcn.js";
import { t as formatHelpExamples } from "./help-format-DXVAk021.js";
import { n as detectPolicyInlineEval } from "./policy-tTpWmHRW.js";
import { c as normalizeSystemRunApprovalPlan, n as formatExecCommand, r as resolveSystemRunCommandRequest } from "./system-run-command-DW7iYPv2.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-DyAD9-Zj.js";
import { t as resolveNodeService } from "./node-service-rW5IS_Z3.js";
...
function resolveSystemRunExecArgv(params) {
	...
	if (params.security === "allowlist" && !params.isWindows && !params.policy.approvedByAsk && params.shellCommand && params.policy.analysisOk && params.policy.allowlistSatisfied && params.segmentSatisfiedBy.some((entry) => entry === "safeBins" || entry === "inlineChain") && isPosixShellInlineCommandTransport(params.argv)) {
		...
		if (!rebuiltAllowlist.analysisOk || !rebuiltAllowlist.allowlistSatisfied) return null;
...
async function resolveSystemRunAutoReviewer(params) {
	...
	const { createModelExecAutoReviewer } = await import("./exec-auto-reviewer-DD9x-niB.js");
...
async function evaluateSystemRunPolicyPhase(opts, parsed) {
	...
	let { analysisOk, allowlistMatches, allowlistSatisfied, segments, segmentAllowlistEntries, segmentSatisfiedBy } = evaluateSystemRunAllowlist({
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-Bq3RCNmZ.js");
