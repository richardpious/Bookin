...
import { i as parseHealthFindingSeverity, r as healthFindingMeetsSeverity, t as exitCodeFromFindings } from "../../doctor-lint-flow-qUKDlWja.js";
import "../../health-Bz7qyN_W.js";
import { a as policyContainerShapeFindings, i as isPolicyValueAtLeastAsStrict, n as POLICY_RULE_METADATA$1, o as registerPolicyDoctorChecks, r as evaluatePolicy, s as createPolicyAttestation, t as POLICY_CHECK_IDS } from "../../register-DyoOsCgM.js";
...
function policyRuleValueIsValid(metadata, value) {
	switch (metadata.valueType) {
		...
		case "string-list": return Array.isArray(value) && value.every((entry) => typeof entry === "string" && entry.trim() !== "" && policyStringIsAllowed(metadata, entry));
	}
	return false;
}
