...
import { n as parseNonNegativeByteSize } from "../../zod-schema-Def67l2T.js";
import { n as SILENT_REPLY_TOKEN } from "../../tokens-BpOBzvOi.js";
import "../../agent-settings-OfQQMq1r.js";
...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-Bh1eA-mt.js";
import { r as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-CPCoregK.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-CTFT0uVG.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-BmxxFp0Y.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-Dsc-w4xt.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-bCkDcsAn.js");
