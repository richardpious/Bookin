import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, f as normalizeStringifiedOptionalString } from "./string-coerce-DKw2K5wM.js";
import { d as parseStrictFiniteNumber, m as parseStrictPositiveInteger } from "./number-coercion-DjYijOzx.js";
...
import { i as resolveAgentModelPrimaryValue } from "./model-input-CET5RLn0.js";
import "./agent-scope-BeI1SY1H.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId } from "./agent-scope-config-CaXAl7-j.js";
import { n as defaultRuntime, r as writeRuntimeJson } from "./runtime-yzlkhCoS.js";
import { i as isLoopbackHost } from "./net-ziAus6sd.js";
...
import { p as normalizeThinkLevel } from "./thinking-Cq-IXzst.js";
...
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-DWAzzmts.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-DGvgHuOd.js";
import { f as randomIdempotencyKey, i as callGateway } from "./call-BuKoI5AV.js";
import { N as registerMemoryEmbeddingProvider, j as listMemoryEmbeddingProviders } from "./loader-wybWjJVr.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-TnUOZVhx.js";
import { c as loadAuthProfileStoreForRuntime, m as updateAuthProfileStoreWithLock } from "./store-CvzOxDnC.js";
import "./auth-profiles-AKuhPu9Q.js";
import { n as listProfilesForProvider } from "./profile-list-BmPTDk7t.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-D0756MDv.js";
import { n as loadModelCatalog } from "./model-catalog-DtvFscuH.js";
import { l as getImageMetadata, s as convertHeicToJpeg } from "./media-services-v2ADmdnV.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-CXyCDpyp.js";
import { u as saveMediaBuffer } from "./store-f1lhXMT1.js";
import { t as buildExplicitSessionIdSessionKey } from "./session-BJiOvZGX.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-Bx3qZVXM.js";
import { a as getCapabilityWebSearchCommandSecretTargets, c as getMemoryEmbeddingCommandSecretTargetIds, l as getModelsCommandSecretTargetIds, m as getTtsCommandSecretTargetIds, r as getCapabilityWebFetchCommandSecretTargets } from "./command-secret-targets-A-IIV5w2.js";
import { o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-BKoiYs3b.js";
import { S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, d as listSpeechVoices, f as listTtsPersonas, g as resolveTtsConfig, k as textToSpeech, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, w as setTtsPersona } from "./tts-runtime-K2ac55wV.js";
import "./tts-DBldkbRt.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-ByTB2N4W.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-B-kpt-pU.js";
import { n as listEmbeddingProviders } from "./embedding-provider-runtime-B1P40N_G.js";
import { t as resolveMemorySearchConfig } from "./memory-search-pQFb2HEv.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-BchbnxFw.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-CXkbpSnb.js";
import { n as runCommandWithRuntime } from "./cli-utils-BSBVYpd6.js";
import { t as removeCommandByName } from "./command-tree-vUuz1b4f.js";
import { t as collectOption } from "./helpers-DlK2bTP5.js";
import { n as describeImageFileWithModel, o as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-D3NLUbhc.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-ELM0OBqk.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-BxEwr3_T.js";
import { n as parseTimeoutMsWithFallback } from "./parse-timeout-BnxwFDxa.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-DXv1UL7f.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-DNrQg-1V.js");
