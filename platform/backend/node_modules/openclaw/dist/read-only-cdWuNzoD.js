...
import { _ as uniqueStrings, g as sortUniqueStrings } from "./string-normalization-B8G0vlWE.js";
...
import { n as getCachedPluginModuleLoader } from "./plugin-module-loader-cache-Cm0F2kLN.js";
...
import { a as resolveSetupChannelRegistration, t as channelPluginIdBelongsToManifest } from "./loader-channel-setup-Dts5CfDz.js";
import { n as getActivePluginChannelRegistryVersion } from "./runtime-BjnrbaLv.js";
import { i as listChannelPlugins } from "./registry-BjxDvA5W.js";
import { f as listConfiguredChannelIdsForReadOnlyScope, g as resolveDiscoverableScopedChannelPluginIds, u as hasExplicitChannelConfig } from "./channel-plugin-ids-Di5PV7SC.js";
import { n as normalizeChannelCommandDefaults, r as readOwnRecordValue, t as isSafeManifestChannelId } from "./read-only-command-defaults-61OFXxOy.js";
...
function listManifestChannelAccountIds(cfg, channelId) {
	...
	if (accounts && typeof accounts === "object" && !Array.isArray(accounts)) return sortUniqueStrings(Object.keys(accounts).filter((accountId) => !isBlockedObjectKey(accountId)).map((accountId) => normalizeAccountId(accountId)).filter((accountId) => !isBlockedObjectKey(accountId)));
