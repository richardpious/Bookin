...
import { r as writeExternalFileWithinRoot } from "./fs-safe-DYWmA8_q.js";
...
import { a as maxBytesForKind } from "./constants-D9zVCSKe.js";
import { r as extensionForMime } from "./mime-TnUOZVhx.js";
import { C as runFfmpeg, T as MEDIA_FFMPEG_MAX_AUDIO_DURATION_SECS, b as parseFfprobeCodecAndSampleRate, w as runFfprobe } from "./media-services-v2ADmdnV.js";
import { r as loadWebMediaRaw } from "./web-media-nQIW_6GE.js";
import "./error-runtime-Dn_nurEc.js";
import { o as unlinkIfExists } from "./media-runtime-B_CojBOF.js";
...
import { s as resolveDiscordAccount } from "./accounts-DgHRf6KD.js";
import { $ as createChannelMessage, At as putChannelPermission, Ct as getGuildVoiceState, Dt as listGuildRoles, Et as listGuildEmojis, It as ChannelType, Mt as removeGuildMemberRole, Nt as timeoutGuildMember, Ot as listGuildScheduledEvents, Q as listMessageReactionUsers, St as getGuildMember, Tt as listGuildChannels, X as createOwnMessageReaction, Z as deleteOwnMessageReaction, _ as readRetryAfter, _t as createGuildEmoji, at as getChannel, bt as deleteChannelPermission, ct as listChannelMessages, dt as searchGuildMessages, et as createThread, ft as sendChannelTyping, g as readDiscordMessage, gt as createGuildChannel, h as readDiscordCode, ht as createGuildBan, it as editChannelMessage, jt as removeGuildMember, kt as moveGuildChannels, lt as listChannelPins, m as RateLimitError, mt as addGuildMemberRole, nt as deleteChannelMessage, ot as getChannelMessage, p as DiscordError, pt as unpinChannelMessage, rt as editChannel, st as listChannelArchivedThreads, tt as deleteChannel, ut as pinChannelMessage, vt as createGuildScheduledEvent, wt as listGuildActiveThreads, xt as getGuild, yt as createGuildSticker } from "./discord-ChyUmJWg.js";
import { C as DISCORD_MAX_STICKER_BYTES, F as createDiscordClient, P as parseAndResolveChannelRecipient, R as resolveDiscordClientAccountContext, S as DISCORD_MAX_EVENT_COVER_BYTES, i as formatReactionEmoji, l as resolveChannelId, o as normalizeEmojiName, r as buildReactionIdentifier, s as normalizeReactionEmoji, t as buildDiscordSendError, x as DISCORD_MAX_EMOJI_BYTES, z as resolveDiscordRest } from "./send.shared-B7bqcLAe.js";
import { n as rewriteDiscordKnownMentions } from "./mentions-CQcSCv_e.js";
import { n as createDiscordSendResult } from "./send.receipt-Bse4z0LA.js";
import "./send.outbound-BlnwD1K7.js";
