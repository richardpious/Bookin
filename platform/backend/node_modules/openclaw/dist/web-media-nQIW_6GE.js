...
import { S as safeFileURLToPath, v as assertNoWindowsNetworkPath } from "./fs-safe-DYWmA8_q.js";
...
import { c as kindFromMime, i as getFileExtension, l as mimeTypeFromFilePath, n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-TnUOZVhx.js";
import { c as createImageProcessor, h as readImageProbeFromHeader, m as readImageMetadataFromHeader } from "./media-services-v2ADmdnV.js";
import { n as extnameFromAnyPath, t as basenameFromAnyPath } from "./file-name-r4prf02z.js";
import { i as resolveInboundMediaReference, t as MediaReferenceError } from "./media-reference-Jr0Vxuz7.js";
import { i as readRemoteMediaBuffer } from "./fetch-CwUUBT5O.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-DJeOPuXP.js";
...
const HOST_READ_DECLARED_TEXT_ERROR = "hostReadCapability permits only validated plain-text CSV/Markdown documents and trusted generated HTML reports for local reads";
const MB = 1024 * 1024;
...
function assertHostReadMediaAllowed(params) {
	...
	if (declaredMime && HOST_READ_DECLARED_TEXT_MIMES.has(declaredMime)) {
		...
		if (HOST_READ_TEXT_PLAIN_ALIASES.has(declaredMime) && !params.sniffedContentType && params.buffer && isValidatedHostReadText(params.buffer)) return;
