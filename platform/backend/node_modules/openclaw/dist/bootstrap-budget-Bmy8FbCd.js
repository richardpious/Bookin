...
function isAgentsBootstrapName(name) {
...
function formatBootstrapTruncationWarningLines(params) {
	...
	if (params.analysis.truncatedFiles.some((file) => isAgentsBootstrapName(file.name))) lines.push("AGENTS.md was truncated; read the full AGENTS.md before relying on scoped policy.");
...
//#endregion
export { buildBootstrapPromptWarningNotice as a, formatBootstrapTruncationWarningLines as c, buildBootstrapPromptWarning as i, resolveBootstrapWarningSignaturesSeen as l, appendBootstrapPromptWarning as n, buildBootstrapTruncationReportMeta as o, buildBootstrapInjectionStats as r, buildBootstrapTruncationSignature as s, analyzeBootstrapBudget as t };
