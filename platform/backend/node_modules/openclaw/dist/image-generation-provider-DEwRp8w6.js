...
import { l as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-DECw01pI.js";
import { n as assertOkOrThrowHttpError } from "./provider-http-errors-BEw8ykZh.js";
import { u as resolveClosestSize } from "./runtime-shared-BgK6LU_t.js";
import { c as postJsonRequest, l as postMultipartRequest, p as resolveProviderHttpRequestConfig } from "./shared-Dq1YVjzc.js";
import "./logging-core-C6RmwFjg.js";
import { r as isProviderApiKeyConfigured } from "./provider-auth-DL7jW6qn.js";
...
import "./media-generation-runtime-CW8W3b8i.js";
import { a as resolveApiKeyForProvider } from "./provider-auth-runtime-CIMWK-gU.js";
import "./provider-http-65KY4eRc.js";
import { c as parseOpenAiCompatibleImageResponse, u as toImageDataUrl } from "./image-generation-DfnMntGO.js";
import { n as canonicalizeCodexResponsesBaseUrl, t as OPENAI_CODEX_RESPONSES_BASE_URL } from "./base-url-COhRZ4t9.js";
import { i as OPENAI_DEFAULT_IMAGE_MODEL } from "./default-models-CJaO315p.js";
import { r as resolveConfiguredOpenAIBaseUrl } from "./shared-CpIn_KiO.js";
...
function hasCodexResponseTransportProfileConfigured(req) {
	...
	return listProfilesForProvider(store, "openai-codex").some((profileId) => store.profiles[profileId]?.type === "oauth" || store.profiles[profileId]?.type === "token");
}
...
function buildOpenAIImageGenerationProvider() {
	return createOpenAIImageGenerationProviderBase({
		...
		async generateImage(req) {
			...
			const useCodexResponseTransportRoute = publicOpenAIBaseUrl && !hasExplicitOpenAIDirectProviderConfig(req.cfg) && hasCodexResponseTransportProfileConfigured(req);
			...
			let imageAuth = preResolvedImageAuth ?? await resolveOptionalApiKeyForProvider({
				provider: "openai",
				cfg: req.cfg,
				agentDir: req.agentDir,
				store: req.authStore
			...
			if (!imageAuth?.apiKey) {
				...
				if (codexAuth?.apiKey) if (codexAuth.mode === "api-key") imageAuth = codexAuth;
				else {
					const timeoutMs = resolveOpenAIImageTimeoutMs(req.timeoutMs);
					logCodexImageAuthSelected({
						req,
				...
				if (!imageAuth?.apiKey) throw new Error("OpenAI API key or Codex OAuth missing");
			}
