...
import { n as GatewayClient, r as GatewayClientRequestError, u as loadDeviceAuthToken } from "./client-5XIBFtwk.js";
...
import { i as READ_SCOPE } from "./operator-scopes-DGvgHuOd.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-CF8z2NCS.js");
