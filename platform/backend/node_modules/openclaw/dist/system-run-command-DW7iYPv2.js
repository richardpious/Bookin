...
import { a as normalizeHostOverrideEnvVarKey } from "./host-env-security-B90drdeB.js";
import { O as normalizeExecutableToken, _ as resolvePowerShellInlineCommandMatch, d as unwrapKnownShellMultiplexerInvocation, f as POSIX_INLINE_COMMAND_FLAGS, g as resolveInlineCommandMatch, h as isPowerShellInlineRestCommandFlag, i as extractShellWrapperCommand, o as hasEnvManipulationBeforeShellWrapper, x as unwrapDispatchWrappersForResolution } from "./shell-wrapper-resolution-Dq5e0a-7.js";
...
function hasTrailingPositionalArgvAfterInlineCommand(argv) {
	...
	const inlineCommandIndex = wrapper === "powershell" || wrapper === "pwsh" ? resolvePowerShellInlineCommandMatch(wrapperArgv).valueTokenIndex : resolveInlineCommandMatch(wrapperArgv, POSIX_INLINE_COMMAND_FLAGS, { allowCombinedC: true }).valueTokenIndex;
...
//#endregion
export { buildSystemRunApprovalEnvBinding as a, normalizeSystemRunApprovalPlan as c, normalizeStringArray as d, buildSystemRunApprovalBinding as i, toSystemRunApprovalMismatchError as l, formatExecCommand as n, matchSystemRunApprovalBinding as o, resolveSystemRunCommandRequest as r, missingSystemRunApprovalBinding as s, extractShellCommandFromArgv as t, normalizeNonEmptyString as u };
