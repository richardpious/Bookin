...
import { r as normalizeElevenLabsBaseUrl } from "./shared-B7utk7gS.js";
...
function normalizeFiniteRange(value, min, max) {
	const parsed = parseFiniteNumber(value);
	return parsed !== void 0 && parsed >= min && parsed <= max ? parsed : void 0;
}
function normalizeIntegerRange(value, min, max) {
	const parsed = parseFiniteNumber(value);
	return parsed !== void 0 && Number.isSafeInteger(parsed) && parsed >= min && parsed <= max ? parsed : void 0;
}
...
//#endregion
export { testing as n, buildElevenLabsRealtimeTranscriptionProvider as t };
