...
import { b as ssrfPolicyFromHttpBaseUrlAllowedOrigin } from "./ssrf-_PxmDk0r.js";
import { n as fetchConfiguredLocalOriginWithSsrFGuard } from "./fetch-guard-BhIEUTw7.js";
...
import "./ssrf-runtime-internal-DK6CUWmL.js";
import { t as OLLAMA_CLOUD_BASE_URL } from "./defaults-Ct4-oW82.js";
import { t as readProviderBaseUrl, u as resolveOllamaApiBase } from "./provider-base-url-DhjcyT5d.js";
import { g as normalizeOllamaWireModelId } from "./stream-huUv_QYT.js";
...
async function createOllamaEmbeddingProvider(options) {
	...
	const embedQuery = async (text, options) => await embedOne(applyQueryInstructionTemplate(client.model, text), options?.signal);
	const provider = {
		id: "ollama",
		model: client.model,
		embedQuery,
		embedBatch: async (texts, options) => texts.length === 0 ? [] : await embedMany(texts, options?.signal)
	};
	return {
		provider,
		client: {
