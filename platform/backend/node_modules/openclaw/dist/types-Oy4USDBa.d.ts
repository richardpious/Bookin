...
import { H as TtsAutoMode } from "./types.slack-B4UzTgqu.js";
import { t as Skill } from "./skill-contract-Cn7l0Xnx.js";
...
type SessionEntry = {
  ...
  spawnedCwd?: string; /** Explicit parent session linkage for dashboard-created child sessions. */
  ...
  inheritedToolAllow?: string[]; /** Plugin id that created this session through api.runtime.subagent. */
...
//#endregion
export { SessionAcpMeta as a, SessionScope as c, SessionAcpIdentity as i, SessionSystemPromptReport as l, CliSessionBinding as n, SessionContextBudgetStatus as o, GroupKeyResolution as r, SessionEntry as s, AcpSessionRuntimeOptions as t };