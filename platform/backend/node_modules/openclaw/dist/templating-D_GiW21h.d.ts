import { h as InputProvenance, i as ReplyThreadingPolicy } from "./types-D4HaPNnq2.js";
import { d as MediaUnderstandingOutput, u as MediaUnderstandingDecision } from "./types-syw1tl7b.js";
import { n as CommandArgs } from "./commands-args.types-BetHnA9i.js";
...
type MsgContext = {
  ...
  MessageSidLast?: string; /** Per-turn reply-threading overrides. */
  ...
  MediaUrls?: string[];
  MediaTypes?: string[];
  MediaWorkspaceDir?: string; /** Attachment indexes whose audio was already transcribed before media understanding runs. */
  ...
  Sticker?: StickerContextMetadata; /** True when current-turn sticker media is present in MediaPaths (false for cached-description path). */
   ...
   */
  SupplementalContext?: SupplementalContextFacts; /** Untrusted metadata that must not be treated as system instructions. */
  UntrustedContext?: string[]; /** Structured untrusted metadata rendered by prompt assembly as fenced JSON. */
  ...
  LocationCaption?: string; /** Provider label. */
  ...
  BotUsername?: string;
  WasMentioned?: boolean; /** True when this turn explicitly mentioned the current bot target. */
  ...
  NativeChannelId?: string; /** Stable provider-native direct-peer id when a DM room/user mapping must survive later writes. */
...
declare function applyTemplate(str: string | undefined, ctx: TemplateContext): string;
//#endregion
export { CommandTurnKind as a, isExplicitCommandTurn as c, InboundEventKind as d, CommandTurnContext as i, isNativeCommandTurn as l, MsgContext as n, createCommandTurnContext as o, applyTemplate as r, isAuthorizedTextSlashCommandTurn as s, FinalizedMsgContext as t, isTextSlashCommandTurn as u };