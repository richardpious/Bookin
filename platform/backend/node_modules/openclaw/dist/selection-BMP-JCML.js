import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, n as localeLowercasePreservingWhitespace, p as readStringValue, s as normalizeOptionalLowercaseString } from "./string-coerce-DKw2K5wM.js";
import { t as isTruthyEnvValue } from "./env-B-C-u8eW.js";
import { a as redactSensitiveFieldValueWithConfig, n as isSensitiveFieldKey, r as redactSecrets, u as redactToolPayloadTextWithConfig } from "./redact-Ba9lUINf.js";
import { c as finiteSecondsToTimerSafeMilliseconds, m as parseStrictPositiveInteger, r as asFiniteNumber, s as clampTimerTimeoutMs, y as resolveIntegerOption } from "./number-coercion-DjYijOzx.js";
import "./parse-finite-number-D6V1jzY2.js";
import { y as resolveStateDir } from "./paths-BQQu4M8v.js";
import { i as asOptionalRecord, o as isRecord$1, r as asOptionalObjectRecord } from "./record-coerce-Btbek4uV.js";
...
import { _ as uniqueStrings, l as normalizeStringEntries, u as normalizeStringEntriesLower, v as uniqueValues } from "./string-normalization-B8G0vlWE.js";
import "./fs-safe-DYWmA8_q.js";
import { t as writeSiblingTempFile } from "./sibling-temp-Bp8wzam_.js";
...
import { p as resolveUserPath, y as truncateUtf16Safe } from "./utils-DlHt_n1Q.js";
import { n as VERSION } from "./version-BjFOZC7j.js";
import { r as normalizeProviderId } from "./provider-id-DhcncFyL.js";
import { v as resolveSessionAgentIds } from "./agent-scope-BeI1SY1H.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey } from "./session-key-utils-CdfsDYvz.js";
import { n as normalizeAccountId } from "./account-id-B0YIFDpA.js";
import { a as resolveAgentDir, i as resolveAgentContextLimits, r as resolveAgentConfig } from "./agent-scope-config-CaXAl7-j.js";
import "./boundary-file-read-CBe_wA_B.js";
import { i as loadPluginMetadataSnapshot, n as isPluginMetadataSnapshotCompatible } from "./plugin-metadata-snapshot-E7-VfWD1.js";
import { n as replaceFileAtomic } from "./replace-file-C7_Inj8B.js";
import { u as readRootJsonObjectSync } from "./json-files-ruLzKqUC.js";
import { a as emitTrustedDiagnosticEvent, b as freezeDiagnosticTraceContext, g as createChildDiagnosticTraceContext, o as emitTrustedDiagnosticEventWithPrivateData, t as areDiagnosticsEnabledForProcess, v as createDiagnosticTraceContextFromActiveScope, y as formatDiagnosticTraceparent } from "./diagnostic-events-CNGydBWO.js";
import { t as createSubsystemLogger } from "./subsystem-Blo0_rG4.js";
import { i as resolveEffectivePluginActivationState, r as normalizePluginsConfigWithResolver } from "./manifest-registry-BSpfEroo.js";
import { y as getCurrentPluginMetadataSnapshot } from "./plugin-registry-ChAglW1O.js";
import "./fs-safe-advanced-CBe_wA_B.js";
import { i as getRuntimeConfig } from "./io-By9euW-h.js";
import { t as applyMergePatch } from "./merge-patch-D2ldaTkZ.js";
...
import { a as normalizeAnyChannelId } from "./registry-CgCBMWZD.js";
import { i as normalizeMessageChannel, t as isDeliverableMessageChannel } from "./message-channel-normalize-mFW26rOU.js";
import "./message-channel-7236hqCk.js";
import { n as ensureGlobalUndiciDispatcherStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-CJimgdNq.js";
...
import { a as listRegisteredAgentHarnesses, r as getRegisteredAgentHarness } from "./registry-CioemnkT.js";
import { L as getCompactionProvider } from "./loader-wybWjJVr.js";
import { A as listRegisteredPluginAgentPromptGuidance } from "./command-registration-BWsYSY_K.js";
import { d as setReplyPayloadMetadata } from "./reply-payload-DM17pxMC.js";
import { l as fireAndForgetBoundedHook, s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-BdHeqZIb.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-BjnrbaLv.js";
import { s as resolveContextEngineOwnerPluginId } from "./registry-BrFVwMmw.js";
...
import { N as isCacheEnabled, P as resolveCacheTtlMs, j as createExpiringMapCache, t as loadSessionStore } from "./store-load-BHiTqlRK.js";
...
import { c as runQuotaSuspensionMaintenance, f as updateSessionStoreEntry } from "./store-Dh6bWvq_.js";
import { r as MAX_IMAGE_BYTES } from "./constants-D9zVCSKe.js";
import { l as mimeTypeFromFilePath } from "./mime-TnUOZVhx.js";
import { c as bindOwnedSessionTranscriptWrites, f as redactTranscriptMessage, l as withOwnedSessionTranscriptWrites, s as appendSessionTranscriptMessage } from "./transcript-CDJoY4Ie.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-DGgnvvtU.js";
import { a as parseAssistantTextSignature, s as resolveAssistantMessagePhase, t as extractAssistantTextForPhase } from "./chat-message-content-CeOacmio.js";
import { c as resolveSessionLockMaxHoldFromTimeout, d as resolveSessionWriteLockOptions, i as acquireSessionWriteLock } from "./session-write-lock-5bJqdAc_.js";
import { n as isSessionWriteLockTimeoutError } from "./session-write-lock-error-HvDhYM6H.js";
import { i as serializeJsonlLine, s as writeJsonlLines } from "./transcript-jsonl-LFU2CQ2E.js";
import { G as transformProviderSystemPrompt, K as validateProviderReplayTurnsWithPlugin, M as resolveProviderSystemPromptContribution, N as resolveProviderTextTransforms, O as resolveProviderReasoningOutputModeWithPlugin, V as sanitizeProviderReplayHistoryWithPlugin, w as resolveProviderCacheTtlEligibility } from "./provider-runtime-Cp-fJ4cK.js";
import { n as parseBooleanValue } from "./boolean-CZag3-H2.js";
import { c as hasCopilotVisionInput, o as buildCopilotDynamicHeaders } from "./copilot-dynamic-headers-CVy4X1Kj.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-87u0i3T-.js";
...
import { d as resolveModelAuthMode } from "./model-auth-sFspw--v.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-BF52cjJK.js";
import { r as resolveAgentTimeoutMs } from "./task-completion-contract-J-Ef4cSA.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-DAz1JBuy.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-BNTcXm1Z.js";
import { a as stripDowngradedToolCallText, d as findFinalTagMatches, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-ye5B62pZ.js";
import { C as parseExecApprovalResultText } from "./sanitize-user-facing-text-CY8fNjm7.js";
import { f as stripRuntimeContextCustomMessages, u as stripHistoricalRuntimeContextCustomMessages } from "./internal-runtime-context-hfmw8MFR.js";
import { i as markDiagnosticRunProgress } from "./diagnostic-run-activity-DfY2SXQ5.js";
import { C as resolveEmbeddedSessionFileKey, b as updateActiveEmbeddedRunSnapshot, r as clearActiveEmbeddedRun, u as markActiveEmbeddedRunAbandoned, v as setActiveEmbeddedRun, y as updateActiveEmbeddedRunSessionFile } from "./runs-DMxJUP3Q.js";
...
import { C as stripInternalMetadataForDisplay, S as jsonUtf8BytesOrInfinity, b as firstEnumerableOwnKeys, y as boundedJsonUtf8Bytes } from "./session-utils.fs-clE0lv0B.js";
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage } from "./usage-BLlQI-Ap.js";
import { i as hasInterSessionUserProvenance, n as annotateInterSessionPromptText, r as applyInputProvenanceToUserMessage, s as normalizeInputProvenance } from "./input-provenance-DHJ0e-Wv.js";
import { t as estimateStringChars } from "./cjk-chars-BtjJDifS.js";
import { t as parseInlineDirectives } from "./directive-tags-DBD-mk-0.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-Dfgqc5tP.js";
import { t as SessionManager } from "./session-manager-Fxwb-hrq.js";
import { i as streamSimple, o as getApiProvider } from "./stream-To8o5poZ.js";
import { r as createAssistantMessageEventStream } from "./event-stream-C9Fn8W_T.js";
import { at as SettingsManager, o as createAgentSession, s as DefaultResourceLoader } from "./sessions-ON1BrWsD.js";
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-t09uTJ5G.js";
import { n as matchesAnyGlobPattern, t as compileGlobPatterns } from "./glob-pattern-CrqljM7B.js";
import { f as expandToolGroups, m as normalizeToolName, p as normalizeToolList } from "./tool-policy-CY4w5sXw.js";
...
import { c as normalizeInteractiveReply, l as normalizeMessagePresentation } from "./payload-Cpx3heIy.js";
import { C as REQUIRED_PARAM_GROUPS, T as isEmbeddedMode, d as isStrictAgenticSupportedProviderModel, f as stripProviderPrefix } from "./openclaw-tools-C1FG9NMc.js";
import { t as resolveAccountEntry } from "./account-lookup-Ce9roNb4.js";
import { o as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-ixjQfAGB.js";
import { i as resolveInheritedToolPolicyForSession, n as resolveEffectiveToolPolicy, o as resolveSubagentToolPolicyForSession, r as resolveGroupToolPolicy } from "./agent-tools.policy-Cg71SQyZ.js";
import { i as isCliRuntimeProvider, r as isCliRuntimeAliasForProvider } from "./model-runtime-aliases-DdKzTF-r.js";
import { t as resolveSenderToolPolicy } from "./sender-tool-policy-BorZvnUX.js";
import { n as OPENCLAW_EMBEDDED_CONTEXT_ENGINE_HOST, r as assertContextEngineHostSupport } from "./host-compat-BibWlia2.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-CvldQmVh.js";
import { o as normalizeHeartbeatToolResponse } from "./heartbeat-tool-response-BO5sRfPm.js";
import { d as stripHeartbeatToken } from "./heartbeat-dtJ8QRZo.js";
import { t as filterHeartbeatTranscriptArtifacts } from "./heartbeat-filter-B34UDSwJ.js";
import { t as resolveDiagnosticModelContentCapturePolicy } from "./diagnostic-llm-content-LjvSdcWz.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-CA3EsP9j.js";
import { t as getMachineDisplayName } from "./machine-name-C08F-g3p.js";
import { _ as sanitizeToolUseResultPairing, b as supportsModelTools, f as sanitizeTransportPayloadText, g as sanitizeToolCallInputs, h as repairToolUseResultPairing, m as makeMissingToolResult, u as mergeTransportHeaders, v as stripToolResultDetails, y as buildGuardedModelFetch } from "./openai-transport-stream-N4q_7Mj8.js";
import { t as log$6 } from "./logger-XoMf1uta.js";
import { c as isAnthropicModelRef, s as isAnthropicFamilyCacheTtlEligible, u as createCodexNativeWebSearchWrapper } from "./proxy-DTJQAioB.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-JukSqUUt.js";
import { a as sanitizeToolCallIdsForCloudCodeAssist, n as extractToolResultId, r as extractToolResultIds, t as extractToolCallsFromAssistant } from "./tool-call-id-B9whgasj.js";
import { i as streamWithPayloadPatch } from "./moonshot-thinking-DiiYXWxD.js";
import { _ as listActiveProcessSessionReferences, a as prependSystemPromptAddition, c as resolvePromptBuildHookResult, d as shouldInjectHeartbeatPrompt, f as shouldWarnOnOrphanedUserRepair, i as mergeOrphanedTrailingUserPrompt, l as resolvePromptModeForSession, n as buildAfterTurnRuntimeContextFromUsage, o as resolveAttemptFsWorkspaceOnly, s as resolveAttemptPrependSystemContext, t as buildAfterTurnRuntimeContext, u as resolvePromptSubmissionSkipReason, v as buildAgentHookContextChannelFields } from "./attempt.prompt-helpers-BENv5V3t.js";
import { i as getPluginToolMeta } from "./tools-DCcZqUtD.js";
import { s as loadWorkspaceSkillEntries, u as resolveSkillsPromptForRun } from "./workspace-CrAPndhs.js";
import { i as resolveSkillRuntimeConfig, n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-chmgYHTL.js";
import { n as redactConfigObject } from "./redact-snapshot-B4Fp0zuB.js";
import { t as resolveCommitHash } from "./git-commit-DUCVesq8.js";
import { t as resolveOsSummary } from "./os-summary-CbPEyjoY.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-CkISVHMK.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-CpV_GD0S.js";
import { t as createBundleLspToolRuntime } from "./agent-bundle-lsp-runtime-DukvILcs.js";
import { a as getOrCreateSessionMcpRuntime, p as loadEmbeddedAgentMcpConfig } from "./agent-bundle-mcp-runtime-n24dxm4C.js";
import { r as materializeBundleMcpToolsForRun } from "./agent-bundle-mcp-materialize-BvdX-mc8.js";
import "./agent-bundle-mcp-tools-DYx8xrZZ.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyAgentAutoCompactionGuard, r as applyAgentCompactionSettingsFromConfig } from "./agent-settings-OfQQMq1r.js";
...
import { A as resolveChannelMessageToolHints, M as resolveChannelReactionGuidance, S as markCodeModeControlTool, j as resolveChannelPromptCapabilities, k as listChannelSupportedActions, v as CODE_MODE_EXEC_TOOL_NAME, x as isCodeModeControlTool, y as CODE_MODE_WAIT_TOOL_NAME } from "./agent-tools.before-tool-call-CcOZYWx4.js";
import { l as jsonResult, n as ToolInputError, r as asToolParamsRecord } from "./common-COS7PQnH.js";
import { r as resolveImageSanitizationLimits } from "./image-sanitization-B1anI66H.js";
import { a as toClientToolDefinitions, n as createClientToolNameConflictError, r as findClientToolNameConflicts, t as splitSdkTools } from "./tool-split-CGOn6jBW.js";
import { _ as isLocalModelLeanEnabled, a as TOOL_SEARCH_CODE_MODE_TOOL_NAME, c as addClientToolsToToolCatalog, d as applyToolSearchCatalog, f as clearToolSearchCatalog, g as filterLocalModelLeanTools, h as resolveToolSearchConfig, i as TOOL_DESCRIBE_RAW_TOOL_NAME, l as addClientToolsToToolSearchCatalog, m as projectToolSearchTargetTranscriptMessages, n as resolveProcessToolScopeKey, o as TOOL_SEARCH_RAW_TOOL_NAME, p as createToolSearchCatalogRef, r as TOOL_CALL_RAW_TOOL_NAME, s as ToolSearchRuntime, t as createOpenClawCodingTools, u as applyToolCatalogCompaction } from "./agent-tools-DkIWbsdu.js";
import { o as optionalStringEnum } from "./typebox-C9t0xBZ7.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-xDEnYsRC.js";
import { c as resolveMainSessionAlias, s as resolveInternalSessionKey } from "./sessions-helpers-TJ3ZsvFq.js";
import { i as generateSecureToken } from "./secure-random-BxnbXS5x.js";
import { c as hasCommittedMessagingToolDeliveryEvidence, f as hasAcceptedSessionSpawn, l as hasMessagingToolDeliveryEvidence, p as normalizeAcceptedSessionSpawnResult, y as mediaUrlsFromGeneratedAttachments } from "./subagent-announce-delivery-B4FRyugH.js";
import { r as wrapUntrustedPromptDataBlock, t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-ByaJGDhT.js";
import { b as resolveBootstrapTotalMaxChars, c as sanitizeSessionMessagesImages, d as normalizeOpenAIResponsesToolCallIds, l as downgradeOpenAIFunctionCallReasoningPairs, n as validateAnthropicTurns, o as isMessagingToolDuplicateNormalized, r as validateGeminiTurns, s as normalizeTextForComparison, u as downgradeOpenAIReasoningBlocks, v as resolveBootstrapMaxChars, x as sanitizeGoogleTurnOrdering, y as resolveBootstrapPromptTruncationWarningMode } from "./embedded-agent-helpers-xBQcYQq8.js";
import { P as formatToolAggregate } from "./streaming-Bv78t77e.js";
import { i as scanFenceSpans } from "./fences-sf8supmN.js";
import { r as splitMediaFromOutput } from "./parse-CJxWJ21x.js";
import { p as parseReplyDirectives } from "./payloads-CsNPmG7g.js";
import { d as shouldSuppressRawErrorConsoleSuffix, l as buildApiErrorObservationFields, p as MissingAgentHarnessError, u as buildTextObservationFields } from "./model-fallback-DRgKirrj.js";
import { a as extractThinkingFromTaggedStream, c as inferToolMetaFromArgs, i as extractAssistantVisibleText, l as isAssistantMessage, n as extractAssistantText, o as extractThinkingFromTaggedText, r as extractAssistantThinking, t as THINKING_TAG_SCAN_RE, u as promoteThinkingTagsToBlocks } from "./embedded-agent-utils-CjcypG6C.js";
import { n as normalizeGoogleApiBaseUrl } from "./google-api-base-url-UBNiBOzj.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-D0aayror.js";
import { n as buildSubagentList } from "./subagent-list-BEvbEIv2.js";
import { a as listControlledSubagentRuns } from "./subagent-control-BiA-0YNH.js";
import { o as resolveSandboxContext } from "./sandbox-Dy_6WAUg.js";
import { n as createAnthropicVertexStreamFnForModel } from "./simple-completion-transport-Dq0HzfXY.js";
import { r as createBoundaryAwareStreamFnForModel, t as registerProviderStreamForModel } from "./provider-stream-CK-3ziP0.js";
import { a as buildBootstrapPromptWarningNotice, i as buildBootstrapPromptWarning, o as buildBootstrapTruncationReportMeta, r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-Bmy8FbCd.js";
import { i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-Jtae_iZP.js";
import { t as resolveHeartbeatPromptForSystemPrompt } from "./heartbeat-system-prompt-aXOfH9x9.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-DyXQ-M1b.js";
import { a as extractToolResultMediaArtifact, c as isToolResultError, d as sanitizeToolResult, f as collectTextContentBlocks, h as isMessagingToolSendAction, i as extractToolErrorMessage, l as isToolResultTimedOut, m as isMessagingTool, n as extractMessagingToolSend, o as extractToolResultText$1, p as isMessageToolSendActionName, r as extractToolErrorCode, s as filterToolResultMediaUrls, t as buildToolLifecycleErrorResult, u as sanitizeToolArgs } from "./embedded-agent-subscribe.tools-mYHOvfka.js";
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-DIqK0fbR.js";
import { t as EmbeddedBlockChunker } from "./embedded-agent-block-chunker-Bbi8NJmo.js";
import { a as buildSystemPromptParams, n as appendModelIdentitySystemPrompt, o as resolveAgentPromptSurfaceForSessionKey, t as buildConfiguredAgentSystemPrompt } from "./system-prompt-config-p3G0fHzO.js";
import { _ as resolveCompactionTimeoutMs, a as formatPrePromptPrecheckLog, b as shouldAllowProviderOwnedThinkingReplay, d as estimateMessagesTokens, f as pruneHistoryForContextShare, l as SUMMARIZATION_OVERHEAD_TOKENS, m as summarizeInStages, n as PREEMPTIVE_OVERFLOW_ERROR_TEXT, o as shouldPreemptivelyCompactBeforePrompt, p as resolveContextWindowTokens$1, r as buildPrePromptContextBudgetStatus, s as createAgentToolResultMiddlewareRunner, t as buildEmbeddedAttemptToolRunContext, u as computeAdaptiveChunkRatio, v as providerRequiresSignedThinking, x as runAgentCleanupStep, y as resolveTranscriptPolicy } from "./attempt.tool-run-context-D-IeXRoG.js";
import { a as normalizeAgentRuntimeTools, i as logAgentRuntimeToolDiagnostics, t as filterRuntimeCompatibleTools } from "./tool-schema-projection-B3ZSp9BA.js";
import { a as resolveLiveToolResultMaxChars, d as formatContextLimitTruncationNotice, l as truncateOversizedToolResultsInSessionManager, s as truncateOversizedToolResultsInMessages, t as DEFAULT_MAX_LIVE_TOOL_RESULT_CHARS, u as truncateToolResultMessage } from "./tool-result-truncation-CerX1wUp.js";
import { a as setRawSessionAppendMessage, c as readTranscriptFileState, i as getRawSessionAppendMessage, l as writeTranscriptFileAtomic, o as TranscriptFileState } from "./transcript-rewrite-BoBMYnet.js";
import { t as detectRuntimeShell } from "./shell-utils-BDYMhC5E.js";
import { i as resolveUserTimezone } from "./date-time-BGhCenVw.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-Bd8ESWer.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-BXLGqh0b.js";
import { a as finalizeHarnessContextEngineTurn, c as runContextEngineMaintenance, n as bootstrapHarnessContextEngine, t as assembleHarnessContextEngine } from "./context-engine-lifecycle-B4rWPTiQ.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-g15iy8bK.js";
import { n as resolveCronStyleNow } from "./current-time-Bx47WQ4W.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-CLq1xHPJ.js";
import "./query-B4JgyjxH.js";
import { s as resolveContextWindowInfo } from "./context-window-guard-uEhQwuGa.js";
import { r as resolveEmbeddedSandboxInfoExecPolicy, t as buildEmbeddedSandboxInfo } from "./sandbox-info-DtQ4oeb_.js";
import { a as shouldCreateBundleMcpRuntimeForAttempt, i as shouldCreateBundleLspRuntimeForAttempt, n as mergeForcedEmbeddedAttemptToolsAllow, r as resolveEmbeddedAttemptToolConstructionPlan, t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-B1KVIpvC.js";
import "./tool-loop-detection-DCEGSB_Y.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-DrgOy9AX.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-YUc2rvlg.js";
import { t as detectAndLoadPromptImages } from "./images-BhxWmMaR.js";
import { o as resolveRuntimeContextPromptParts, r as buildRuntimeContextCustomMessage, t as buildCurrentInboundPrompt } from "./runtime-context-prompt-DwVoGddF.js";
...
const log$5 = createSubsystemLogger("embedded-agent-settings");
...
function loadBundleSettingsFile(params) {
	...
	if (!result.ok && result.reason === "open") {
		log$5.warn(`skipping unsafe bundle settings file: ${absolutePath}`);
		return null;
	}
	if (!result.ok) {
		log$5.warn(`${result.error}: ${absolutePath}`);
		return null;
	}
...
function loadEnabledBundleAgentSettingsSnapshot(params) {
	...
	for (const diagnostic of embeddedAgentMcp.diagnostics) log$5.warn(`bundle MCP skipped for ${diagnostic.pluginId}: ${diagnostic.message}`);
...
function normalizeCodeModeWorkerResult(result) {
	if (result.status === "failed" && result.code === "timeout" && result.error === "interrupted") return {
		...result,
	...
	try {
		return await new Promise((resolve) => {
			...
			worker.once("message", (message) => {
				worker.terminate();
				finish(normalizeCodeModeWorkerResult(isRecord$1(message) ? message : {
					status: "failed",
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-5YrNUWOu.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./plugins/hook-runner-global.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-DWiH5JIa.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./agent-tools.before-tool-call-CF2pz3Qr.js"));
...
async function collectEmittedToolOutputMediaUrls(toolName, outputText, result, trustedLocalMediaToolNames) {
...
async function emitToolResultOutput(params) {
	...
	if (!shouldSuppressStructuredMediaToolOutput({
		...
		if (outputText) {
			...
			if (ctx.params.toolResultFormat === "plain") emittedToolOutputMediaUrls = await collectEmittedToolOutputMediaUrls(rawToolName, outputText, result, ctx.trustedLocalMediaToolNames);
		}
...
function subscribeEmbeddedAgentSession(params) {
	...
	const emitToolResultMessage = (toolName, message, result) => {
		...
		const filteredMediaUrls = filterToolResultMediaUrls(toolName, mediaUrls ?? [], result, params.trustedLocalMediaToolNames);
	...
	const stripBlockTags = (text, state, options) => {
		...
		state.pendingFenceFragment = void 0;
		...
		let hiddenInlineState = state.reasoningInlineCode ? { ...state.reasoningInlineCode } : createInlineCodeState();
		let hiddenFenceState = state.reasoningFence?.open ? {
			atLineStart: state.reasoningFence.atLineStart,
			open: { ...state.reasoningFence.open }
		} : state.reasoningFence ? { atLineStart: state.reasoningFence.atLineStart } : void 0;
		let hiddenPendingFenceFragment = state.reasoningPendingFenceFragment;
		state.reasoningPendingFenceFragment = void 0;
		...
		state.reasoningInlineCode = inThinking ? hiddenInlineState : void 0;
		state.reasoningFence = inThinking ? hiddenFenceState : void 0;
		state.reasoningPendingFenceFragment = inThinking ? hiddenPendingFenceFragment : void 0;
		...
		if (!everInFinal) {
			...
			state.fence = finalCodeSpans.fenceState;
			state.finalInlineCode = void 0;
			state.finalFence = void 0;
			return "";
		}
		...
		state.inlineCode = finalCodeSpans.inlineState;
		state.fence = finalCodeSpans.fenceState;
		state.finalInlineCode = inFinal ? resultCodeSpans.inlineState : void 0;
		state.finalFence = inFinal ? resultCodeSpans.fenceState : void 0;
...
async function persistUserTurnTranscript(params) {
	...
	if (!message) return;
	const { resolveSessionTranscriptFile } = await import("./transcript-Djcg9p_-.js");
...
function createUserTurnTranscriptRecorder(params) {
	...
	const handlePersistenceError = (error) => {
		...
		import("./globals-C-KmomKC.js").then(({ logVerbose }) => {
...
function logRuntimeToolSchemaQuarantine(params) {
	...
	log$3.warn(`[tools] quarantined ${params.diagnostics.length} unsupported tool schema${params.diagnostics.length === 1 ? "" : "s"} before model runtime projection: ${summary}. Run openclaw doctor for details.`);
}
//#endregion
...
function buildAgentToolResultMiddlewareFactory() {
	...
	return (agent) => {
		agent.on("tool_result", async (rawEvent, ctx) => {
			...
			const toolCallId = typeof event.toolCallId === "string" && event.toolCallId.trim() ? event.toolCallId : `openclaw-${randomUUID()}`;
			const current = {
...
function waitForSessionFileOwnerRelease(params) {
	if (params.signal?.aborted) return Promise.reject(abortOwnerWaitReason(params.signal));
	return new Promise((resolve, reject) => {
		const waiter = {
			resolve,
			reject,
...
async function sanitizeSessionHistory(params) {
	...
	const validatedThinkingSignatures = signedThinkingProvider || policy.preserveSignatures ? stripInvalidThinkingSignatures(sanitizedImages, { preserveLatestAssistant: preserveLatestAssistantThinking }) : sanitizedImages;
...
function duplicateSignature(message) {
	if (!isRecord$1(message) || message.role !== "user" || typeof message.timestamp !== "number") return;
...
function collectDuplicateUserMessageEntryIdsForCompaction(entries, options = {}) {
	...
	for (const entry of entries) {
		...
		const signature = duplicateSignature(isRecord$1(entry.message) ? entry.message : void 0);
...
async function cleanupEmbeddedAttemptResources(params) {
	...
	if (sessionLockReleaseError) throw sessionLockReleaseError;
}
//#endregion
...
function resolveLlmIdleTimeoutMs(params) {
	...
	const timeoutBounds = [runTimeoutMs, agentTimeoutMs].filter((value) => typeof value === "number" && Number.isFinite(value) && value > 0 && value < 2147e6);
...
async function runEmbeddedAttempt(params) {
	...
	try {
		...
		const filteredBundledTools = applyFinalEffectiveToolPolicy({
			bundledTools: applyEmbeddedAttemptToolsAllow([...bundleMcpRuntime?.tools ?? [], ...bundleLspRuntime?.tools ?? []], effectiveToolsAllow, { toolMeta: (tool) => getPluginToolMeta(tool) }),
			config: params.config,
		...
		try {
			...
			const abortRun = (isTimeout = false, reason) => {
				...
				if (isTimeout && queueHandleForAbandonment) {
					...
					sessionLockController.releaseHeldLockForAbort().catch((err) => {
						log$6.warn(`failed to release session lock on timeout abort: runId=${params.runId} ${String(err)}`);
					});
				}
			};
			...
			try {
				...
				try {
					...
					if (promptToolResultTruncation.truncatedCount > 0) {
						...
						log$6.info(`[tool-result-truncation] Truncated ${promptToolResultTruncation.truncatedCount} tool result(s) for prompt history (maxChars=${promptToolResultMaxChars} aggregateBudgetChars=${promptToolResultMaxChars * PROMPT_TOOL_RESULT_AGGREGATE_CAP_MULTIPLIER}) sessionKey=${params.sessionKey ?? params.sessionId ?? "unknown"}`);
					}
			...
			if (cleanupFailure) if (shouldPreservePromptError) {
				log$6.warn(`embedded attempt cleanup detected session takeover after prompt failure; preserving prompt error: runId=${params.runId} sessionId=${params.sessionId} promptError=${formatErrorMessage(promptError)} cleanupError=${formatErrorMessage(cleanupFailure)}`);
				await Promise.reject(new EmbeddedAttemptPromptErrorWithCleanupTakeoverError({
					promptError,
					cleanupError: cleanupFailure
				}));
			} else await Promise.reject(cleanupFailure);
		}
	} finally {
		removeExternalAbortSignalListener?.();
		try {
		...
		retainedSessionFileOwner = void 0;
...
async function runAgentHarnessAttempt(params) {
	...
	if (harness.id === "openclaw") return await runAgentHarnessV2LifecycleAttempt(v2Harness, attemptParams);
	try {
...
//#endregion
export { readPostCompactionContext as $, shouldRotateCompactionTranscript as A, createTrajectoryRuntimeRecorder as At, resolveEmbeddedAgentBaseStreamFn as B, EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE as C, resolveSilentToolResultReplyPayload as Ct, resolveBootstrapMode as D, observeReplayMetadata as Dt, shouldWarnEmbeddedRunStageSummary as E, createEmbeddedRunReplayState as Et, collectAllowedToolNames as F, sanitizeSessionHistory as G, prewarmSessionFile as H, collectRegisteredToolNames as I, getHistoryLimitFromSessionKey as J, validateReplayTurns as K, toSessionToolAllowlist as L, flushPendingToolResultsAfterIdle as M, mapThinkingLevel as N, rotateTranscriptAfterCompaction as O, createPreparedEmbeddedAgentSettingsManager as Ot, normalizeContextTokenBudget as P, isRealConversationMessage as Q, applySystemPromptToSession as R, mergeUsageIntoAccumulator as S, resolveRunLivenessState as St, formatEmbeddedRunStageSummary as T, shouldTreatEmptyAssistantReplyAsSilent as Tt, trackSessionManagerAccess as U, resolveEmbeddedAgentStreamFn as V, createEmbeddedAgentResourceLoader as W, buildEmbeddedExtensionFactories as X, limitHistoryTurns as Y, hasMeaningfulConversationContent as Z, resolveOverloadProfileRotationLimit as _, resolveIncompleteTurnPayloadText as _t, RUNTIME_AUTH_REFRESH_MARGIN_MS as a, buildPersistedUserTurnMediaInputsFromFields as at, scrubAnthropicRefusalMagic as b, resolveReasoningOnlyRetryInstruction as bt, buildErrorAgentMeta as c, repairSessionFileIfNeeded as ct, isAssistantForModelRef as d, collectRuntimeChannelCapabilities as dt, consumeCompactionSafeguardCancelReason as et, resolveActiveErrorContext as f, STRICT_AGENTIC_BLOCKED_TEXT as ft, resolveOverloadFailoverBackoffMs as g, resolveEmptyResponseRetryInstruction as gt, resolveMaxRunRetryIterations as h, resolveAttemptReplayMetadata as ht, selectAgentHarness as i, appendUserTurnTranscriptMessage as it, dedupeDuplicateUserMessagesForCompaction as j, resolveEmbeddedRunSkillEntries as jt, rotateTranscriptFileAfterCompaction as k, isReasoningTagProvider as kt, buildUsageAgentMetaFields as l, STREAM_ERROR_FALLBACK_TEXT as lt, resolveFinalAssistantVisibleText as m, resolveAckExecutionFastPathInstruction as mt, resolveAvailableAgentHarnessPolicy as n, logRuntimeToolSchemaQuarantine as nt, RUNTIME_AUTH_REFRESH_MIN_DELAY_MS as o, createUserTurnTranscriptRecorder as ot, resolveFinalAssistantRawText as p, extractPlanningOnlyPlanDetails as pt, buildEmbeddedMessageActionDiscoveryInput as q, runAgentHarnessAttempt as r, guardSessionManager as rt, RUNTIME_AUTH_REFRESH_RETRY_MS as s, resolvePersistedUserTurnText as st, maybeCompactAgentHarnessSession as t, setCompactionSafeguardCancelReason as tt, createCompactionDiagId as u, buildUsageWithNoCost as ut, resolveRateLimitProfileRotationLimit as v, resolvePlanningOnlyRetryInstruction as vt, createEmbeddedRunStageTracker as w, shouldRetryMissingAssistantTurn as wt, createUsageAccumulator as x, resolveReplayInvalidFlag as xt, resolveReportedModelRef as y, resolvePlanningOnlyRetryLimit as yt, buildEmbeddedSystemPrompt as z };
