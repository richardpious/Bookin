...
import { c as isDiagnosticsEnabled, i as emitInternalDiagnosticEvent, t as areDiagnosticsEnabledForProcess } from "./diagnostic-events-CNGydBWO.js";
...
import { a as resetDiagnosticRunActivityForTest, t as getDiagnosticSessionActivitySnapshot } from "./diagnostic-run-activity-DfY2SXQ5.js";
import { i as resetDiagnosticStabilityRecorderForTest, o as startDiagnosticStabilityRecorder, s as stopDiagnosticStabilityRecorder } from "./diagnostic-stability-B5DLb6EX.js";
import { a as installDiagnosticStabilityFatalHook, d as uninstallDiagnosticStabilityFatalHook, f as writeDiagnosticMemoryPressureBundleSync, l as resetDiagnosticStabilityBundleForTest } from "./diagnostic-stability-bundle-D07FkRnA.js";
import { n as getRecentDiagnosticPhases, r as resetDiagnosticPhasesForTest, t as getCurrentDiagnosticPhase } from "./diagnostic-phase-C4T_uTKE.js";
import { a as markDiagnosticActivity, n as getLastDiagnosticActivityAt, o as resetDiagnosticActivityForTest, t as diagnosticLogger } from "./diagnostic-runtime-DmjXzyoD.js";
import { a as peekDiagnosticSessionState, i as isDiagnosticSessionStateCurrent, n as getDiagnosticSessionState, o as pruneDiagnosticSessionStates, r as getDiagnosticSessionStateCountForTest$1, s as resetDiagnosticSessionStateForTest, t as diagnosticSessionStates } from "./diagnostic-session-state-DwjGSduD.js";
...
function classifySessionAttention(params) {
	if (params.activity.activeWorkKind) {
		if (params.state === "idle" && params.queueDepth > 0 && params.activity.hasActiveEmbeddedRun !== true && (params.activity.lastProgressAgeMs ?? 0) > params.staleMs) return {
