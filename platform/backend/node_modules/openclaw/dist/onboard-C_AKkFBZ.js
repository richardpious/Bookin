...
import { l as isValidEnvSecretRefId, m as resolveSecretInputRef } from "./types.secrets-CuOz9KrZ.js";
...
import "./daemon-runtime-C5rLdYLT.js";
import { s as resolveDefaultSecretProviderAlias } from "./ref-contract-C46R_Xj3.js";
import { t as resolveConfiguredSecretInputString } from "./resolve-configured-secret-input-string-sbCz989A.js";
...
import { r as formatInvalidPortOption } from "./error-format-ZFU1PhmU.js";
...
import { c as normalizeGatewayTokenInput, m as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-BelfoDhi.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-BMYAYGL5.js";
import { i as applySkipBootstrapConfig, r as applyLocalSetupWorkspaceConfig } from "./onboard-config-D7UEGvik.js";
import { t as createNonInteractiveLoggingPrompter } from "./non-interactive-prompter-CGPDOJMx.js";
import { t as runSetupWizard } from "./setup-BbUR4CSN.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-CRA7x4Mx.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-BsVkGG2s.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-BycOitjK.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
		workspaceDir,
		env: process.env
	});
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-BFVklEV_.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-WSrg0YvO.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-yHEdqv81.js");
...
async function runNonInteractiveMigrationImport(params) {
	...
	const { detectSetupMigrationSources, runSetupMigrationImport } = await import("./setup.migration-import-DZWeGAk8.js");
