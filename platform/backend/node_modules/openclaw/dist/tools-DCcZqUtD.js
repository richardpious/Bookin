...
import { _ as uniqueStrings, p as normalizeUniqueStringEntries } from "./string-normalization-B8G0vlWE.js";
import { s as normalizePluginsConfig, t as applyTestPluginDefaults } from "./config-state-Cz5agD6j.js";
...
import { a as loadManifestContractSnapshot, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-DfXtj3dh.js";
import { t as findUndeclaredPluginToolNames } from "./tool-contracts-B4ca1WYv.js";
import { n as getLoadedRuntimePluginRegistry } from "./active-runtime-registry-CmiKiXSu.js";
import { i as resolvePluginRuntimeLoadContext, t as buildPluginRuntimeLoadOptions } from "./load-context-CUMIxKGA.js";
...
import { t as hasManifestToolAvailability } from "./manifest-tool-availability-DOJymO1T.js";
import { t as ensureStandaloneRuntimePluginRegistryLoaded } from "./standalone-runtime-registry-loader-BBbi9sLu.js";
		...
		async execute(toolCallId, executeParams, signal, onUpdate) {
			...
			const resolveCandidateTool = (candidate) => {
				...
				for (const toolRaw of listRaw) {
					...
					if (normalizeToolName(runtimeTool.name) === requestedToolName) return runtimeTool;
				}
			};
			const matchingNamedCandidates = candidates.filter((candidate) => candidate.names.length > 0 && candidate.names.some((name) => normalizeToolName(name) === requestedToolName));
...
//#endregion
export { resolvePluginTools as a, getPluginToolMeta as i, copyPluginToolMeta as n, setPluginToolMeta as o, ensureStandalonePluginToolRegistryLoaded as r, resetPluginToolDescriptorCache as s, buildPluginToolMetadataKey as t };
