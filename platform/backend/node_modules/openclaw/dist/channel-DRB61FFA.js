import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, l as normalizeOptionalStringifiedId } from "./string-coerce-DKw2K5wM.js";
import { u as parseThreadSessionSuffix } from "./session-key-utils-CdfsDYvz.js";
...
import { b as readStringParam, g as readPositiveIntegerParam, i as createActionGate, t as ToolAuthorizationError } from "./common-COS7PQnH.js";
import { l as createScopedDmSecurityResolver, t as adaptScopedAccountAccessor } from "./channel-config-helpers-h3merl20.js";
import "./string-coerce-runtime-Ccm67Pxa.js";
import { t as chunkTextForOutbound } from "./text-chunking-BP2bskoz.js";
import { n as describeAccountSnapshot } from "./account-helpers-BSPsbBAx.js";
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-JSVFlQzA.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-o_D7C15R.js";
import "./channel-core-CAovOIo4.js";
import "./routing-Dn3BGi2k.js";
import { _ as createAllowlistProviderOpenWarningCollector, w as projectAccountConfigWarningCollector } from "./channel-policy-BHf_hSRR.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-ComQM5Hk.js";
import { i as createResolvedDirectoryEntriesLister } from "./directory-config-helpers-LyIq_y1r.js";
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-CJHIfxll.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-B5iANTqf.js";
import "./approval-delivery-runtime-CEGzJdrf.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-uo1rB4v-.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-aSonK2kC.js";
import { r as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-DNYIdab9.js";
import "./approval-native-runtime-Cs2iATjl.js";
import { x as createChannelMessageAdapterFromOutbound } from "./channel-outbound-BIEsrm5d.js";
import "./conversation-runtime-B1GQD43y.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-C9w9gv4K.js";
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-DBuL-HPa.js";
import "./channel-status-xWbTzVy0.js";
import "./channel-actions-Bb-MxUVd.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-C-RyjVLy.js";
import { t as loadSessionStore } from "./session-store-runtime-C_mjsn5P.js";
import { t as extractToolSend } from "./tool-send-BjKZzzCz.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-B70b--aC.js";
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-Cpsq13G9.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-ul5QM6qC.js";
import { a as resolveMatrixAccountConfig } from "./account-config-CeaoXPGX.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-XMYZpoFJ.js";
import { n as normalizeMatrixUserId } from "./allowlist-tk6pDyPg.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-IsLHR4FC.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-Cb95ZHZA.js";
import { t as formatMatrixErrorMessage } from "./errors-CX9HRhRX.js";
import { n as matrixConfigAdapter, t as MatrixChannelConfigSchema } from "./config-schema-sNTDoZ_-.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-BosHonr3.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-CoNDHboj.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-CTot5N9F.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-TDe427p7.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-CIjM1R33.js";
...
import { t as maybeCreateMatrixMigrationSnapshot } from "./migration-snapshot-backup-DPWx416z.js";
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-BLHa-M7s.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-DAA17cjX.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-FKcRQXLH.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-B3l1qQ32.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixDoctor = {
	...
	runConfigSequence: async ({ cfg, env, shouldRepair }) => await (await import("./doctor-DZfag9iq.js")).runMatrixDoctorSequence({
		cfg,
		env,
		shouldRepair
	}),
	cleanStaleConfig: async ({ cfg }) => await (await import("./doctor-DZfag9iq.js")).cleanStaleMatrixPluginConfig(cfg)
};
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-Byk82Lpj.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
