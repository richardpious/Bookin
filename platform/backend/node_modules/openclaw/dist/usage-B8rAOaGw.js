import { h as positiveSecondsToSafeMilliseconds, v as resolveExpiresAtMsFromEpochSeconds } from "./number-coercion-DjYijOzx.js";
import { r as normalizeProviderId } from "./provider-id-DhcncFyL.js";
import { t as createSubsystemLogger } from "./subsystem-Blo0_rG4.js";
import { m as updateAuthProfileStoreWithLock, p as saveAuthProfileStore } from "./store-CvzOxDnC.js";
import { i as isAuthCooldownBypassedForProvider, o as resolveProfileUnusableUntil, r as isActiveUnusableWindow } from "./usage-state-C6N0ss4h.js";
import { s as resolveProviderRequestHeaders } from "./provider-request-config-DECw01pI.js";
import { t as redactIdentifier } from "./redact-identifier-BI6BTlLC.js";
...
async function markAuthProfileBlockedUntil(params) {
	...
	const profile = store.profiles[profileId];
	if (!profile || isAuthCooldownBypassedForProvider(profile.provider) || !Number.isFinite(blockedUntil) || blockedUntil <= Date.now()) return;
	let nextStats;
	let previousStats;
	let updateTime = 0;
	const updated = await authProfileUsageDeps.updateAuthProfileStoreWithLock({
		...
		updater: (freshStore) => {
			...
			const activeBlockedUntil = typeof existingBlockedUntil === "number" && Number.isFinite(existingBlockedUntil) && existingBlockedUntil > now ? existingBlockedUntil : 0;
			nextStats = {
				...previousStats,
...
//#endregion
export { markAuthProfileFailure as a, setAuthProfileFailureHook as c, markAuthProfileCooldown as i, clearAuthProfileCooldown as n, resolveProfileUnusableUntilForDisplay as o, markAuthProfileBlockedUntil as r, resolveProfilesUnavailableReason as s, calculateAuthProfileCooldownMs as t };
