...
import { m as resolveSecretInputRef } from "./types.secrets-CuOz9KrZ.js";
import { t as createSubsystemLogger } from "./subsystem-Blo0_rG4.js";
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-ChAglW1O.js";
import { i as setPathExistingStrict, n as getPath } from "./path-utils-hvU8RLf2.js";
import { r as discoverConfigSecretTargetsByIds } from "./target-registry-CwMproYl.js";
import { a as resolveSecretRefValue } from "./resolve-BB3PkFpN.js";
...
import { n as getLoadedChannelPlugin } from "./registry-BjxDvA5W.js";
import { t as resolveChannelApprovalAdapter } from "./plugins-vwMXgDxy.js";
import { k as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-D31CZ_MJ.js";
import { a as getActiveSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeEnv } from "./runtime-state-DQeWLTXc.js";
import { t as assertExpectedResolvedSecretValue } from "./secret-value-DqsowC-c.js";
import { n as collectCommandSecretAssignmentsFromSnapshot, t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-B7OmCA_k.js";
import { r as createResolverContext } from "./runtime-shared-D6HuhbQm.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-DbFPnyPG.js";
import { t as resolveRuntimeWebTools } from "./runtime-web-tools-BFogtiTJ.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-BN2W9aAi.js";
import { d as formatExecApprovalExpiresIn } from "./exec-approval-reply-BBI3Gc5p.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-CZfrr_AK.js";
import { c as buildPluginApprovalRequestMessage, o as approvalDecisionLabel, s as buildPluginApprovalExpiredMessage, u as resolvePluginApprovalRequestAllowedDecisions } from "./plugin-approvals-BAd_Vwt-.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-RlQ2Me5d.js";
import { l as roleScopesAllow } from "./pairing-token-CUzOg9u-.js";
import { l as listDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-C5JfsLW6.js";
import { a as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-2JVNNzmM.js";
import { d as shouldClearStoredApnsRegistration, f as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalAlert, o as resolveApnsAuthConfigFromEnv, r as loadApnsRegistrations, t as clearApnsRegistrationIfCurrent, u as sendApnsExecApprovalResolvedWake } from "./push-apns-Bu6oS_nh.js";
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-Csm1h6QK.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-DHIwTCBt.js")).activateSecretsRuntimeSnapshot(snapshot);
}
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-C5lQIliE.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-DWBZQ9f0.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-Mjoslgc7.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
