...
import { d as parseStrictFiniteNumber } from "./number-coercion-DjYijOzx.js";
...
import { y as basenameFromMediaSource } from "./fs-safe-DYWmA8_q.js";
...
import { i as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-BjoMoBVC.js";
...
import { a as actionHasTarget, o as actionRequiresTarget, r as applyTargetToParams, s as hasPotentialPluginActionParam } from "./channel-target-C9N0HItF.js";
import { o as resolveSandboxedMediaSource, t as assertMediaNotDataUrl } from "./sandbox-paths-B5_QhWlv.js";
import "./local-file-access-CBe_wA_B.js";
import { u as resolveStorePath } from "./paths-CBJPLq30.js";
import { t as loadSessionStore, z as resolveSessionStoreEntry } from "./store-load-BHiTqlRK.js";
...
import { r as extensionForMime } from "./mime-TnUOZVhx.js";
import "./sessions-BN2mnV-J.js";
import { t as appendAssistantMessageToSessionTranscript } from "./transcript-CDJoY4Ie.js";
import { r as stripPlainTextToolCallBlocks, t as extractToolPayload } from "./tool-payload-BwXNuCsb.js";
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-ye5B62pZ.js";
import { i as throwIfAborted } from "./deliver-B_snf0tE.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-swpu2tGD.js";
import { a as hasReplyPayloadContent, c as normalizeInteractiveReply, l as normalizeMessagePresentation, n as hasMessagePresentationBlocks, t as hasInteractiveReplyBlocks } from "./payload-Cpx3heIy.js";
import { a as resolveChannelMessageToolMediaSourceParamKeys } from "./message-action-discovery-D8YY2Nqu.js";
import { E as resolveSnakeCaseParamKey, T as readSnakeCaseParamRaw, b as readStringParam, g as readPositiveIntegerParam, v as readStringArrayParam } from "./common-COS7PQnH.js";
import { t as basenameFromAnyPath } from "./file-name-r4prf02z.js";
import { t as resolveChannelAccountMediaMaxMb } from "./configured-max-bytes-DO3xX_0h.js";
...
import { r as shouldAttemptTtsPayload } from "./tts-config-Bt-uWGJA.js";
import { t as resolveAgentScopedOutboundMediaAccess } from "./read-capability-CuIw3iFj.js";
import { r as resolveOutboundChannelPlugin } from "./channel-resolution-B3eQbSQ1.js";
import { p as parseReplyDirectives, u as stripUnsupportedCitationControlMarkers } from "./payloads-CsNPmG7g.js";
import { r as resolvePollMaxSelections } from "./polls-C-v11_tu.js";
import { n as resolveMessageChannelSelection, t as listConfiguredMessageChannels } from "./channel-selection-DsMGeAdX.js";
import { n as resolveOutboundSessionRoute, t as ensureOutboundSessionEntry } from "./outbound-session-BYz0wjrj.js";
import { i as resolveChannelTarget, n as lookupDirectoryDisplay, t as formatTargetDisplay } from "./target-resolver-UFAReHv1.js";
import { a as normalizeTargetForProvider } from "./target-normalization-ClOwmz7Y.js";
import { n as sendPoll, t as sendMessage } from "./message-CNE0W85Z.js";
import { t as dispatchChannelMessageAction } from "./message-action-dispatch-BOdOXpOH.js";
...
import { t as readBooleanParam$1 } from "./boolean-param-CWV3moh0.js";
...
function hasPollCreationParams(params) {
	for (const key of SHARED_POLL_CREATION_PARAM_NAMES) {
		...
		if (def.kind === "positiveInteger") {
			...
			if (typeof value === "string") {
				const parsed = parseStrictFiniteNumber(value.trim());
				if (parsed !== void 0 && parsed !== 0) return true;
			}
		}
		if (def.kind === "boolean") {
			if (value === true) return true;
...
function buildInternalSourceReplyToolResult(payload) {
	return {
		content: [{
			type: "text",
			text: `${payload.dryRun ? "Prepared" : "Sent"} visible reply to the current webchat conversation${payload.sourceReplySink ? ` via ${payload.sourceReplySink}` : ""}.`
		}],
		details: {
...
//#endregion
export { POLL_CREATION_PARAM_DEFS as a, stripFormattedReasoningMessage as i, runMessageAction as n, SHARED_POLL_CREATION_PARAM_NAMES as o, resolveAllowedMessageActions as r, getToolResult as t };
