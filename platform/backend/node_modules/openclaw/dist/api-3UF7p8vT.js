...
import { s as parseMediaContentLength } from "./fetch-CwUUBT5O.js";
...
import { n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-C6sqrjsE.js";
import "./ssrf-runtime-C5GYV25C.js";
import "./runtime-api-CRm0tV8M.js";
...
async function loadGoogleAuthRuntime() {
	if (!googleAuthRuntimePromise) googleAuthRuntimePromise = (async () => {
		try {
			const [googleAuthModule, gaxiosModule] = await Promise.all([import("./src-GWz6AwfB.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./src-xYB1F9y5.js")]);
			return {
