...
import { i as isOpenAIProvider, t as OPENAI_CODEX_PROVIDER_ID } from "./openai-codex-routing-Cc71DT_j.js";
...
import { i as getApiKeyForModel, n as applyLocalNoAuthHeaderOverride } from "./model-auth-sFspw--v.js";
import { n as completeSimple } from "./stream-To8o5poZ.js";
import { n as resolveModelAsync, t as resolveModel } from "./model-B0BrTDWx.js";
import { t as prepareModelForSimpleCompletion } from "./simple-completion-transport-Dq0HzfXY.js";
...
async function setRuntimeApiKeyForCompletion(params) {
	if (params.model.provider === "github-copilot") {
		const { resolveCopilotApiToken } = await import("./github-copilot-token-BfMX3hTe.js");
...
async function prepareSimpleCompletionModel(params) {
	const resolved = params.skipAgentDiscovery ? await (params.modelResolver ?? resolveModelAsync)(params.provider, params.modelId, params.agentDir, params.cfg, {
