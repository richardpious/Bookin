...
import { _ as normalizeLogLevel, r as getChildLogger } from "../../logger-Ph_vzWhz.js";
import { a as shouldLogVerbose } from "../../globals-Dc2qfZst.js";
...
import { c as resolveThinkingProfile, p as normalizeThinkLevel } from "../../thinking-Cq-IXzst.js";
import { i as replaceConfigFile, n as mutateConfigFile } from "../../mutate-DajLmhPa.js";
...
import { a as patchSessionEntry, d as updateSessionStore, f as updateSessionStoreEntry, i as listSessionEntries, l as saveSessionStore, p as upsertSessionEntry, r as getSessionEntry } from "../../store-Dh6bWvq_.js";
import { o as mediaKindFromMime } from "../../constants-D9zVCSKe.js";
import { n as detectMime } from "../../mime-TnUOZVhx.js";
import { n as onSessionTranscriptUpdate } from "../../transcript-events-DGgnvvtU.js";
import { t as getPluginRuntimeGatewayRequestScope } from "../../gateway-request-scope-B9qYB9tg.js";
import "../../logging-ZVjGjUSs.js";
import { r as buildConfiguredModelCatalog } from "../../model-selection-shared-DIfscIiX.js";
import { t as resolveThinkingDefault } from "../../model-thinking-default-CTAvg-iA.js";
import "../../model-selection-D0756MDv.js";
import { l as ensureAgentWorkspace } from "../../workspace-BF52cjJK.js";
...
import { B as resumeFlow, N as finishFlow, O as createManagedTaskFlow, R as requestFlowCancel, V as setFlowWaiting, j as failFlow, m as listTasksForFlowId } from "../../task-registry-BIbw6MG4.js";
import { n as summarizeTaskRecords } from "../../task-registry.summary-BwpoHlXv.js";
import "../../runtime-internal-CiE_ufD9.js";
import { _ as resolveTaskFlowForLookupTokenForOwner, d as runTaskInFlowForOwner, g as listTaskFlowsForOwner, h as getTaskFlowByIdForOwner, l as getFlowTaskSummary, m as findLatestTaskFlowForOwner, r as cancelFlowByIdForOwner, t as cancelDetachedTaskRunById } from "../../task-executor-T-TWqmQG.js";
import { o as generateMusic, s as listRuntimeMusicGenerationProviders } from "../../openclaw-tools-C1FG9NMc.js";
...
import { g as resizeToJpeg, l as getImageMetadata } from "../../media-services-v2ADmdnV.js";
...
import { n as resolveAgentIdentity } from "../../identity-FHl-I3Ta.js";
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "../../task-owner-access-BHCFwUAb.js";
import { t as RequestScopedSubagentRuntimeError } from "../../error-runtime-Dn_nurEc.js";
import { g as isVoiceCompatibleAudio } from "../../media-runtime-B_CojBOF.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "../../runtime-ByTB2N4W.js";
import { i as runWebSearch, r as listWebSearchProviders } from "../../runtime-B-kpt-pU.js";
...
import { t as createRuntimeChannel } from "../../runtime-channel-DSbqIqfK.js";
...
const loadEmbeddedAgentRuntime = createLazyRuntimeModule(() => import("../../runtime-embedded-agent.runtime-CX3UbMbL.js"));
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("../../heartbeat-runner-D24hkTuM.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("../../tts-C2jr9Efw.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("../../runtime-C3HBzWm4.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("../../runtime-model-auth.runtime-DJcIbilO.js"));
...
function createRuntimeLlmFacade() {
	const loadLlm = createLazyRuntimeSurface(() => import("../../runtime-llm.runtime-BIlS4d25.js"), (m) => m.createRuntimeLlm({
