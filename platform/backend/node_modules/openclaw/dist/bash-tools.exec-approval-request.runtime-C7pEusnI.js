import { O as normalizeExecutableToken, a as extractShellWrapperInlineCommand, c as isShellWrapperExecutable, i as extractShellWrapperCommand, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv, w as SOURCE_EXECUTABLES } from "./shell-wrapper-resolution-Dq5e0a-7.js";
import "./exec-wrapper-resolution-DGUmAqHc.js";
import { a as detectInlineEvalArgv, i as detectCommandCarrierArgv, n as detectCarriedShellBuiltinArgv, r as detectCarrierInlineEvalArgv, s as detectShellWrapperThroughCarrierArgv } from "./risks-DUUficc3.js";
...
function appendDecodedText(decoded, value, sourceEndOffset) {
	decoded.value += value;
	for (let index = 0; index < value.length; index += 1) decoded.sourceOffsets.push(sourceEndOffset);
}
