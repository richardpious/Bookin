import { c as OAuthProviderInterface, i as OAuthPrompt, n as OAuthCredentials } from "./openai-codex-oauth-types.runtime-DW1PqT14.js";

//#region extensions/openai/openai-codex-oauth-flow.runtime.d.ts
type TokenSuccess = {
  type: "success";
  access: string;
  refresh: string;
