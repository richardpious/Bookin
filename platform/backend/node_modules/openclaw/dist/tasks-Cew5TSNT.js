...
import { Bn as validateTasksGetParams, Ri as ErrorCodes, Vn as validateTasksListParams, t as formatValidationErrors, zi as errorShape, zn as validateTasksCancelParams } from "./src-S72EdpgG.js";
import { f as listTaskRecords, s as getTaskById } from "./task-registry-BIbw6MG4.js";
import { a as sanitizeTaskStatusText, r as formatTaskStatusTitle } from "./task-status-C-pTpHs4.js";
import "./runtime-internal-CiE_ufD9.js";
import { t as cancelDetachedTaskRunById } from "./detached-task-runtime-Dbps45ky.js";
...
function taskMatchesAgent(task, agentId) {
	...
	if (!normalized) return true;
	if (normalizeOptionalString(task.agentId) === normalized) return true;
	return [
		task.requesterSessionKey,
		task.childSessionKey,
		task.ownerKey
