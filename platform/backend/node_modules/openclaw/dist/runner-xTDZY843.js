...
import { i as buildModelAliasIndex, l as inferUniqueProviderFromConfiguredModels, x as resolveModelRefFromString } from "./model-selection-shared-DIfscIiX.js";
...
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-Dm-lW8mD.js";
import { n as isMinimaxVlmProvider, t as isMinimaxVlmModel } from "./minimax-vlm-BpEI62eW.js";
import { n as normalizeMediaProviderId, t as normalizeMediaExecutionProviderId } from "./provider-id-CHswGupa.js";
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-Bx3qZVXM.js";
import { t as providerSupportsCapability } from "./provider-supports-_vg7HvJF.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-CXTlDR-U.js";
import { S as normalizeAttachments, _ as fileExists, a as runCliEntry, b as selectAttachments, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaAttachmentCache, y as isMediaUnderstandingSkipError } from "./runner.entries-D2ObA36z.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-BoDbv-ea.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-CVXGomjW.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-Ca9W9gjp.js");
...
function hasExplicitImageUnderstandingConfig(params) {
	return (params.config?.models?.length ?? 0) > 0 || resolveImageModelFromAgentDefaults({
		cfg: params.cfg,
		agentId: params.agentId
	}).length > 0;
}
...
async function runCapability(params) {
	...
	const activeProvider = params.activeModel?.provider?.trim();
	if (capability === "image" && activeProvider && !isMinimaxVlmProvider(activeProvider) && !hasExplicitImageUnderstandingConfig({
		cfg,
		config,
		agentId: params.agentId
	})) {
