...
import { c as stripToolCallXmlTags, f as stripFinalTags, o as stripLegacyBracketToolCallBlocks, s as stripMinimaxToolCallXml } from "./assistant-visible-text-ye5B62pZ.js";
...
function sanitizeUserFacingText(text, opts) {
	...
	const withoutToolCallBlocks = stripPlainTextToolCallBlocks(stripLegacyBracketToolCallBlocks(stripToolCallsOmittedPlaceholderLines(stripToolCallXmlTags(stripMinimaxToolCallXml(stripInboundMetadata(stripInternalRuntimeContext(stripFinalTagsFromText(raw)))), { stripFunctionCallsXmlPayloads: true }))));
