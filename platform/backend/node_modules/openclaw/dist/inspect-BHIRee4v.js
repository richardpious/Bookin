...
import { m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName, r as GATEWAY_SERVICE_MARKER, u as resolveGatewayLaunchAgentLabel } from "./constants-BOOZFRBo.js";
import { r as resolveHomeDir } from "./paths-d5v1FQxC.js";
import { i as parseSystemdExecStart } from "./systemd-unit-B7yQZr07.js";
...
async function scanLaunchdDir(params) {
	...
	for (const { name: labelFromName, fullPath, contents } of candidates) {
		...
		const marker = hasGatewayServiceMarker(contents) || executionMarker === "openclaw" ? "openclaw" : executionMarker === "clawdbot" || legacyLabel ? "clawdbot" : null;
		if (!marker) continue;
