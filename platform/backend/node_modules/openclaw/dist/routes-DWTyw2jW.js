...
import { d as parseStrictFiniteNumber, f as parseStrictInteger, m as parseStrictPositiveInteger, p as parseStrictNonNegativeInteger } from "./number-coercion-DjYijOzx.js";
import { i as formatErrorMessage } from "./errors-AAwmFBlx.js";
import { _ as uniqueStrings } from "./string-normalization-B8G0vlWE.js";
import { u as pathScope } from "./fs-safe-DYWmA8_q.js";
import { p as resolveUserPath } from "./utils-DlHt_n1Q.js";
import { i as getRuntimeConfig } from "./io-By9euW-h.js";
import { d as isImageProcessorUnavailableError, g as resizeToJpeg, l as getImageMetadata, o as buildImageResizeSideGrid, r as IMAGE_REDUCE_QUALITY_STEPS } from "./media-services-v2ADmdnV.js";
import { a as ensureMediaDir, u as saveMediaBuffer } from "./store-f1lhXMT1.js";
import "./string-coerce-runtime-Ccm67Pxa.js";
import "./number-runtime-FvL6JHZB.js";
import { n as redactCdpUrl, t as parseBrowserHttpUrl } from "./browser-config-DGzVyu71.js";
...
import { C as BrowserTargetAmbiguousError, I as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, L as DEFAULT_AI_SNAPSHOT_MAX_CHARS, S as BrowserTabNotFoundError, T as toBrowserErrorResponse, U as DEFAULT_BROWSER_SCREENSHOT_TIMEOUT_MS, _ as BrowserError, d as withCdpSocket, f as normalizeBrowserTimerDelayMs, g as BrowserConflictError, n as assertCdpEndpointAllowed, v as BrowserProfileNotFoundError, w as BrowserValidationError, y as BrowserProfileUnavailableError } from "./cdp.helpers-WyU0BhTo.js";
import { a as DEFAULT_DOWNLOAD_DIR, i as resolveProfile, o as DEFAULT_TRACE_DIR, r as resolveManagedBrowserHeadlessMode, s as DEFAULT_UPLOAD_DIR } from "./config-DwOUvgX-.js";
import "./errors-k-DCi7_1.js";
import { i as isValidProfileName, n as deleteBrowserProfileConfig, t as createBrowserProfileConfig } from "./config-mutations-CPLBcAnx.js";
import { r as resolveBrowserExecutableForPlatform } from "./chrome.executables-5gKwmEjw.js";
import { t as movePathToTrash } from "./trash-DMVqrOOG.js";
import { n as normalizeString } from "./record-shared-BhLowCnt.js";
import "./sdk-setup-tools-BhoQvZdZ.js";
import { D as takeChromeMcpSnapshot, E as takeChromeMcpScreenshot, O as uploadChromeMcpFile, S as resizeChromeMcpPage, a as closeChromeMcpTab, b as pressChromeMcpKey, d as fillChromeMcpForm, h as hoverChromeMcpElement, l as evaluateChromeMcpScript, n as clickChromeMcpCoords, p as getChromeMcpPid, r as clickChromeMcpElement, s as dragChromeMcpElement, u as fillChromeMcpElement, v as navigateChromeMcpPage } from "./chrome-mcp-Bmrcs9HS.js";
import { E as withBrowserNavigationPolicy, S as assertBrowserNavigationAllowed, _ as INTERACTIVE_ROLES, a as resolveOpenClawUserDataDir, b as resolveBrowserNavigationProxyMode, g as CONTENT_ROLES, h as snapshotRoleViaCdp, m as snapshotAria, t as getChromeWebSocketUrl, u as captureScreenshot, v as STRUCTURAL_ROLES, w as assertBrowserNavigationResultAllowed, y as ensureOutputDirectory } from "./chrome-tYaQ0Ybi.js";
import { a as shouldUsePlaywrightForAriaSnapshot, i as resolveDefaultSnapshotFormat, n as getPwAiModule$1, o as shouldUsePlaywrightForScreenshot, r as getBrowserProfileCapabilities, t as resolveTargetIdFromTabs } from "./target-id-BGgaen7g.js";
import { i as getRoleSnapshotStats, l as matchBrowserUrlPattern, s as normalizeBrowserFormField, t as appendSnapshotUrls } from "./snapshot-urls-B5DjT968.js";
...
function readActionPositiveInteger(body, key) {
...
async function runBrowserLiveProbe(req, ctx) {
	...
	try {
		...
		if (capabilities.usesChromeMcp) {
			const { takeChromeMcpSnapshot } = await import("./chrome-mcp-ac9aCT_x.js");
...
function registerBrowserPermissionRoutes(app, ctx) {
	app.post("/permissions/grant", asyncBrowserRoute(async (req, res) => {
		...
		let timeoutMs;
		try {
			timeoutMs = Math.max(1e3, readRoutePositiveInteger(body.timeoutMs, "timeoutMs") ?? 5e3);
		} catch (err) {
			return jsonError(res, 400, formatErrorMessage(err));
		}
		try {
