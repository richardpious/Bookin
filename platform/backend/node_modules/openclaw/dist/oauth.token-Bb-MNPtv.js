...
import { r as resolveOAuthClientConfig } from "./oauth.credentials-DVmUXCzz.js";
import { t as fetchWithTimeout } from "./oauth.http-DkI_-Vna.js";
import { n as resolveGooglePersonalOAuthIdentity, t as resolveGoogleOAuthIdentity } from "./oauth.project-C9qTjAv8.js";
import { t as isGeminiCliPersonalOAuth } from "./oauth.settings-_bLw4F1F.js";
...
function resolveTokenExpiresAt(value) {
	return resolveExpiresAtMsFromDurationSeconds(value, { bufferMs: TOKEN_EXPIRY_BUFFER_MS }) ?? Date.now() - TOKEN_EXPIRY_BUFFER_MS;
}
