...
import { b as isUsageCountedSessionTranscriptFileName, h as isSessionArchiveArtifactName, l as resolveSessionTranscriptsDirForAgent } from "./paths-CBJPLq30.js";
...
import { t as extractKeywords } from "./query-expansion-CLq1xHPJ.js";
import { r as classifyMemoryMultimodalPath } from "./multimodal-CnyHf_yl.js";
import { t as getEmbeddingProvider } from "./embedding-provider-runtime-B1P40N_G.js";
import { t as resolveMemorySearchConfig } from "./memory-search-pQFb2HEv.js";
import "./embedding-providers-UKrMpM8k.js";
import { t as getMemoryEmbeddingProvider } from "./memory-embedding-provider-runtime-_o7hxDw4.js";
import { u as enforceEmbeddingMaxInputTokens } from "./memory-core-host-engine-embeddings-DyeyMyeY.js";
import { t as isFileMissingError } from "./fs-utils-D051hvBx.js";
import { a as ensureDir, c as normalizeExtraMemoryPaths, d as runWithConcurrency, f as hasNonTextEmbeddingParts, i as cosineSimilarity, l as parseEmbedding, n as buildMultimodalChunkForIndexing, r as chunkMarkdown, s as listMemoryFiles, t as buildFileEntry, u as remapChunkLines } from "./internal-C2dqLo5Q.js";
import { t as hashText } from "./hash-C0FSXO-A.js";
import "./memory-core-host-engine-foundation-Lua9Mea3.js";
import { l as buildSessionEntry, m as sessionPathForFile, u as listSessionFilesForAgent } from "./engine-qmd-9ddD0cRD.js";
import "./memory-core-host-engine-qmd-EGAG9h9g.js";
import { n as readMemoryFile } from "./read-file-D4SrlEMg.js";
import { a as ensureMemoryIndexSchema, i as loadSqliteVecExtension, n as configureMemorySqliteWalMaintenance, r as requireNodeSqlite, t as closeMemorySqliteWalMaintenance } from "./engine-storage-Dkl2KcXA.js";
import "./memory-core-host-engine-storage-DJh_aOZ2.js";
import "./dreaming-shared-twpRe-Pz.js";
import { r as tokenize, t as jaccardSimilarity } from "./tokenize-B-rU9X-u.js";
import { n as settleMemoryWatchEventPaths, t as recordMemoryWatchEventPath } from "./watch-settle-D8vi8R4W.js";
...
var MemoryManagerSyncOps = class {
	...
	ensureWatcher() {
		...
		for (const dir of dirWatchPaths) {
			...
			if (!this.attachNativeMemoryWatchForDir(dir, markDirty)) fileWatchPaths.add(dir);
		}
	...
	async runSync(params) {
		...
		try {
			...
			if (!this.provider && this.fts.enabled && this.shouldFallbackOnError(err)) {
				log$3.warn(`memory embeddings unavailable; rebuilding lexical memory index only: ${reason}`);
				await this.runSafeReindex({
...
async function runEmbeddingOperationWithTimeout(params) {
	...
	if (!Number.isFinite(params.timeoutMs) || params.timeoutMs <= 0) return await params.run(controller.signal);
	let timer = null;
...
var MemoryIndexManager = class MemoryIndexManager extends MemoryManagerEmbeddingOps {
	...
	markLocalEmbeddingProviderDegraded(err) {
		...
		Promise.resolve(degradedProvider.close?.()).catch((err) => {
