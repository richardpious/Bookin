...
import { i as formatErrorMessage$1 } from "./errors-AAwmFBlx.js";
...
import { t as createDedupeCache } from "./dedupe-zVlG7e82.js";
...
import { a as saveRemoteMedia, i as readRemoteMediaBuffer } from "./fetch-CwUUBT5O.js";
...
import { u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-C6sqrjsE.js";
import "./ssrf-runtime-C5GYV25C.js";
import "./media-mime-CoRc7Jth.js";
import "./channel-ingress-runtime-2H79nAIE.js";
import "./runtime-api-Cqo5e0Sc.js";
import { c as validateUrbitBaseUrl, d as formatTargetHint, f as normalizeShip, h as resolveTlonOutboundTarget, m as parseTlonTarget, p as parseChannelNest, s as normalizeUrbitHostname, u as resolveTlonAccount } from "./setup-core-CVRqSqSO.js";
import { t as getTlonRuntime } from "./runtime-B0ffOFfb.js";
import { t as tlonSetupWizard } from "./setup-surface-D3RHfEj4.js";
...
var require_dist_cjs$5 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const remoteProvider = async (init) => {
		...
		if (process.env[ENV_CMDS_RELATIVE_URI] || process.env[ENV_CMDS_FULL_URI]) {
			...
			const { fromHttp } = await import("./dist-cjs-sku9Z-qB.js").then((m) => /* @__PURE__ */ __toESM(m.default));
...
`);
		...
		async (awsIdentityProperties) => {
			...
			const { fromSSO } = await import("./dist-cjs-CpjG3TIH.js").then((m) => /* @__PURE__ */ __toESM(m.default));
			return fromSSO(init)(awsIdentityProperties);
		},
		async (awsIdentityProperties) => {
			init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromIni");
			const { fromIni } = await import("./dist-cjs-CfA6dkWC2.js").then((m) => /* @__PURE__ */ __toESM(m.default));
			return fromIni(init)(awsIdentityProperties);
		},
		async (awsIdentityProperties) => {
			init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromProcess");
			const { fromProcess } = await import("./dist-cjs-Br3PVdcX.js").then((m) => /* @__PURE__ */ __toESM(m.default));
			return fromProcess(init)(awsIdentityProperties);
		},
		async (awsIdentityProperties) => {
			init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromTokenFile");
			const { fromTokenFile } = await import("./dist-cjs-BmFJjt_l.js").then((m) => /* @__PURE__ */ __toESM(m.default));
