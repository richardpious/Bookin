...
function shouldDeferConfiguredChannelFullRuntimeMerge(params) {
	return params.preferSetupRuntimeForChannelPlugins === true && params.startupDeferConfiguredChannelFullLoadUntilAfterListen === true && params.manifestChannels.some((channelId) => isChannelConfigured(params.cfg, channelId, params.env));
}
...
//#endregion
export { resolveSetupChannelRegistration as a, resolveBundledRuntimeChannelRegistration as i, loadBundledRuntimeChannelPlugin as n, shouldDeferConfiguredChannelFullRuntimeMerge as o, mergeSetupRuntimeChannelPlugin as r, shouldLoadChannelPluginInSetupRuntime as s, channelPluginIdBelongsToManifest as t };
