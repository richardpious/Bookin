...
import { h as normalizeProviderResolvedModelWithPlugin } from "./provider-runtime-Cp-fJ4cK.js";
import { n as modelKey } from "./model-selection-normalize-DUxQN8bc.js";
import { i as shouldSuppressBuiltInModelFromManifest, r as shouldSuppressBuiltInModel } from "./model-suppression-CEK73Vv2.js";
import { f as isLocalBaseUrl, p as canonicalizeModelCatalogProviderAlias } from "./shared-Cx7BK4jP.js";
import { t as toModelRow } from "./list.model-row-D_L5pINM.js";
//#region src/commands/models/list.rows.ts
const modelCatalogModuleLoader = createLazyImportLoader(() => import("./model-catalog-BoDbv-ea.js"));
const modelResolverModuleLoader = createLazyImportLoader(() => import("./model-vVHjUUP8.js"));
const providerCatalogModuleLoader = createLazyImportLoader(() => import("./list.provider-catalog-8xUV52G9.js"));
...
async function appendConfiguredRows(params) {
	...
	for (const entry of params.entries) {
		...
		const allowProviderAvailabilityFallback = model && (!params.context.discoveredKeys.has(modelKey(model.provider, model.id)) || params.context.authIndex.allowsProviderAuthAvailabilityFallback(model.provider));
