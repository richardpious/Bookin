import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, i as normalizeFastMode, s as normalizeOptionalLowercaseString } from "./string-coerce-DKw2K5wM.js";
...
import { d as normalizeTrimmedStringList, l as normalizeStringEntries } from "./string-normalization-B8G0vlWE.js";
import { w as pathExists } from "./fs-safe-DYWmA8_q.js";
import { s as resolveArchiveKind } from "./archive-Cb-7DCaB.js";
import { p as resolveUserPath, r as clampInt } from "./utils-DlHt_n1Q.js";
import { r as normalizeProviderId } from "./provider-id-DhcncFyL.js";
import { _ as resolveSessionAgentId, v as resolveSessionAgentIds } from "./agent-scope-BeI1SY1H.js";
...
import { n as parseGitPluginSpec, t as installPluginFromGitSpec } from "./git-install-c8B-WhHo.js";
...
import "./clawhub-eHNqclD3.js";
import { c as resolveOfficialExternalPluginInstall, n as getOfficialExternalPluginCatalogEntryForPackage, s as resolveOfficialExternalPluginId } from "./official-external-plugin-catalog-gltTeu6n.js";
import { r as logVerbose } from "./globals-Dc2qfZst.js";
import { E as validateConfigObjectWithPlugins, M as resetConfigOverrides, N as setConfigOverride, P as unsetConfigOverride, j as getConfigOverrides, u as readConfigFileSnapshot } from "./io-By9euW-h.js";
import "./archive-CBe_wA_B.js";
import "./installed-plugin-index-records-B68pYawc.js";
import { _ as resolveResponseUsageMode, h as normalizeUsageDisplay, u as isSessionDefaultDirectiveValue } from "./thinking-Cq-IXzst.js";
import { n as assertConfigWriteAllowedInCurrentMode } from "./nix-mode-write-guard-Dk_303j0.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath, t as getConfigValueAtPath } from "./config-paths-DixdsTm-.js";
import { t as setPluginEnabledInConfig } from "./toggle-config-DSbITXqf.js";
import { t as parseDurationMs } from "./parse-duration-CI8nUnt1.js";
import { o as transformConfigFileWithRetry } from "./mutate-DajLmhPa.js";
import "./config-Bzaup9wC.js";
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-DfmpOAvt.js";
import { o as normalizeChannelId } from "./registry-CgCBMWZD.js";
import { i as normalizeMessageChannel } from "./message-channel-normalize-mFW26rOU.js";
import { r as isInternalMessageChannel } from "./message-channel-7236hqCk.js";
import { g as triggerOpenClawRestart, p as scheduleGatewaySigusr1Restart } from "./restart-5nDaAeZf.js";
import { a as listOpenAIAuthProfileProvidersForAgentRuntime, l as resolveContextConfigProviderForRuntime } from "./openai-codex-routing-Cc71DT_j.js";
import { t as resolveAgentHarnessPolicy } from "./policy-CWPpOk4M.js";
import { t as getActivePluginChannelRegistry } from "./runtime-BjnrbaLv.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-Cgwuqoib.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-CBJPLq30.js";
import { t as loadSessionStore } from "./store-load-BHiTqlRK.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-BjxDvA5W.js";
import { d as updateSessionStore } from "./store-Dh6bWvq_.js";
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-vwMXgDxy.js";
...
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-CDJoY4Ie.js";
import { y as prepareProviderRuntimeAuth } from "./provider-runtime-Cp-fJ4cK.js";
import { i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-CvzOxDnC.js";
import { n as ensureOpenClawModelsJson } from "./models-config-mBJVnnMi.js";
import { n as requireApiKey } from "./model-auth-runtime-shared-cdTr1v5l.js";
import { i as getApiKeyForModel } from "./model-auth-sFspw--v.js";
import { a as isNativeCommandTurn, s as resolveCommandTurnContext } from "./command-turn-context-Cqhb6nXp.js";
import { i as resolveTextCommand, r as normalizeCommandBody } from "./commands-registry-normalize-DO574On-.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-Btgm6rsH.js";
import { n as stripInboundMetadata } from "./strip-inbound-meta-DAz1JBuy.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-C-pTpHs4.js";
import { p as replyRunRegistry } from "./reply-run-registry-BYXDUcCT.js";
import "./diagnostic-w1vyIc20.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-DmjXzyoD.js";
import { a as getActiveEmbeddedRunSnapshot, g as resolveActiveEmbeddedRunSessionId, i as formatEmbeddedAgentQueueFailureSummary, o as isEmbeddedAgentRunActive, p as queueEmbeddedAgentMessageWithOutcomeAsync } from "./runs-DMxJUP3Q.js";
import { r as isSilentReplyPayloadText } from "./tokens-BpOBzvOi.js";
import { n as estimateTokensFromChars } from "./cjk-chars-BtjJDifS.js";
import { n as discoverModels, t as discoverAuthStorage } from "./agent-model-discovery-kGuxMCA1.js";
import { c as parseSessionEntries, n as buildSessionContext, s as migrateSessionEntries } from "./session-manager-Fxwb-hrq.js";
import { i as streamSimple } from "./stream-To8o5poZ.js";
import { o as resolveContextTokensForModel } from "./context-CjLHH2E3.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-Ddra24Lg.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-C2iY3lrL.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BQYHVOio.js";
import { n as getSessionBindingService } from "./session-binding-service-DInWFDrJ.js";
import { V as resolveEmbeddedAgentStreamFn, i as selectAgentHarness, n as resolveAvailableAgentHarnessPolicy } from "./selection-BMP-JCML.js";
import { v as stripToolResultDetails } from "./openai-transport-stream-N4q_7Mj8.js";
...
import { n as sanitizeImageBlocks } from "./tool-images-jxvaHCzc.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-CXSpxGgB.js";
import { c as resolveMainSessionAlias, s as resolveInternalSessionKey } from "./sessions-helpers-TJ3ZsvFq.js";
import { a as clearSessionQueues } from "./queue-B7Cec0kj.js";
import { i as resolveReplyToMode } from "./reply-threading-BE0aAf2S.js";
import { b as resolveBootstrapTotalMaxChars, v as resolveBootstrapMaxChars } from "./embedded-agent-helpers-xBQcYQq8.js";
import { n as routeReply } from "./route-reply-C70jpJKu.js";
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, x as resolveExplicitConfigWriteTargetShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-h3merl20.js";
import { r as resolveModelWithRegistry } from "./model-B0BrTDWx.js";
...
import "./sandbox-Dy_6WAUg.js";
import { t as registerProviderStreamForModel } from "./provider-stream-CK-3ziP0.js";
import { i as getSpeechProvider, o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-BKoiYs3b.js";
import { C as setTtsMaxLength, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, a as getTtsMaxLength, b as setSummarizationEnabled, c as isSummarizationEnabled, f as listTtsPersonas, g as resolveTtsConfig, i as getResolvedSpeechProviderConfig, k as textToSpeech, l as isTtsEnabled, o as getTtsPersona, r as getLastTtsAttempt, s as getTtsProvider, u as isTtsProviderConfigured, w as setTtsPersona, y as setLastTtsAttempt } from "./tts-runtime-K2ac55wV.js";
import "./tts-DBldkbRt.js";
import { o as getFinishedSession, s as getSession } from "./bash-process-registry-CY1zCAxV.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-Bmy8FbCd.js";
...
import { r as matchPluginCommand, t as executePluginCommand } from "./commands-BCn4RB8m.js";
import "./commands-registry-DpHmX1BG.js";
import { t as resolveExternalCliAuthOverlayScopeFromSelection } from "./external-cli-auth-selection-CxPk5n_S.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-ClDL4k5O.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-Pd8L7G6Z.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-egWEBd-u.js";
import { a as shouldPersistAbortCutoff, i as resolveAbortCutoffFromContext, t as applyAbortCutoffToSessionEntry } from "./abort-cutoff-CkY-lK7L.js";
import { i as stopSubagentsForRequester, n as formatAbortReplyText, r as resolveSessionEntryForKey, t as abortSessionRunTarget } from "./abort-Dt8gPfFo.js";
import { n as formatTimeAgo } from "./format-relative-Bjc3l98W.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-DVwShqnk.js";
import { t as handleCrestodianCommand } from "./commands-crestodian-BI4PCCEa.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-C820KMAF.js";
import { t as resolveApprovalOverGateway } from "./approval-gateway-resolver-CqnnXFtk.js";
import { n as parseActivationCommand } from "./group-activation-fRC7clVy.js";
import { t as resolveFastModeState } from "./fast-mode-DDf0ijP7.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-DQ4GalGu.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-CG0yhLny.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-CXSRXJ7R.js";
import { i as resolveSkillCommandInvocation, t as listSkillCommandsForAgents } from "./chat-commands-CfCU480A.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-B0ZRGCla.js";
import { t as extractBtwQuestion } from "./btw-command-BuBXqhY2.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-BO8l-lwu.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-TGv1dS2b.js";
import { a as buildDisabledCommandReply, c as requireCommandFlagEnabled, l as requireGatewayClientScope, o as rejectNonOwnerCommand, r as handleModelsCommand, s as rejectUnauthorizedCommand } from "./commands-models-DcmPRC6d.js";
import { r as createExecTool } from "./bash-tools-Dyt_DQSE.js";
import { n as listTasksForAgentIdForStatus, r as listTasksForSessionKeyForStatus } from "./task-status-access-COvVqKBg.js";
import { C as stopWithText, b as resolveAcpAction, d as COMMAND, x as resolveAcpHelpText } from "./shared-CZZtorw4.js";
import { a as resolveHandledPrefix, c as resolveSubagentsAction, d as resolveCommandSurfaceChannel, l as stopWithText$1, o as resolveRequesterSessionKey, u as resolveChannelAccountId } from "./shared-BZ0hxuJI.js";
import { t as buildToolsMessage } from "./status-hyJrMQob.js";
import { i as parseConfigValue, n as setConfiguredMcpServer, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-D_KYn6dt.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-osERfmMK.js";
import "./command-export-DX7lUfQc.js";
import { t as buildStatusReply } from "./commands-status-DgnD46k4.js";
import { n as persistPluginInstall, r as buildNpmInstallRecordFields } from "./plugins-install-persist-CBYOanUq.js";
import { a as installPluginFromNpmSpec, o as installPluginFromPath } from "./install-wil4fGpe.js";
import { a as resolveOfficialExternalNpmPackageTrust } from "./plugin-install-plan-C5WoKrDc.js";
import { a as buildPluginDiagnosticsReport, l as formatPluginCompatibilityNotice, o as buildPluginInspectReport, s as buildPluginRegistrySnapshotReport, t as buildAllPluginInspectReports } from "./status-D08lJVx6.js";
import { d as resolveFileNpmSpecToLocalPath, r as createPluginInstallLogger } from "./plugins-command-helpers-BL30aYUI.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-BeZgxRv6.js";
import { r as installPluginFromClawHub } from "./clawhub-CZvVv4cS.js";
import { i as loadSessionCostSummary, n as loadCostUsageSummary } from "./session-cost-usage-Cze11hDk.js";
...
const lifecycleHandlersLoader = createLazyImportLoader(() => import("./lifecycle-Cg9G3FDf.js"));
const runtimeOptionHandlersLoader = createLazyImportLoader(() => import("./runtime-options-D7vyq5z6.js"));
const diagnosticHandlersLoader = createLazyImportLoader(() => import("./diagnostics-CPrnWp4U.js"));
...
async function runBtwSideQuestion(params) {
	...
	if (harness.runSideQuestion) {
		...
		return { text: (await harness.runSideQuestion({
			...params,
...
function isCompactionSkipReason(reason) {
	...
	return text.includes("nothing to compact") || text.includes("below threshold") || text.includes("already under target") || text.includes("already compacted") || text.includes("no real conversation messages");
}
function formatCompactionReason(reason) {
	...
	if (lower.includes("already under target")) return "context is already under the compaction target";
...
function resolveManualCompactContextModelId(params) {
	...
	if (modelProvider === selectedProvider || modelProvider === contextConfigProvider || modelProvider === "openai" && contextConfigProvider === "openai-codex") return modelId;
	return model;
}
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-D_ETGNZL.js");
...
async function resolveSkillCommands(params) {
	if (params.skillCommands !== void 0) return params.skillCommands;
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-CvWxYOjA.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-DwUFoncQ.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-IaptW-Oy.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-C3KWm_Rn.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-C_btIRjE.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-D6DjaBfE.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-CmWWXYP3.js"));
