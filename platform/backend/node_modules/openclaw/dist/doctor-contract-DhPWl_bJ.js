import { i as normalizeLegacyChannelAliases, t as asObjectRecord } from "./runtime-doctor-D9RjqWkP.js";
import { g as normalizeRealtimeVoiceActivationNamePrefix, p as isSupportedRealtimeVoiceActivationName } from "./realtime-voice-BYkOOxsM.js";
...
const legacyConfigRules = [
	...
	{
		path: ["channels", "discord"],
		message: "channels.discord.guilds.<id>.channels.<id>.agentId is legacy; use top-level bindings[] for per-channel Discord agent routing. Run \"openclaw doctor --fix\".",
