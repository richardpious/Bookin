import { c as normalizeOptionalString, u as normalizeOptionalThreadValue } from "./string-coerce-DKw2K5wM.js";
...
import { i as readSessionEntry } from "./store-load-BHiTqlRK.js";
...
import { n as resolveCronStaggerMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-BR4bL1xg.js";
import { l as resolveCronStoredDeliveryContext, n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-DCYduxJU.js";
import { t as parseAbsoluteTimeMs } from "./parse-C0cLBCh3.js";
import { i as normalizeRequiredName, n as normalizeOptionalAgentId, r as normalizePayloadToSystemText } from "./normalize-DMcHTwIN.js";
import { i as stripTargetProviderPrefix, t as resolveExplicitDeliveryTargetCompat } from "./target-parsing-loaded-TH7-ZwjZ.js";
import { n as resolveOutboundTargetWithPlugin, t as resolveSessionDeliveryTarget } from "./targets-session-CN4olkuH.js";
import { n as computePreviousRunAtMs, t as computeNextRunAtMs } from "./schedule-CDBPbFar.js";
...
function resolveJobErrorBackoffUntilMs(job, scheduleMs = DEFAULT_ERROR_BACKOFF_SCHEDULE_MS) {
	if (job.state.lastStatus !== "error" || !isFiniteTimestamp(job.state.lastRunAtMs)) return;
...
//#endregion
export { resolveJobPayloadTextForMain as _, computeJobPreviousRunAtMs as a, findJobOrThrow as c, isJobEnabled as d, nextWakeAtMs as f, resolveJobErrorBackoffUntilMs as g, recordScheduleComputeError as h, computeJobNextRunAtMs as i, hasScheduledNextRunAtMs as l, recomputeNextRunsForMaintenance as m, applyJobPatch as n, createJob as o, recomputeNextRuns as p, assertSupportedJobSpec as r, errorBackoffMs as s, DEFAULT_ERROR_BACKOFF_SCHEDULE_MS as t, isJobDue as u, resolveDeliveryTarget as v };
