...
import { C as hasSessionAutoModelFallbackProvenance } from "./agent-scope-BeI1SY1H.js";
...
import { i as buildModelAliasIndex, v as resolveConfiguredModelRef, x as resolveModelRefFromString } from "./model-selection-shared-DIfscIiX.js";
import "./model-selection-D0756MDv.js";
import { d as resolveModelAuthMode } from "./model-auth-sFspw--v.js";
import { s as readRecentSessionUsageFromTranscript } from "./session-utils.fs-clE0lv0B.js";
import { o as resolveContextTokensForModel } from "./context-CjLHH2E3.js";
import { a as resolveModelCostConfig, n as formatTokenCount$1, r as formatUsd, t as estimateUsageCost } from "./usage-format-Ddra24Lg.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BQYHVOio.js";
import { o as shouldPreferActiveRuntimeAliasAuthLabel, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-DdKzTF-r.js";
import { w as resolveOpenAITextVerbosity } from "./proxy-DTJQAioB.js";
import { t as resolveCommitHash } from "./git-commit-DUCVesq8.js";
import { n as findDecisionReason, s as summarizeDecisionReason } from "./runner.entries-D2ObA36z.js";
import "./sandbox-Dy_6WAUg.js";
import { i as resolveExtraParams } from "./extra-params-BXLGqh0b.js";
import { t as resolveChannelModelOverride } from "./model-overrides-BuuZpOr7.js";
import { t as resolveAgentRuntimeLabel } from "./agent-runtime-label-CANK_9W5.js";
import { n as formatTimeAgo } from "./format-relative-Bjc3l98W.js";
import { n as resolveSelectedAndActiveModel, t as formatProviderModelRef } from "./model-runtime-DbOmaJ1o.js";
import { t as resolveActiveFallbackState } from "./fallback-notice-state-C5qyxcku.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-Cnqa77A0.js";
import fs from "node:fs";
//#region src/status/status-labels.ts
const formatFastModeLabel = (enabled) => `Fast: ${enabled ? "on" : "off"}`;
//#endregion
...
function buildStatusMessage(args) {
	...
	const cappedPersistedContextTokens = typeof persistedContextTokens === "number" && typeof activeContextTokens === "number" ? Math.min(persistedContextTokens, activeContextTokens) : persistedContextTokens;
	...
	const contextLine = [`Context: ${totalTokens == null || totalTokens === 0 ? formatEstimatedContextBudgetTokens(entry?.contextBudgetStatus, contextTokens) ?? formatTokens(totalTokens, contextTokens ?? null) : formatTokens(totalTokens, contextTokens ?? null)}`, `🧹 Compactions: ${entry?.compactionCount ?? 0}`].filter(Boolean).join(" · ");
	...
	const modelLines = hasUserPinnedModelSelection(entry) && configuredDefaultModelLabel && selectedModelLabel !== configuredDefaultModelLabel && !areRuntimeModelRefsEquivalent(selectedModelLabel, configuredDefaultModelLabel, { config: args.config }) ? [
