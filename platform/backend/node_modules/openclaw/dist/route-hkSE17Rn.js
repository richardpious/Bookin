...
import { a as getPositiveIntFlagValue, c as hasFlag, i as getFlagValue, k as isValueToken, r as getCommandPositionalsWithRootOptions, s as getVerboseFlag } from "./argv-htX0ehVt.js";
import { t as resolveCliArgvInvocation } from "./argv-invocation-DOvZlpGg.js";
import { t as createLazyImportLoader } from "./lazy-promise-Djskx0qC.js";
import { n as defaultRuntime } from "./runtime-yzlkhCoS.js";
import { i as cliCommandCatalog, r as matchesCommandPath, t as resolveCliCommandPathPolicy } from "./command-path-policy-BiCwrrln.js";
import { i as parseStrictPositiveIntOrUndefined } from "./helpers-DlK2bTP5.js";
import { n as ensureCliExecutionBootstrap, r as resolveCliExecutionStartupContext, t as applyCliExecutionStartupPresentation } from "./command-execution-startup-COlPJ7H3.js";
...
const configCliLoader = createLazyImportLoader(() => import("./config-cli-BFrjilKF.js"));
const agentsListCommandLoader = createLazyImportLoader(() => import("./agents.commands.list-B8TIR5Np.js"));
const modelsListCommandLoader = createLazyImportLoader(() => import("./list.list-command-BrR01xRG.js"));
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-DXv1UL7f.js"));
...
const routedCommandDefinitions = {
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-kb5W2Nus.js");
			...
			const { statusCommand } = await import("./status-BsrHl8Y-.js");
	...
	"gateway-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runDaemonStatus } = await import("./status-Dk5IQYRZ.js");
	...
	sessions: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { sessionsCommand } = await import("./sessions-DygStlin.js");
	...
	"tasks-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { tasksListJsonCommand } = await import("./tasks-json-CCVf23mJ.js");
	...
	"tasks-audit": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { tasksAuditJsonCommand } = await import("./tasks-json-CCVf23mJ.js");
	...
	"channels-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsListCommand } = await import("./list-CHfV3Y-K.js");
	...
	"channels-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsStatusCommand } = await import("./status-DnHfkRP3.js");
	...
	"plugins-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runPluginsListCommand } = await import("./plugins-list-command-DGTdbpjD.js");
...
async function prepareRoutedCommand(params) {
	...
	const { VERSION } = await import("./version-CH9gLQAQ.js");
