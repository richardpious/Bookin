...
import { B as MANAGED_MEMORY_DREAMING_CRON_TAG, G as resolveMemoryDeepDreamingConfig, V as MEMORY_DREAMING_SYSTEM_EVENT_TEXT, W as resolveMemoryCorePluginConfig, Y as resolveMemoryDreamingWorkspaces, z as MANAGED_MEMORY_DREAMING_CRON_NAME } from "./dreaming-DiJ54ZAu.js";
import { c as peekSystemEventEntries } from "./system-events-Br-JdvCt.js";
...
import { n as normalizeTrimmedString, t as includesSystemEventToken } from "./dreaming-shared-twpRe-Pz.js";
...
async function runShortTermDreamingPromotionIfTriggered(params) {
	...
	const [{ writeDeepDreamingReport }, { generateAndAppendDreamNarrative, runDetachedDreamNarrative }, { runDreamingSweepPhases }, { applyShortTermPromotions, repairShortTermPromotionArtifacts, rankShortTermPromotionCandidates }] = await Promise.all([
		import("./dreaming-markdown-C3Mcucob.js"),
		import("./dreaming-narrative-CVnWWbGl.js"),
		import("./dreaming-phases-BXlHpHnv.js"),
		import("./short-term-promotion-B_mGHd7P.js")
	]);
...
function registerShortTermPromotionDreaming(api) {
	...
	const scheduleStartupCronRetry = () => {
		...
		startupCronRetryTimer = setTimeout(() => {
			...
			reconcileManagedDreamingCron({ reason: "runtime" }).then(() => {
				if (disposed || hasStartupCron()) {
					clearStartupCronRetry();
					return;
				}
