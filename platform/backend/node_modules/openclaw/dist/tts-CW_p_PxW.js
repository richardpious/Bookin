...
import { r as assertOkOrThrowProviderError } from "./provider-http-errors-BEw8ykZh.js";
...
async function openaiTTS(params) {
	...
	try {
		...
		return await readResponseWithLimit(response, maxBytes, { onOverflow: ({ maxBytes }) => /* @__PURE__ */ new Error(`OpenAI TTS audio response exceeds ${maxBytes} bytes`) });
	} finally {
		await release();
	}
}
