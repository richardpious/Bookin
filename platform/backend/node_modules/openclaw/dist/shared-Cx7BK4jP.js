...
import { n as normalizeAgentModelRefForConfig, o as toAgentModelListLike } from "./model-input-CET5RLn0.js";
import "./agent-scope-BeI1SY1H.js";
import { l as normalizeAgentId } from "./session-key-CJf5_zWs.js";
import { n as listAgentIds } from "./agent-scope-config-CaXAl7-j.js";
...
function buildProviderAliasMap(params) {
	...
	for (const plugin of listManifestPlugins(params)) for (const [aliasProvider, target] of Object.entries(plugin.modelCatalog?.aliases ?? {})) {
...
*/
//#endregion
export { loadValidConfigOrThrow as a, resolveModelKeysFromEntries as c, upsertCanonicalModelConfigEntry as d, isLocalBaseUrl as f, formatTokenK as i, resolveModelTarget as l, createModelCatalogProviderAliasCanonicalizer as m, ensureFlagCompatibility as n, mergePrimaryFallbackConfig as o, canonicalizeModelCatalogProviderAlias as p, formatMs as r, resolveKnownAgentId as s, applyDefaultModelPrimaryUpdate as t, updateConfig as u };
