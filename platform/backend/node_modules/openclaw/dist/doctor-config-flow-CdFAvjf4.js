...
import { i as LEGACY_SECRETREF_ENV_MARKER_PREFIX, p as parseLegacySecretRefEnvMarker } from "./types.secrets-CuOz9KrZ.js";
...
import { i as setPathExistingStrict } from "./path-utils-hvU8RLf2.js";
import { n as discoverConfigSecretTargets } from "./target-registry-CwMproYl.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-By9euW-h.js";
import { n as formatConfigIssueLines } from "./issue-format-c8ezaSew.js";
import { r as normalizeTalkSection } from "./talk-B4JlnxOO.js";
...
import { r as getBundledChannelPlugin, s as hasBundledChannelPackageSetupFeature } from "./bundled-Dwfyb6k4.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-CwcwyKzL.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-vNyAsqzr.js";
import { a as legacyRuntimeModelAliasRequiresRuntimePolicy, c as mergeMissing, i as migrateLegacyXSearchConfig, o as listLegacyRuntimeModelProviderAliases, r as migrateLegacyWebSearchConfig, s as migrateLegacyRuntimeModelRef } from "./legacy-config-migrations-Ww1TJAF-.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-BTtnSVct.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-AFN16nmP.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-1Yjm-b7X.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-CjYtNgag.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-BMs616aG.js");
	...
	const { collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-Cnuhjalr.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-DDaX9To-.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-CUuA7qRl.js");
		...
		const { collectDoctorPreviewNotes } = await import("./preview-warnings-DFowi2ur.js");
