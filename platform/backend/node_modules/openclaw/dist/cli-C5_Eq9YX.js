...
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-CeCGRUS4.js";
import { n as matrixSetupAdapter } from "./setup-core-CIjM1R33.js";
import { t as withResolvedActionClient } from "./client-CXAvRKB6.js";
import { r as resolveMatrixAuthContext } from "./config-DkksmTWp.js";
...
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-Bil7K5_k.js";
...
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-iLu7aRj0.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-CauZ5f5X.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-BB9I4fHG.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-18GvvQlj.js");
