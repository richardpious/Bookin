...
import { t as createIMessageRpcClient } from "./client-7P5-Kcmt.js";
import { c as parseIMessageTarget, o as normalizeIMessageHandle, t as formatIMessageChatTarget } from "./targets-CvpxsMi3.js";
import { r as rememberIMessageReplyCache } from "./monitor-reply-cache-B5TyaAZc.js";
import { a as extractIMessageApprovalPromptBinding, i as appendIMessageApprovalReactionHintForOutboundMessage, u as registerIMessageApprovalReactionTargetForOutboundMessage } from "./normalize-DPI1uIB4.js";
...
async function trySendAttachmentForExplicitChat(params) {
	...
	if (!attachmentChatGuid) return null;
	let result;
	try {
...
async function sendMessageIMessage(to, text, opts) {
	...
	try {
		try {
			...
			if (filePath || resolvedReplyToId || !isIMessageRpcSendTimeout(error)) throw error;
...
//#endregion
export { hasPersistedIMessageEcho as n, sendMessageIMessage as t };
