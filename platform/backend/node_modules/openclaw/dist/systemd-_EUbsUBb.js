...
import { f as parseStrictInteger, m as parseStrictPositiveInteger, p as parseStrictNonNegativeInteger } from "./number-coercion-DjYijOzx.js";
...
import { i as normalizeEnvVarKey } from "./host-env-security-B90drdeB.js";
import { r as readStateDirDotEnvVarsFromStateDir } from "./state-dir-dotenv-CduBnsb-.js";
import { a as LEGACY_GATEWAY_SYSTEMD_SERVICE_NAMES, f as resolveGatewayServiceDescription, p as resolveGatewaySystemdServiceName } from "./constants-BOOZFRBo.js";
import { r as resolveHomeDir } from "./paths-d5v1FQxC.js";
import { i as runExec, r as runCommandWithTimeout } from "./exec-DuIacDCM.js";
...
import { a as renderSystemdEnvAssignment, i as parseSystemdExecStart, n as parseSystemdEnvAssignment, r as parseSystemdEnvAssignments, t as buildSystemdUnit } from "./systemd-unit-B7yQZr07.js";
...
function collectSystemdFileBackedEnvironment(params) {
	...
	for (const [rawKey, rawValue] of Object.entries(params.environment ?? {})) {
		...
		const key = normalizeSystemdEnvironmentKey(rawKey);
		if (key && params.fileManagedKeys.has(key)) environment[rawKey] = rawValue;
	}
	return environment;
}
...
async function writeSystemdGatewayEnvironmentFile(params) {
	...
	const managedKeysToDrop = new Set([...params.inlineManagedKeys ?? [], ...params.fileManagedKeys ?? []]);
	const merged = {
		...managedKeysToDrop.size > 0 ? Object.fromEntries(Object.entries(existing).filter(([key]) => {
