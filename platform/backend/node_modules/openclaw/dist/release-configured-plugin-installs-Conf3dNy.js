import { o as normalizeNullableString } from "./string-coerce-DKw2K5wM.js";
import { n as VERSION } from "./version-BjFOZC7j.js";
import { r as normalizeChatChannelId } from "./ids-BxC_RKqP.js";
import { t as getOfficialExternalPluginCatalogEntry } from "./official-external-plugin-catalog-gltTeu6n.js";
...
import { t as compareOpenClawVersions } from "./version-CAjjTWnS.js";
import "./registry-CgCBMWZD.js";
import { r as detectPluginAutoEnableCandidates } from "./plugin-auto-enable-brBbr1un.js";
...
import { c as shouldDeferConfiguredPluginInstallRepair } from "./update-phase-D2Gf6c_8.js";
import { t as asObjectRecord } from "./object-BsiS9JXh.js";
import { n as repairMissingPluginInstallsForIds } from "./missing-configured-plugin-install-DtYQt63t.js";
...
function collectSlotPluginIds(cfg) {
	...
	return ["memory", "contextEngine"].map((key) => normalizeNullableString(slots?.[key])).filter((pluginId) => !!pluginId && pluginId.toLowerCase() !== "none");
}
