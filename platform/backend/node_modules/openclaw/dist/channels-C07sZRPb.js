...
import { c as resolveDefaultAgentId, o as resolveAgentWorkspaceDir } from "./agent-scope-config-CaXAl7-j.js";
import { a as getResolvedLoggerSettings } from "./logger-Ph_vzWhz.js";
import { n as defaultRuntime, r as writeRuntimeJson } from "./runtime-yzlkhCoS.js";
import { t as danger } from "./globals-Dc2qfZst.js";
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-By9euW-h.js";
import { i as replaceConfigFile } from "./mutate-DajLmhPa.js";
import "./config-Bzaup9wC.js";
import { c as formatUnknownChannelMessage, l as formatUnsupportedChannelActionMessage } from "./error-format-ZFU1PhmU.js";
...
import { i as callGateway } from "./call-BuKoI5AV.js";
import { a as getBundledChannelSetupPlugin } from "./bundled-Dwfyb6k4.js";
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-BjxDvA5W.js";
import "./plugins-vwMXgDxy.js";
import "./logging-ZVjGjUSs.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-BJigdzml.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-D8YY2Nqu.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-DsMGeAdX.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-jaysAyiD.js";
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-cdWuNzoD.js";
import { o as getChannelsCommandSecretTargetIds } from "./command-secret-targets-A-IIV5w2.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-Cf0GFnoG.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-CRjjJzPx.js";
import { n as resolveLogFile } from "./log-tail-zpAgtUXc.js";
import { t as parseLogLine } from "./parse-log-line-C0kclqqn.js";
import { t as describeBinding } from "./agents.binding-format-B_OLxIww.js";
import { t as applyAgentBindings } from "./agents.bindings-t-NhZEXL.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-0DcBuXJL.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-CjPnLtRs.js";
import { t as channelsListCommand } from "./list-CLFmilsU.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-BJaLfKwM.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-DTYZId21.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-BNuNBvuM.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-BijszacS.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-BxChufSj.js").then(({ listChannelPluginCatalogEntries }) => listChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-BK_dN6kj.js"), loadOnboardChannels()]);
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-D4cQTuDp.js");
...
async function channelsCapabilitiesCommand(opts, runtime = defaultRuntime) {
	...
	if (!loadedCfg) return;
	let cfg = loadedCfg;
	const timeoutMs = parseTimeoutMsWithFallback(opts.timeout, 1e4);
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-CDxYMfJI.js");
