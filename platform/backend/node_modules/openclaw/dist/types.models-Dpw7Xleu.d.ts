...
import { s as AgentRuntimePolicyConfig, t as ConfiguredModelProviderRequest } from "./types.provider-request-DjXDZnyb.js";
import { T as ThinkingLevelMap, m as OpenAIResponsesCompat, p as OpenAICompletionsCompat, t as AnthropicMessagesCompat } from "./types-CBQ0-JNc.js";

//#region src/config/types.models.d.ts
declare const MODEL_APIS: readonly ["openai-completions", "openai-responses", "openai-codex-responses", "anthropic-messages", "google-generative-ai", "google-vertex", "github-copilot", "bedrock-converse-stream", "ollama", "azure-openai-responses"];
