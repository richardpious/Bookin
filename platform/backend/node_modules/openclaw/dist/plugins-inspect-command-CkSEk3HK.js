...
import { o as tracePluginLifecyclePhase, s as tracePluginLifecyclePhaseAsync } from "./discovery-B31QTAmU.js";
...
import { u as quietPluginJsonLogger } from "./plugins-command-helpers-BL30aYUI.js";
...
async function runPluginsInspectCommand(id, opts) {
	const { buildAllPluginInspectReports, buildPluginDiagnosticsReport, buildPluginInspectReport, buildPluginSnapshotReport, formatPluginCompatibilityNotice } = await import("./status-C-PN3sys.js");
	const { loadInstalledPluginIndexInstallRecords } = await import("./installed-plugin-index-records-B3kCyKmi.js");
	...
	if (!inspect) {
		defaultRuntime.error(formatMissingPluginMessage({
			id,
			listCommand: "openclaw plugins list --json"
		}));
		return defaultRuntime.exit(1);
	}
