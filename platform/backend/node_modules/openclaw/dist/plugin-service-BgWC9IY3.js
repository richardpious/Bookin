...
import { b as readStringParam, c as imageResultFromFile, g as readPositiveIntegerParam, l as jsonResult, m as readNonNegativeIntegerParam } from "./common-COS7PQnH.js";
...
import { n as startLazyPluginServiceModule } from "./plugin-runtime-DBz1g2if.js";
import { o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-BCMevVUy.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError } from "./nodes.helpers-LMg7AReV.js";
import "./param-readers-Bcwt6PB5.js";
import { t as BrowserToolSchema } from "./browser-tool.schema-CsN3fntm.js";
import { n as withTimeout } from "./sdk-security-runtime-B0-eAFUp.js";
import { L as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./cdp.helpers-WyU0BhTo.js";
...
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-Cobp0uQD.js";
import { c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as isPersistentBrowserProfileMutation, l as browserAct, n as persistBrowserProxyFiles, o as resolveRequestedBrowserProfile, p as browserScreenshotAction, s as browserConsoleMessages, t as applyBrowserProxyPaths, u as browserArmDialog } from "./browser-runtime-BnDmPdUN.js";
...
import { n as createBrowserControlContext } from "./plugin-enabled-DOYeoziX.js";
import { t as startBrowserControlServiceFromConfig } from "./control-service-COf3095Q.js";
import "./core-api-UrlYKIvu.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-8gA7I5B1.js"),
		...
		stop: async () => {
			...
			const { stopBrowserControlService } = await import("./control-service-BsAFdbLh.js");
