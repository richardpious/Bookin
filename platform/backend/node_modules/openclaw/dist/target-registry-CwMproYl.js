...
import { n as loadChannelSecretContractApiForRecord, t as loadChannelSecretContractApi } from "./channel-contract-api-vuoXzcO9.js";
import { t as parseConfigPathArrayIndex } from "./path-array-index-DfinFp_j.js";
import { i as parseDotPath } from "./shared-C5rQkSi0.js";
import { n as getPath } from "./path-utils-hvU8RLf2.js";
...
function matchPathTokens(segments, tokens) {
	...
	for (const token of tokens) {
		...
		if (!next || parseConfigPathArrayIndex(next) === void 0) return null;
		captures.push(next);
		index += 2;
	}
...
function materializePathTokens(tokens, captures) {
	...
	for (const token of tokens) {
		...
		if (!arrayIndex || parseConfigPathArrayIndex(arrayIndex) === void 0) return null;
