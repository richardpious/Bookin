...
import { At as boolean, Bt as discriminatedUnion, Et as array, Nn as record, Qn as url, Rn as string, Si as NEVER, Tn as object, Xn as union, Zn as unknown, dn as literal, un as lazy, wn as number, yt as _enum } from "./schemas-Del5uzR8.js";
import { n as ZodIssueCode } from "./compat-bCpUj7Jq.js";
import { t as InstallRecordShape } from "./zod-schema.installs-D7BhBdmh.js";
import { C as SecretInputSchema, E as SecretsConfigSchema, F as VisibleRepliesSchema, P as TypingModeSchema, _ as NativeCommandsSettingSchema, c as GroupChatSchema, d as HumanDelaySchema, g as ModelsConfigSchema, j as TtsConfigSchema, k as TranscribeAudioSchema, n as BlockStreamingCoalesceSchema, p as InboundDebounceSchema, r as CliBackendSchema, t as BlockStreamingChunkSchema, u as HexColorSchema, y as QueueSchema, z as createAllowDenyChannelRulesSchema } from "./zod-schema.core-Blo_HNrk.js";
import { t as sensitive } from "./zod-schema.sensitive-3GVmnUbm.js";
import { t as parseDurationMs } from "./parse-duration-CI8nUnt1.js";
import { a as AgentSandboxSchema, c as MemorySearchSchema, d as AgentModelSchema, f as AgentToolModelSchema, i as AgentRunRetriesConfigSchema, n as AgentEntrySchema, o as ElevatedAllowFromSchema, r as AgentModelRuntimeEntrySchema, s as HeartbeatSchema, t as AgentContextLimitsSchema, u as ToolsSchema } from "./zod-schema.agent-runtime-BMFszaAv.js";
import { a as ApprovalsSchema, n as ChannelsSchema } from "./zod-schema.channels-config-CjDYNaFW.js";
...
const SecuritySchema = object({ audit: object({ suppressions: array(object({
...
const McpServerSchema = object({
	...
	transport: union([literal("sse"), literal("streamable-http")]).optional(),
...
const OpenClawSchema = object({
	...
	gateway: object({
		...
		webchat: object({ chatHistoryMaxChars: number().int().positive().max(5e5).optional() }).strict().optional(),
