import { i as OpenClawConfig, kn as CliBackendConfig, pt as TalkProviderConfig, t as ConfigFileSnapshot } from "./types.openclaw-FkxG7fk3.js";
import { l as SecretInput } from "./types.secrets-tbFW-hY6.js";
import { o as AgentModelConfig } from "./types.provider-request-DjXDZnyb.js";
import { M as SessionScope, O as SessionMaintenanceMode } from "./types.base-BSBlTq-x.js";
import { n as SafeBinProfileFixture } from "./exec-safe-bin-policy-profiles-BDyHRwUP.js";
import { M as MemoryCitationsMode, S as ToolLoopDetectionConfig } from "./types.tools-BMOhx4BN.js";
import { H as TtsAutoMode, U as TtsConfig, V as ResolvedTtsPersona, W as TtsMode, Y as TtsProvider } from "./types.slack-B4UzTgqu.js";
import { c as ImageContent, d as Model, n as Api, r as AssistantMessage, w as ThinkingLevel } from "./types-CBQ0-JNc.js";
import { d as ModelProviderAuthMode, f as ModelProviderConfig, l as ModelMediaInputConfig, o as ModelCompatConfig } from "./types.models-Dpw7Xleu.js";
import { o as SsrFPolicy } from "./ssrf-skjEI_i5.js";
import { t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-HhHBni1q.js";
import { n as requestHeartbeat, t as HeartbeatRunResult } from "./heartbeat-wake-B5gXOqCt.js";
import { d as UnifiedModelCatalogEntry, f as UnifiedModelCatalogKind, h as PluginConfigUiHint, u as PluginKind } from "./manifest-registry-BftjHKx5.js";
import { t as JsonSchemaObject } from "./json-schema.types-fpZiub1R.js";
import { t as ConfigWriteAfterWrite } from "./runtime-snapshot-B6QvrEmp.js";
import { g as ConfigMutationBase, w as ConfigReplaceResult } from "./config-mC_jXMXK.js";
import { y as resolveStateDir } from "./paths-DzFdQoLV.js";
import { f as ReasoningLevel, g as VerboseLevel, m as ThinkingCatalogEntry, p as ThinkLevel, s as CommandNormalizeOptions, u as ShouldHandleTextCommandsParams } from "./commands-registry.types-C7Tb2NPD.js";
import { _ as PromptImageOrderEntry, a as SourceReplyDeliveryMode, h as InputProvenance, m as UserTurnTranscriptRecorder, n as GetReplyOptions, r as PartialReplyPayload, s as ReplyPayload } from "./types-D4HaPNnq2.js";
import { d as StreamFn } from "./validation-Cys4yUnY.js";
import { Er as AgentMessage, Or as AgentTool, jr as AgentToolResult, zr as StreamFn$1 } from "./index-CGp_nQb_.js";
import { d as InboundEventKind, n as MsgContext } from "./templating-D_GiW21h.js";
import { a as TaskDeliveryStatus, c as TaskRegistrySummary, d as TaskScopeKind, f as TaskStatus, h as CommandQueueEnqueueFn, i as TaskDeliveryState, l as TaskRuntime, m as TaskTerminalOutcome, n as TaskFlowRecord, o as TaskNotifyPolicy, p as TaskStatusCounts, r as TaskFlowStatus, s as TaskRecord, t as JsonValue, u as TaskRuntimeCounts } from "./task-flow-registry.types-B_1RpYuw.js";
import { n as SkillSnapshot, r as SkillTelemetrySource } from "./types-e2DzUtW5.js";
import { b as ExecTarget, g as ExecAsk, v as ExecMode, y as ExecSecurity } from "./exec-approvals-CPpcfY0H.js";
import { r as SandboxBackendExecSpec, s as SandboxFsBridge } from "./backend-handle.types-D7afWmft.js";
import { t as ChannelId } from "./channel-id.types-ClK6B_QE.js";
import { o as ChannelRouteRef } from "./channel-route-BlhIItCm.js";
import { t as DeliveryContext } from "./delivery-context.types-CMuLXJxD.js";
import { l as SessionSystemPromptReport, n as CliSessionBinding, o as SessionContextBudgetStatus, r as GroupKeyResolution, s as SessionEntry } from "./types-Oy4USDBa.js";
import { t as DiagnosticTraceContext } from "./diagnostic-trace-context-DKGBqNVx.js";
import { n as FailoverReason } from "./types-7Vl6d1IJ.js";
import { t as FallbackAttempt } from "./model-fallback.types-BLDHZH6C.js";
import { g as completeSimple } from "./llm-Czy2ANbl.js";
import { t as ProviderUsageSnapshot } from "./provider-usage.types-BGbkzahX.js";
import { a as ensureAgentWorkspace, r as InternalHookHandler } from "./internal-hook-types-BohNPEA8.js";
import { r as AnyAgentTool } from "./common-C5X3-7Sz.js";
import { c as OAuthCredential, i as AuthProfileCredential, s as AuthProfileStore, t as ApiKeyCredential } from "./types-qgn2mJGT.js";
import { t as ModelCatalogEntry } from "./model-catalog.types-u8upOb3K.js";
import { Oi as AuthStorage, xi as ModelRegistry$1 } from "./index-pZd7c38m.js";
import { n as RuntimeEnv } from "./runtime-Bxifh4bY.js";
import { s as LogLevel } from "./subsystem-CfQVin8T.js";
import { _ as ResolvedProviderAuth } from "./model-auth-BOl4YOFn.js";
import { c as EmbeddedAgentExecutionPhase } from "./store-B_fjddgo.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-6FEupg54.js";
import { M as resolveAgentDir, N as resolveAgentWorkspaceDir } from "./agent-scope-BMW8Qxek.js";
import { a as createAckReactionHandle, c as shouldAckReaction, d as resolveAgentIdentity, f as resolveEffectiveMessagesConfig, o as removeAckReactionAfterReply, p as resolveHumanDelayConfig, s as removeAckReactionHandleAfterReply } from "./ack-reactions-1NIhY-RD.js";
import { _ as resolveSessionFilePath, a as patchSessionEntry, b as resolveStorePath, d as updateSessionStoreEntry, f as upsertSessionEntry, i as listSessionEntries, m as loadSessionStore, r as getSessionEntry, u as updateSessionStore } from "./session-key-D2ahr6Uh.js";
import { f as MediaUnderstandingProvider } from "./types-syw1tl7b.js";
import { o as enqueueSystemEvent } from "./system-events-aSa8pIiL.js";
import { a as runCommandWithTimeout } from "./exec-BdCmhVG3.js";
import { s as mediaKindFromMime } from "./constants-Bjv4FoLj.js";
import { h as resizeToJpeg, u as getImageMetadata } from "./media-services-VQu0-ewV.js";
import { n as loadWebMedia } from "./web-media-DPbTJU4K.js";
import { n as detectMime } from "./mime-Ds6Fkh-A.js";
import { d as readRemoteMediaBuffer, f as saveRemoteMedia, g as isVoiceCompatibleAudio, p as saveResponseMedia, u as fetchRemoteMedia } from "./fetch-6raxI7fB.js";
import { _ as ImageGenerationSourceImage, c as ImageGenerationOutputFormat, f as ImageGenerationProviderOptions, h as ImageGenerationResolution, i as ImageGenerationNormalization, l as ImageGenerationProvider, n as ImageGenerationBackground, p as ImageGenerationQuality, r as ImageGenerationIgnoredOverride, t as GeneratedImageAsset } from "./types-JBpoJNDW.js";
import { d as VideoGenerationResolution, n as VideoGenerationIgnoredOverride, o as VideoGenerationNormalization, p as VideoGenerationSourceAsset, s as VideoGenerationProvider, t as GeneratedVideoAsset } from "./types-CE7181rU.js";
import { c as MusicGenerationProvider, f as MusicGenerationSourceImage, o as MusicGenerationNormalization, r as MusicGenerationIgnoredOverride, s as MusicGenerationOutputFormat, t as GeneratedMusicAsset } from "./types-CAN42W1Y.js";
...
import { n as GatewayRequestHandler, y as SecretInputMode } from "./types-BS4JTU5w.js";
import { a as onAgentEvent, n as AgentEventPayload, r as AgentEventStream } from "./agent-events-DtKTaaH3.js";
import { a as shouldLogVerbose } from "./globals-BL1_NohW.js";
import { i as PluginStateSyncKeyedStore, r as PluginStateKeyedStore, t as OpenKeyedStoreOptions } from "./plugin-state-store.types-BaJtc5SJ.js";
import { t as HookEntry } from "./types-BCpQVPCb.js";
import { a as MediaUnderstandingRuntime } from "./runtime-types-BNY_gTNK.js";
import { _ as chunkTextWithMode, g as chunkText, h as chunkMarkdownTextWithMode, m as chunkMarkdownText, n as ChannelOutboundAdapter, p as chunkByNewline, v as resolveChunkMode, y as resolveTextChunkLimit } from "./outbound.types-CPrgy4We.js";
import { r as EmbeddingProviderAdapter } from "./embedding-providers-B5Llu2tv.js";
import { f as MemoryPluginRuntime, o as MemoryFlushPlanResolver, p as MemoryPromptSectionBuilder, r as MemoryCorpusSupplement, s as MemoryPluginCapability } from "./memory-state-Dc1KIMfj.js";
import { Bt as PluginNextTurnInjectionEnqueueResult, Ct as PluginHookToolKind, Ht as PluginJsonValue, M as PluginHookBeforeToolCallEvent, N as PluginHookBeforeToolCallResult, St as PluginHookToolInputKind, a as PluginApprovalResolution, et as PluginHookName, q as PluginHookHandlerMap, tn as PluginHookBeforeAgentStartResult, xt as PluginHookToolContext, zt as PluginNextTurnInjection } from "./hook-types-Cyy3i-Xg.js";
import { t as OperatorScope } from "./operator-scopes-ijAvkvEk.js";
import { n as ChannelPlugin } from "./types.public-C--qU0lk.js";
import { Vt as TalkTransport, a as DiagnosticEventPayload, i as DiagnosticEventMetadata, o as DiagnosticEventPrivateData, r as DiagnosticEventInput } from "./diagnostic-events-CxpSYO1s.js";
import { o as TranscriptSourceProvider$1 } from "./provider-types-Ba83NN2D.js";
import { a as PluginConversationBindingResolvedEvent, n as PluginConversationBindingRequestParams, r as PluginConversationBindingRequestResult, t as PluginConversationBinding } from "./conversation-binding.types-Bje6qkJz.js";
import { r as ReplyDispatcher } from "./reply-dispatcher.types-DMvdWrAr.js";
import { i as MatchesMentionWithExplicit$1, r as MatchesMentionPatterns$1, t as BuildMentionRegexes$1 } from "./mentions.types-BHC8SwPu.js";
import { n as RecordInboundSession$1 } from "./session.types-CkQNOrNB.js";
import { c as SessionBindingRecord } from "./session-binding.types-cd2c9es6.js";
import { t as hasControlCommand } from "./command-detection-CI4jcnQR.js";
import { t as ResolveMarkdownTableMode } from "./markdown-tables.types-PqdhiV-_.js";
import { t as convertMarkdownTables } from "./tables-CmnZeKxg.js";
import { c as DispatchReplyFromConfig, o as createReplyDispatcherWithTyping, t as DispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher.types-CBPUaOcN.js";
import { n as finalizeInboundContext } from "./inbound-context-jFWZJxSc.js";
import { a as resolveEnvelopeFormatOptions, n as formatAgentEnvelope, r as formatInboundEnvelope } from "./envelope-4YyBAzRm.js";
import { i as buildAgentSessionKey, o as resolveAgentRoute } from "./resolve-route-CLsHgyl2.js";
import { n as ReadChannelAllowFromStoreForAccount, r as UpsertChannelPairingRequestForAccount } from "./pairing-store.types-C5p348D3.js";
import { t as buildPairingReply } from "./pairing-messages-BHpPg56p.js";
...
import { n as resolveChannelGroupPolicy, r as resolveChannelGroupRequireMention } from "./group-policy-CBmDuSPI.js";
import { n as createInboundDebouncer, r as resolveInboundDebounceMs } from "./inbound-debounce-BPp3KX6P.js";
import { r as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-CqkwecYF.js";
import { a as runPreparedInboundReply, b as buildChannelInboundEventContext, i as runChannelInboundEvent, t as dispatchChannelInboundReply } from "./kernel-DZGrG75y.js";
...
type ExecAutoReviewHost = "gateway" | "node";
...
type ProviderResolveExternalOAuthProfilesContext = ProviderResolveExternalAuthProfilesContext;
type ProviderExternalAuthProfile = {
  profileId: string;
  credential: OAuthCredential;
  persistence?: "runtime-only" | "persisted";
};
type ProviderExternalOAuthProfile = ProviderExternalAuthProfile;
//#endregion
...
type RunEmbeddedAgentParams = {
  sessionId: string;
  sessionKey?: string; /** Provider prompt-cache affinity key; distinct from transcript/session identity. */
  ...
  senderIsOwner?: boolean; /** Current channel ID for auto-threading (Slack). */
  ...
  agentHarnessId?: string; /** Explicit runtime override selected for this turn. Unlike agentHarnessId, this may force OpenClaw. */
...
type ReadSessionUpdatedAt$1 = (params: {
  storePath: string;
  sessionKey: string;
}) => number | undefined;
...
type RecordSessionMetaFromInbound$1 = (params: {
  storePath: string;
  sessionKey: string;
  ctx: MsgContext;
 ...
 */
declare function resolveEmbeddedAgentRuntime(_env?: NodeJS.ProcessEnv): EmbeddedAgentRuntime;
//#endregion
...
//#endregion
//#region src/agents/agent-tools.before-tool-call.d.ts
...
type AgentRuntimeMessagePresentationButton = {
  /** User-visible button label. */label: string; /** Callback command or opaque value sent when pressed. */
  value?: string; /** External URL opened by the button. */
  url?: string; /** Channel-native web app URL for renderers that support embedded web apps. */
  webApp?: {
    url: string;
...
type AgentRuntimeMessagePresentationOption = {
  /** User-visible option label. */label: string; /** Callback command or opaque value sent when selected. */
  value: string;
};
/**
...
type EmbeddedRunAttemptBase = Omit<RunEmbeddedAgentParams, "provider" | "model" | "authProfileId" | "authProfileIdSource" | "thinkLevel" | "lane" | "enqueue">;
...
type EmbeddedRunAttemptParams = EmbeddedRunAttemptBase & {
  ...
  runtimePlan?: AgentRuntimePlan; /** Host-issued scope for harnesses that mirror native child runs into task state. */
  agentHarnessTaskRuntimeScope?: AgentHarnessTaskRuntimeScope; /** Live observer called after wrapped tool outcomes are recorded. */
  onToolOutcome?: ToolOutcomeObserver;
  model: Model;
...
type CliBackendPlugin = {
  ...
  modelProvider?: string; /** Default backend config before user overrides from `agents.defaults.cliBackends`. */
...
type PluginTranscriptsSourceProviderEntry = TranscriptSourceProvider & {
  pluginId: string;
};
...
type OpenClawPluginApi = {
  ...
  registerMediaUnderstandingProvider: (provider: MediaUnderstandingProviderPlugin) => void; /** Register a transcripts source provider (live or imported meeting transcript capability). */
  registerTranscriptSourceProvider: (provider: TranscriptSourceProvider) => void; /** Register an image generation provider (image generation capability). */
...
//#endregion
export { OpenClawPluginService as $, TaskFlowView as $a, setBeforeToolCallDiagnosticsEnabled as $i, SubagentRunParams as $n, WebSearchProviderToolExecutionContext as $o, RealtimeVoiceAudioFormat as $r, ProviderModelSelectedContext as $t, OpenClawPluginDefinition as A, ContextEngineRuntimeContext as Aa, AgentHarnessResetParams as Ai, ProviderResolvePromptOverlayContext as An, TtsDirectiveParseResult as Ao, CodexAppServerToolResultHandlerResult as Ar, ProviderThinkingPolicyContext as As, ProviderAuthOptionBag as At, OpenClawPluginModule as B, LlmCompleteParams as Ba, NormalizedUsage as Bi, ProviderTransportTurnState as Bn, PluginWebSearchProviderEntry as Bo, CliBundleMcpMode as Br, ProviderSyntheticAuthResult as Bs, ProviderCatalogResult as Bt, OpenClawPluginApi as C, ContextEngineHostCapability as Ca, RealtimeTranscriptionSessionCreateRequest as Ci, ProviderReplaySanitizeMode as Cn, SpeechSynthesisRequest as Co, PluginSessionTurnUnscheduleByTagResult as Cr, prepareSimpleCompletionModel as Cs, PluginTranscriptsSourceProviderEntry as Ct, OpenClawPluginCliRegistrar as D, ContextEngineOperation as Da, AgentHarnessCompactParams as Di, ProviderResolveAuthProfileIdContext as Dn, SpeechTelephonySynthesisRequest as Do, CodexAppServerExtensionFactory as Dr, augmentModelCatalogWithProviderPlugins as Ds, ProviderAuthKind as Dt, OpenClawPluginCliContext as E, ContextEngineMaintenanceResult as Ea, AgentHarnessAttemptResult as Ei, ProviderReplayToolCallIdMode as En, SpeechSynthesisTarget as Eo, CodexAppServerExtensionContext as Er, resolveModelAsync as Es, ProviderAuthDoctorHintContext as Et, OpenClawPluginHttpRouteHandler as F, TranscriptRewriteReplacement as Fa, AgentHarnessSupportContext as Fi, ProviderRuntimeProviderConfig as Fn, OpenClawPluginToolFactory as Fo, CliBackendPrepareExecutionContext as Fr, ProviderExternalAuthProfile as Fs, ProviderBuiltInModelSuppressionResult as Ft, OpenClawPluginNodeInvokePolicyApprovalRuntime as G, BoundTaskFlowsRuntime as Ga, DeferredPluginToolApproval as Gi, RealtimeVoiceProviderPlugin as Gn, WebFetchProviderToolDefinition as Go, AgentToolResultMiddlewareEvent as Gr, MessagingToolSourceReplyPayload as Gs, ProviderDiscoveryOrder as Gt, OpenClawPluginNodeHostCommand as H, LlmCompleteUsage as Ha, AgentRuntimePlan as Hi, ProviderWebSocketSessionPolicy as Hn, WebFetchProviderContext as Ho, PluginTextTransforms as Hr, EmbeddedAgentRunMeta as Hs, ProviderCreateStreamFnContext as Ht, OpenClawPluginHttpRouteMatch as I, TranscriptRewriteRequest as Ia, CompactEmbeddedAgentSessionParams as Ii, ProviderSanitizeReplayHistoryContext as In, OpenClawPluginToolOptions as Io, CliBackendPreparedExecution as Ir, ProviderExternalOAuthProfile as Is, ProviderCacheTtlEligibilityContext as It, OpenClawPluginNodeInvokeTransportResult as J, PluginRuntimeTaskRuns as Ja, getBeforeToolCallPolicyDiagnosticState as Ji, UnifiedModelCatalogProviderContext as Jn, WebSearchProviderContext as Jo, AgentToolResultMiddlewareResult as Jr, normalizeHeartbeatToolResponse as Js, ProviderExtraParamsForTransportResult as Jt, OpenClawPluginNodeInvokePolicyContext as K, BoundTaskRunsRuntime as Ka, HookContext as Ki, SpeechProviderPlugin as Kn, WebFetchRuntimeMetadataContext as Ko, AgentToolResultMiddlewareHarness as Kr, HEARTBEAT_RESPONSE_TOOL_NAME as Ks, ProviderDiscoveryResult as Kt, OpenClawPluginHttpRouteParams as L, TranscriptRewriteResult as La, EmbeddedRunAttemptParams as Li, ProviderSystemPromptContributionContext as Ln, emitSessionTranscriptUpdate as Lo, CliBackendResolveExecutionArgs as Lr, ProviderResolveExternalAuthProfilesContext as Ls, ProviderCapabilities as Lt, OpenClawPluginGatewayRuntimeScopeSurface as M, IngestResult as Ma, AgentHarnessSideQuestionParams as Mi, ProviderResolveUsageAuthContext as Mn, OpenClawPluginActiveModelContext as Mo, CliBackendNativeToolMode as Mr, ProviderRuntimeModel as Ms, ProviderBuildMissingAuthMessageContext as Mt, OpenClawPluginHostedMediaResolver as N, SubagentEndReason as Na, AgentHarnessSideQuestionResult as Ni, ProviderResolveWebSocketSessionPolicyContext as Nn, OpenClawPluginHookOptions as No, CliBackendNormalizeConfigContext as Nr, ProviderRuntimePluginHandle as Ns, ProviderBuildUnknownModelHintContext as Nt, OpenClawPluginCommandDefinition as O, ContextEngineProjection as Oa, AgentHarnessCompactResult as Oi, ProviderResolveDynamicModelContext as On, SpeechVoiceOption as Oo, CodexAppServerExtensionRuntime as Or, provider_runtime_d_exports as Os, ProviderAuthMethod as Ot, OpenClawPluginHttpRouteAuth as P, SubagentSpawnPreparation as Pa, AgentHarnessSupport as Pi, ProviderResolvedUsageAuth as Pn, OpenClawPluginToolContext as Po, CliBackendPlugin as Pr, ProviderSystemPromptContribution as Ps, ProviderBuiltInModelSuppressionContext as Pt, OpenClawPluginSecurityAuditContext as Q, TaskFlowDetail as Qa, runBeforeToolCallHook as Qi, PluginRuntime as Qn, WebSearchProviderToolDefinition as Qo, REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ as Qr, ProviderFollowupFallbackRouteResult as Qt, OpenClawPluginHttpRouteUpgradeHandler as R, LlmCompleteCaller as Ra, EmbeddedRunAttemptResult as Ri, ProviderToolSchemaDiagnostic as Rn, onSessionTranscriptUpdate as Ro, CliBackendResolveExecutionArgsContext as Rr, ProviderResolveExternalOAuthProfilesContext as Rs, ProviderCatalogContext as Rt, OpenClawPluginAgentEventsApi as S, ContextEngine as Sa, RealtimeTranscriptionSessionCallbacks as Si, ProviderReplayPolicyContext as Sn, SpeechProviderResolveTalkOverridesContext as So, PluginSessionTurnUnscheduleByTagParams as Sr, completeWithPreparedSimpleCompletionModel as Ss, PluginTextTransformRegistration as St, OpenClawPluginCliCommandDescriptor as T, ContextEngineInfo as Ta, AgentHarnessAttemptParams as Ti, ProviderReplaySessionState as Tn, SpeechSynthesisStreamResult as To, PluginTrustedToolPolicyRegistration as Tr, resolveSimpleCompletionSelectionForAgent as Ts, ProviderAuthContext as Tt, OpenClawPluginNodeInvokeApprovalDecision as U, PluginRuntimeCore as Ua, BuildAgentRuntimePlanParams as Ui, ProviderWrapStreamFnContext as Un, WebFetchProviderId as Uo, AgentToolResultMiddleware as Ur, EmbeddedAgentRunResult as Us, ProviderDeferSyntheticProfileAuthContext as Ut, OpenClawPluginNodeCliFeatureOptions as V, LlmCompleteResult as Va, normalizeUsage as Vi, ProviderValidateReplayTurnsContext as Vn, WebFetchCredentialResolutionSource as Vo, PluginTextReplacement as Vr, EmbeddedAgentCompactResult as Vs, ProviderCreateEmbeddingProviderContext as Vt, OpenClawPluginNodeInvokePolicy as W, RuntimeLogger as Wa, BeforeToolCallPolicyDiagnosticState as Wi, RealtimeTranscriptionProviderPlugin as Wn, WebFetchProviderPlugin as Wo, AgentToolResultMiddlewareContext as Wr, MessagingToolSend as Ws, ProviderDiscoveryContext as Wt, OpenClawPluginRunContextApi as X, DetachedTaskFinalizeParams as Xa, isToolWrappedWithBeforeToolCallHook as Xi, VideoGenerationProviderPlugin as Xn, WebSearchProviderPlugin as Xo, OpenClawAgentToolResult as Xr, ProviderFetchUsageSnapshotContext as Xt, OpenClawPluginReloadRegistration as Y, PluginRuntimeTasks as Ya, hasBeforeToolCallPolicy as Yi, UnifiedModelCatalogProviderPlugin as Yn, WebSearchProviderId as Yo, AgentToolResultMiddlewareRuntime as Yr, ProviderFailoverErrorContext as Yt, OpenClawPluginSecurityAuditCollector as Z, DetachedTaskLifecycleRuntime as Za, requestDeferredPluginToolApproval as Zi, CreatePluginRuntimeOptions as Zn, WebSearchProviderSetupContext as Zo, REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ as Zr, ProviderFollowupFallbackRouteContext as Zt, MigrationSummary as _, resolveContextEngine as _a, RealtimeTranscriptionProviderConfig as _i, ProviderPrepareRuntimeAuthContext as _n, SpeechProviderOverrides as _o, PluginSessionExtensionProjection as _r, ExecToolDefaults as _s, PluginRealtimeVoiceProviderEntry as _t, ImageGenerationProviderPlugin as a, MemoryEmbeddingProvider as aa, RealtimeVoiceBrowserSession as ai, ProviderNormalizeToolSchemasContext as an, ResolvedTtsModelOverrides as ao, PluginAgentEventEmitParams as ar, resolveAgentTimeoutMs as as, PluginCommandContext as at, OpenClawGatewayDiscoveryService as b, BootstrapResult as ba, RealtimeTranscriptionProviderResolveConfigContext as bi, ProviderReasoningOutputModeContext as bn, SpeechProviderResolveConfigContext as bo, PluginSessionSchedulerJobRegistration as br, PreparedSimpleCompletionModelForAgent as bs, PluginSetupAutoEnableProbe as bt, MigrationDetection as c, MemoryEmbeddingProviderCreateOptions as ca, RealtimeVoiceProviderCapabilities as ci, ProviderPlugin as cn, TTS_AUTO_MODES as co, PluginControlUiDescriptor as cr, RunEmbeddedAgentParams as cs, PluginCommandResult as ct, MigrationItemKind as d, clearMemoryEmbeddingProviders as da, RealtimeVoiceProviderId as di, ProviderPluginWizard as dn, SpeechDirectiveTokenParseResult as do, PluginRuntimeLifecycleRegistration as dr, OPENCLAW_RUNTIME_CONTEXT_CUSTOM_TYPE as ds, PluginEmbeddingProvider as dt, wrapToolWithBeforeToolCallHook as ea, RealtimeVoiceBargeInOptions as ei, ProviderModernModelPolicyContext as en, TaskRunAggregateSummary as eo, SubagentRunResult as er, WebSearchRuntimeMetadataContext as es, OpenClawPluginServiceContext as et, MigrationItemStatus as f, listRegisteredMemoryEmbeddingProviders as fa, RealtimeVoiceProviderResolveConfigContext as fi, ProviderPluginWizardModelPicker as fn, SpeechListVoicesRequest as fo, PluginSessionActionContext as fr, BlockReplyChunking as fs, PluginInteractiveHandlerRegistration as ft, MigrationProviderPreparation as g, registerContextEngine as ga, RealtimeVoiceToolResultOptions as gi, ProviderPrepareExtraParamsContext as gn, SpeechProviderId as go, PluginSessionAttachmentResult as gr, ExecElevatedDefaults as gs, PluginRealtimeTranscriptionProviderEntry as gt, MigrationProviderPlugin as h, ContextEngineFactoryContext as ha, RealtimeVoiceToolCallEvent as hi, ProviderPrepareDynamicModelContext as hn, SpeechProviderConfiguredContext as ho, PluginSessionAttachmentParams as hr, ClientToolDefinition as hs, PluginLogger as ht, AgentPromptSurfaceKind as i, MemoryEmbeddingBatchOptions as ia, RealtimeVoiceBridgeEvent as ii, ProviderNormalizeResolvedModelContext as in, ResolvedTtsConfig as io, ProviderResolveConfigApiKeyContext as ir, GenerateImageRuntimeResult as is, OpenClawPluginSessionWorkflowApi as it, OpenClawPluginGatewayMethod as j, IngestBatchResult as ja, AgentHarnessResultClassification as ji, ProviderResolveTransportTurnStateContext as jn, ResolvedProviderRuntimeAuth as jo, CliBackendAuthEpochMode as jr, ProviderThinkingProfile as js, ProviderAuthResult as jt, OpenClawPluginConfigSchema as k, ContextEnginePromptCacheInfo as ka, AgentHarnessDeliveryDefaults as ki, ProviderResolveNonInteractiveApiKeyParams as kn, TtsDirectiveOverrides as ko, CodexAppServerToolResultEvent as kr, ProviderDefaultThinkingPolicyContext as ks, ProviderAuthMethodNonInteractiveContext as kt, MigrationItem as l, MemoryEmbeddingProviderCreateResult as la, RealtimeVoiceProviderConfig as li, ProviderPluginCatalog as ln, normalizeTtsAutoMode as lo, PluginRunContextGetParams as lr, PromptMode as ls, PluginConfigMigration as lt, MigrationProviderContext as m, ContextEngineFactory as ma, RealtimeVoiceTool as mi, ProviderPreferRuntimeResolvedModelContext as mn, SpeechProviderConfig as mo, PluginSessionActionResult as mr, AgentStreamParams as ms, PluginInteractiveRegistration as mt, AgentPromptGuidance as n, resolveEmbeddedAgentRuntime as na, RealtimeVoiceBridgeCallbacks as ni, ProviderNonInteractiveApiKeyResult as nn, TaskRunDetail as no, ProviderApplyConfigDefaultsContext as nr, GenerateVideoRuntimeResult as ns, OpenClawPluginSessionControlsApi as nt, MediaUnderstandingProviderPlugin as o, MemoryEmbeddingProviderAdapter as oa, RealtimeVoiceBrowserSessionCreateRequest as oi, ProviderNormalizeTransportContext as on, TtsConfigResolutionContext as oo, PluginAgentEventEmitResult as or, CurrentInboundPromptContext as os, PluginCommandDiagnosticsSession as ot, MigrationPlan as p, registerMemoryEmbeddingProvider as pa, RealtimeVoiceRole as pi, ProviderPluginWizardSetup as pn, SpeechModelOverridePolicy as po, PluginSessionActionRegistration as pr, EmbeddedBlockChunker as ps, PluginInteractiveHandlerResult as pt, OpenClawPluginNodeInvokePolicyResult as q, PluginRuntimeTaskFlows as qa, ToolOutcomeObserver as qi, TranscriptSourceProvider as qn, WebSearchCredentialResolutionSource as qo, AgentToolResultMiddlewareOptions as qr, HeartbeatToolResponse as qs, ProviderExtraParamsForTransportContext as qt, AgentPromptGuidanceEntry as r, MemoryEmbeddingBatchChunk as ra, RealtimeVoiceBridgeCreateRequest as ri, ProviderNormalizeModelIdContext as rn, TaskRunView as ro, ProviderNormalizeConfigContext as rr, GenerateImageParams as rs, OpenClawPluginSessionStateApi as rt, MigrationApplyResult as s, MemoryEmbeddingProviderCallOptions as sa, RealtimeVoiceCloseReason as si, ProviderOAuthProfileIdRepair as sn, resolveEffectiveTtsConfig as so, PluginAgentEventSubscriptionRegistration as sr, EmbeddedRunTrigger as ss, PluginCommandHandler as st, AGENT_PROMPT_SURFACE_KINDS as t, AgentHarnessTaskRuntimeScope as ta, RealtimeVoiceBridge as ti, ProviderNonInteractiveApiKeyCredentialParams as tn, TaskRunCancelResult as to, settleReplyDispatcher as tr, GenerateVideoParams as ts, OpenClawPluginSessionApi as tt, MigrationItemAction as u, MemoryEmbeddingProviderRuntime as ua, RealtimeVoiceProviderConfiguredContext as ui, ProviderPluginDiscovery as un, SpeechDirectiveTokenParseContext as uo, PluginRunContextPatch as ur, AgentInternalEvent as us, PluginConfigValidation as ut, MusicGenerationProviderPlugin as v, resolveContextEngineOwnerPluginId as va, RealtimeTranscriptionProviderConfiguredContext as vi, ProviderPreparedRuntimeAuth as vn, SpeechProviderPrepareSynthesisContext as vo, PluginSessionExtensionRegistration as vr, AgentSimpleCompletionSelection as vs, PluginRegistrationMode as vt, OpenClawPluginChannelRegistration as w, ContextEngineHostRequirements as wa, AgentHarness as wi, ProviderReplaySessionEntry as wn, SpeechSynthesisStreamRequest as wo, PluginToolMetadataRegistration as wr, prepareSimpleCompletionModelForAgent as ws, ProviderAugmentModelCatalogContext as wt, OpenClawPluginAgentApi as x, CompactResult as xa, RealtimeTranscriptionSession as xi, ProviderReplayPolicy as xn, SpeechProviderResolveTalkConfigContext as xo, PluginSessionTurnScheduleParams as xr, SimpleCompletionModelOptions as xs, PluginSpeechProviderEntry as xt, OpenClawGatewayDiscoveryAdvertiseContext as y, AssembleResult as ya, RealtimeTranscriptionProviderId as yi, ProviderReasoningOutputMode as yn, SpeechProviderPreparedSynthesis as yo, PluginSessionSchedulerJobHandle as yr, PreparedSimpleCompletionModel as ys, PluginSetupAutoEnableContext as yt, OpenClawPluginLifecycleApi as z, LlmCompleteMessage as za, PreemptiveCompactionRoute as zi, ProviderTransformSystemPromptContext as zn, PluginWebFetchProviderEntry as zo, CliBackendThinkingLevel as zr, ProviderResolveSyntheticAuthContext as zs, ProviderCatalogOrder as zt };