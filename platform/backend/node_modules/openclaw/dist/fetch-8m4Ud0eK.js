...
import { n as hasEnvHttpProxyAgentConfigured, o as resolveEnvHttpProxyAgentOptions } from "./proxy-env-X5Pg2u1u.js";
import { n as createHttp1EnvHttpProxyAgent, r as createHttp1ProxyAgent } from "./undici-runtime-J6eEXVxH.js";
import { o as createPinnedLookup } from "./ssrf-_PxmDk0r.js";
import { i as resolveEffectiveDebugProxyUrl } from "./env-CE6Ioijc.js";
import "./error-runtime-Dn_nurEc.js";
import { n as getProxyUrlFromFetch, r as makeProxyFetch } from "./proxy-fetch-9PPXMjbi.js";
...
import { t as captureHttpExchange } from "./runtime-BymPI_-h.js";
...
function resolveTelegramTransport(proxyFetch, options) {
	...
	const getAttemptCooldownError = (attemptIndex) => {
		...
		if (health.unhealthyUntilMs <= Date.now()) return null;
