...
declare class DebugProxyCaptureStore {
...
declare function getDebugProxyCaptureStore(dbPath: string, blobDir: string): DebugProxyCaptureStore;
...
declare function persistEventPayload(store: DebugProxyCaptureStore, params: {
