...
import { a as SourceReplyDeliveryMode, u as ReplyPayload } from "./types-CgXdquv1.js";
import { t as FinalizedMsgContext } from "./templating-BQp429Hz.js";
import { i as OpenClawConfig } from "./types.openclaw-Dkap9jPv.js";
import { H as TtsAutoMode } from "./types.slack-DAS-St0z.js";
import { t as DiagnosticTraceContext } from "./diagnostic-trace-context-DKGBqNVx.js";
import { t as PluginConversationBinding } from "./conversation-binding.types-CUczetNC.js";
import { n as ReplyDispatchKind, r as ReplyDispatcher } from "./reply-dispatcher.types-D6zjGnXN.js";
...
//#endregion
export { PluginHookModelCallStartedEvent as $, PluginHookBeforeAgentStartEvent as $t, PluginHookBeforeMessageWriteResult as A, PluginInstallTargetType as At, PluginHookGatewayCronJobState as B, PluginNextTurnInjectionEnqueueResult as Bt, PluginHookBeforeInstallEvent as C, PluginHookToolKind as Ct, PluginHookBeforeInstallSkill as D, PluginInstallFinding as Dt, PluginHookBeforeInstallResult as E, PluginHookToolResultPersistResult as Et, PluginHookCronChangedEvent as F, PluginAgentTurnPrepareEvent as Ft, PluginHookGatewayStartEvent as G, PluginHookMessageContext as Gt, PluginHookGatewayCronRunStatus as H, PluginJsonValue as Ht, PluginHookGatewayContext as I, PluginAgentTurnPrepareResult as It, PluginHookInboundClaimResult as J, PluginHookMessageSendingResult as Jt, PluginHookGatewayStopEvent as K, PluginHookMessageReceivedEvent as Kt, PluginHookGatewayCronCreateInput as L, PluginHeartbeatPromptContributionEvent as Lt, PluginHookBeforeToolCallEvent as M, isConversationHookName as Mt, PluginHookBeforeToolCallResult as N, isPluginHookName as Nt, PluginHookBeforeInstallSkillInstallSpec as O, PluginInstallRequestKind as Ot, PluginHookContextWindowSource as P, isPromptInjectionHookName as Pt, PluginHookModelCallEndedEvent as Q, PLUGIN_PROMPT_MUTATION_RESULT_FIELDS as Qt, PluginHookGatewayCronDeliveryStatus as R, PluginHeartbeatPromptContributionResult as Rt, PluginHookBeforeInstallContext as S, PluginHookToolInputKind as St, PluginHookBeforeInstallRequest as T, PluginHookToolResultPersistEvent as Tt, PluginHookGatewayCronService as U, PluginHookInboundClaimContext as Ut, PluginHookGatewayCronRemoveResult as V, PluginNextTurnInjectionRecord as Vt, PluginHookGatewayCronUpdateInput as W, PluginHookInboundClaimEvent as Wt, PluginHookLlmOutputEvent as X, GateHookResult as Xt, PluginHookLlmInputEvent as Y, PluginHookMessageSentEvent as Yt, PluginHookModelCallBaseEvent as Z, InputGateDecision as Zt, PluginHookBeforeCompactionEvent as _, PluginHookSubagentSpawnedEvent as _t, PluginApprovalResolution as a, PluginHookBeforePromptBuildEvent as an, PluginHookReplyPayload as at, PluginHookBeforeDispatchResult as b, PluginHookSubagentTargetKind as bt, PluginHookAfterToolCallEvent as c, PluginHookReplyPayloadSendingResult as ct, PluginHookBeforeAgentFinalizeEvent as d, PluginHookSessionEndReason as dt, PluginHookBeforeAgentStartOverrideResult as en, PluginHookName as et, PluginHookBeforeAgentFinalizeResult as f, PluginHookSessionStartEvent as ft, PluginHookBeforeAgentRunResult as g, PluginHookSubagentEndedEvent as gt, PluginHookBeforeAgentRunEvent as h, PluginHookSubagentDeliveryTargetResult as ht, PROMPT_INJECTION_HOOK_NAMES as i, PluginHookBeforeModelResolveResult as in, PluginHookReplyDispatchResult as it, PluginHookBeforeResetEvent as j, PromptInjectionHookName as jt, PluginHookBeforeMessageWriteEvent as k, PluginInstallSourcePathKind as kt, PluginHookAgentContext as l, PluginHookSessionContext as lt, PluginHookBeforeAgentReplyResult as m, PluginHookSubagentDeliveryTargetEvent as mt, ConversationHookName as n, PluginHookBeforeModelResolveAttachment as nn, PluginHookReplyDispatchContext as nt, PluginApprovalResolutions as o, PluginHookBeforePromptBuildResult as on, PluginHookReplyPayloadSendingContext as ot, PluginHookBeforeAgentReplyEvent as p, PluginHookSubagentContext as pt, PluginHookHandlerMap as q, PluginHookMessageSendingEvent as qt, PLUGIN_HOOK_NAMES as r, PluginHookBeforeModelResolveEvent as rn, PluginHookReplyDispatchEvent as rt, PluginHookAfterCompactionEvent as s, stripPromptMutationFieldsFromLegacyHookResult as sn, PluginHookReplyPayloadSendingEvent as st, CONVERSATION_HOOK_NAMES as t, PluginHookBeforeAgentStartResult as tn, PluginHookRegistration as tt, PluginHookAgentEndEvent as u, PluginHookSessionEndEvent as ut, PluginHookBeforeDispatchContext as v, PluginHookSubagentSpawningEvent as vt, PluginHookBeforeInstallPlugin as w, PluginHookToolResultPersistContext as wt, PluginHookBeforeInstallBuiltinScan as x, PluginHookToolContext as xt, PluginHookBeforeDispatchEvent as y, PluginHookSubagentSpawningResult as yt, PluginHookGatewayCronJob as z, PluginNextTurnInjection as zt };