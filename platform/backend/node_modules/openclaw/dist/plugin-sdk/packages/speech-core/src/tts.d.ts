...
export declare function resolveTtsConfig(cfg: OpenClawConfig, contextOrAgentId?: string | TtsConfigResolutionContext): ResolvedTtsConfig;
...
export declare function buildTtsSystemPromptHint(cfg: OpenClawConfig, agentId?: string): string | undefined;
