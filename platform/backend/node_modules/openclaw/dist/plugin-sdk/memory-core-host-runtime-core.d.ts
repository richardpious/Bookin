...
import { M as MemoryCitationsMode } from "./types.tools-Bn_OLwRV.js";
import { a as loadConfig, i as getRuntimeConfig } from "./io-CVdnKwci.js";
import { i as resolveStateDir } from "./paths-Lsj0j7L3.js";
import { p as parseAgentSessionKey } from "./session-key-fJM_U9Lv.js";
import { C as OpenClawPluginApi } from "./types-B4TJD_iZ.js";
import { C as readPositiveIntegerParam, D as readStringParam, S as readNumberParam, b as readFiniteNumberParam, g as jsonResult, r as AnyAgentTool, u as asToolParamsRecord } from "./common-BdhtzyVj.js";
import { F as resolveDefaultAgentId, S as resolveSessionAgentIds, x as resolveSessionAgentId } from "./agent-scope-B4Xy--jT.js";
import { x as resolveSessionTranscriptsDirForAgent } from "./session-file-BJp5RjHd.js";
import { _ as listMemoryCorpusSupplements, a as MemoryFlushPlan, c as MemoryPluginPublicArtifact, d as MemoryPromptSectionBuilder, g as listActiveMemoryPublicArtifacts, h as getMemoryCapabilityRegistration, i as MemoryCorpusSupplementRegistration, l as MemoryPluginPublicArtifactsProvider, m as clearMemoryPluginState, n as MemoryCorpusSearchResult, o as MemoryFlushPlanResolver, p as buildMemoryPromptSection, r as MemoryCorpusSupplement, s as MemoryPluginCapability, t as MemoryCorpusGetResult, u as MemoryPluginRuntime, v as registerMemoryCapability, y as registerMemoryCorpusSupplement } from "./memory-state-BJcIAV_c.js";
import { r as resolveCronStyleNow } from "./current-time-B7_zRNnN.js";
import { r as emptyPluginConfigSchema } from "./config-schema-JfnY3XRX.js";
import { f as resolveMemorySearchConfig, m as DEFAULT_AGENT_COMPACTION_RESERVE_TOKENS_FLOOR, s as parseNonNegativeByteSize } from "./openclaw-runtime-3BuGqTi3.js";
