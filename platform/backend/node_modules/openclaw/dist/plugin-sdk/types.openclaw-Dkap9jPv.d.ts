...
import { h as SecretsConfig, l as SecretInput } from "./types.secrets-tbFW-hY6.js";
import { c as AgentSandboxConfig, l as AgentToolModelConfig, o as AgentModelConfig, s as AgentRuntimePolicyConfig } from "./types.provider-request-DjXDZnyb.js";
import { B as TypingMode, E as SessionConfig, V as WebConfig, b as LoggingConfig, g as DmScope, n as BlockStreamingChunkConfig, p as DiagnosticsConfig, r as BlockStreamingCoalesceConfig, v as HumanDelayConfig, y as IdentityConfig } from "./types.base-bTa1ro6X.js";
import { N as MemoryConfig, _ as MemorySearchConfig, k as ToolsConfig, t as AgentToolsConfig } from "./types.tools-Bn_OLwRV.js";
import { P as MessagesConfig, T as BroadcastConfig, U as TtsConfig, j as GroupChatConfig, k as CommandsConfig, w as AudioConfig, y as ApprovalsConfig } from "./types.slack-DAS-St0z.js";
import { r as ChannelsConfig } from "./types.channels-pcykT6I6.js";
import { _ as ModelsConfigInput, g as ModelsConfig } from "./types.models-Vjh6XQd-.js";
import { t as ProxyConfig } from "./zod-schema.proxy-B1XBkex5.js";
...
type AgentConfig = {
  ...
  fastModeDefault?: boolean; /** Optional per-agent bootstrap/context injection mode override. */
...
type McpServerConfig = {
  ...
  connectionTimeoutMs?: number; /** Codex-specific projection controls for Codex app-server/runtime config. */
...
//#endregion
export { GatewayReloadConfig as $, AgentContextPruningConfig as $t, HooksGmailTailscaleMode as A, AcpSessionUpdateTag as An, AuthProfileConfig as At, GatewayHttpChatCompletionsImagesConfig as B, SkillsConfig as Bt, HookConfig as C, AcpRuntimeSessionMode as Cn, CliConfig as Ct, HookMappingTransform as D, AcpRuntimeTurnInput as Dn, BrowserSsrFPolicyConfig as Dt, HookMappingMatch as E, AcpRuntimeTurnAttachment as En, BrowserSnapshotDefaults as Et, GatewayAuthRateLimitConfig as F, SilentReplyConversationType as Fn, AgentRouteBinding as Ft, GatewayHttpResponsesImagesConfig as G, AgentCompactionIdentifierPolicy as Gt, GatewayHttpEndpointsConfig as H, SkillsLimitsConfig as Ht, GatewayBindMode as I, AgentRuntimeAcpConfig as It, GatewayNodePairingConfig as J, AgentCompactionMode as Jt, GatewayHttpResponsesPdfConfig as K, AgentCompactionMemoryFlushConfig as Kt, GatewayConfig as L, AgentRuntimeConfig as Lt, DiscoveryConfig as M, AccessGroupsConfig as Mn, AgentBinding as Mt, GatewayAuthConfig as N, DiscordChannelAudienceAccessGroup as Nn, AgentBindingMatch as Nt, HooksConfig as O, AcpRuntimeTurnResult as On, BrowserTabCleanupConfig as Ot, GatewayAuthMode as P, MessageSendersAccessGroup as Pn, AgentConfig as Pt, GatewayPushConfig as Q, AgentContextLimitsConfig as Qt, GatewayControlUiConfig as R, AgentsConfig as Rt, McpServerConfig as S, AcpRuntimePromptMode as Sn, CliBannerTaglineMode as St, HookMappingConfig as T, AcpRuntimeTurn as Tn, BrowserProfileConfig as Tt, GatewayHttpResponsesConfig as U, SkillsLoadConfig as Ut, GatewayHttpConfig as V, SkillsInstallConfig as Vt, GatewayHttpResponsesFilesConfig as W, AgentCompactionConfig as Wt, GatewayPushApnsConfig as X, AgentCompactionQualityGuardConfig as Xt, GatewayNodesConfig as Y, AgentCompactionPostIndexSyncMode as Yt, GatewayPushApnsRelayConfig as Z, AgentContextInjection as Zt, NodeHostBrowserProxyConfig as _, AcpRuntimeCapabilities as _n, CronFailureAlertConfig as _t, OpenClawConfigInput as a, AgentStartupContextConfig as an, GatewayToolsConfig as at, McpConfig as b, AcpRuntimeEvent as bn, CronRetryOn as bt, SecurityAuditSuppression as c, Gpt5PromptOverlayConfig as cn, MdnsDiscoveryConfig as ct, SurfaceConfigEntry as d, SubagentDelegationMode as dn, TalkConfig as dt, AgentDefaultsConfig as en, GatewayReloadMode as et, PluginEntryConfig as f, AcpConfig as fn, TalkConfigResponse as ft, PluginsLoadConfig as g, AcpRuntime as gn, CronConfig as gt, PluginsConfig as h, AcpStreamConfig as hn, WideAreaDiscoveryConfig as ht, OpenClawConfig as i, AgentRunRetriesConfig as in, GatewayTlsConfig as it, InternalHooksConfig as j, AccessGroupConfig as jn, AgentAcpBinding as jt, HooksGmailConfig as k, AcpRuntimeTurnResultError as kn, AuthConfig as kt, SecurityConfig as l, OptionalBootstrapFileName as ln, MdnsDiscoveryMode as lt, PluginSlotsConfig as m, AcpRuntimeConfig as mn, TalkRealtimeConfig as mt, ConfigValidationIssue as n, AgentModelEntryConfig as nn, GatewayTailscaleConfig as nt, ResolvedSourceConfig as o, CliBackendConfig as on, GatewayTrustedProxyConfig as ot, PluginInstallRecord as p, AcpDispatchConfig as pn, TalkProviderConfig as pt, GatewayHttpSecurityHeadersConfig as q, AgentCompactionMidTurnPrecheckConfig as qt, LegacyConfigIssue as r, AgentModelListConfig as rn, GatewayTailscaleMode as rt, RuntimeConfig as s, EmbeddedAgentExecutionContract as sn, GatewayWebchatConfig as st, ConfigFileSnapshot as t, AgentImageQualityPreference as tn, GatewayRemoteConfig as tt, SourceConfig as u, PromptOverlaysConfig as un, ResolvedTalkConfig as ut, NodeHostConfig as v, AcpRuntimeDoctorReport as vn, CronFailureDestinationConfig as vt, HookInstallRecord as w, AcpRuntimeStatus as wn, BrowserConfig as wt, McpServerCodexConfig as x, AcpRuntimeHandle as xn, CommitmentsConfig as xt, McpCodexToolApprovalMode as y, AcpRuntimeEnsureInput as yn, CronRetryConfig as yt, GatewayHttpChatCompletionsConfig as z, SkillConfig as zt };