...
import { At as boolean, Et as array, Nn as record, Rn as string, Tn as object, Xn as union, wn as number, yt as _enum } from "./schemas-Del5uzR8.js";
import { h as MarkdownConfigSchema } from "./zod-schema.core-Blo_HNrk.js";
...
import { d as createDefaultChannelRuntimeState, u as createComputedAccountStatusAdapter } from "./status-helpers-DBuL-HPa.js";
import { h as runStoppablePassiveMonitor, n as buildPassiveProbedChannelStatusSummary } from "./extension-shared-C-2MGtWA.js";
import "./channel-config-primitives-CdBeBfAO.js";
import { i as createPairingPrefixStripper, r as createLoggedPairingApprovalNotifier } from "./channel-pairing-C-RyjVLy.js";
import { a as normalizeTwitchChannel, i as normalizeToken, n as isAccountConfigured, o as resolveTwitchToken, r as missingTargetError, t as generateMessageId } from "./twitch-DoR1_Bq7.js";
import { a as getAccountConfig, c as resolveTwitchAccountContext, i as DEFAULT_ACCOUNT_ID, l as resolveTwitchSnapshotAccountId, o as listAccountIds, r as twitchSetupWizard, s as resolveDefaultTwitchAccountId, t as twitchSetupAdapter } from "./setup-surface-BXezhFOj.js";
import { A as accessTokenIsExpired, C as extractUserId, D as CustomError, E as rtfm, F as Enumerable, M as mapNullable, N as mapOptional, O as DataObject, P as arrayToObject, S as HttpStatusCodeError, T as HellFreezesOverError, _ as InvalidTokenError, a as removeClientManager, b as handleTwitchApiResponseError, c as Cacheable, d as CustomError$1, f as createLogger$1, g as TokenInfo, h as EventEmitter, j as promiseWithResolvers, k as rawDataSymbol, l as PartitionedTimeBasedRateLimiter, m as StaticAuthProvider, n as stripMarkdownForTwitch, o as ChatClient, p as require_detect_node, r as getClientManager, s as CachedGetter, t as chunkTextForTwitch, u as RateLimitReachedError, v as callTwitchApi, w as extractUserName, x as transformTwitchApiResponse, y as callTwitchApiRaw } from "./markdown-CoXNM5sB.js";
import { a as __read, n as __decorate, o as __spreadArray, s as init_tslib_es6 } from "./tslib.es6-DJxJwErw.js";
		...
		gateway: {
			startAccount: async (ctx) => {
				...
				await runStoppablePassiveMonitor({
					...
					start: async () => {
						const { monitorTwitchProvider } = await import("./monitor-DWJ7KlrE.js");
