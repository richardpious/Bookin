...
import { d as resolveGatewayPort, f as resolveIncludeRoots, n as DEFAULT_GATEWAY_PORT, t as CONFIG_PATH } from "./paths-BQQu4M8v.js";
...
import "./daemon-cli-Dz5GEhJ3.js";
import { w as pathExists } from "./fs-safe-DYWmA8_q.js";
import { p as resolveUserPath, u as pathExists$1 } from "./utils-DlHt_n1Q.js";
import { r as resolveConfigEnvVars } from "./env-substitution-D-AbRwK0.js";
import { i as GATEWAY_SERVICE_RUNTIME_PID_ENV, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName, u as resolveGatewayLaunchAgentLabel } from "./constants-BOOZFRBo.js";
import { i as resolveGatewayInstallEntrypoint } from "./gateway-entrypoint-BKe5gzkF.js";
import { n as VERSION } from "./version-BjFOZC7j.js";
import { n as readPersistedInstalledPluginIndex } from "./installed-plugin-index-store-CXA8VPyK.js";
import { a as readJsonIfExists, m as writeJson } from "./json-files-ruLzKqUC.js";
import { c as resolveEffectiveEnableState, s as normalizePluginsConfig } from "./config-state-Cz5agD6j.js";
import { a as resolveDefaultPluginNpmDir } from "./install-paths-P7XUTgg_.js";
import { n as loadInstalledPluginIndexInstallRecords, o as listManagedPluginNpmRoots } from "./installed-plugin-index-record-reader-B_NZbZil.js";
import { n as defaultRuntime } from "./runtime-yzlkhCoS.js";
import { a as parseSemver, i as nodeVersionSatisfiesEngine } from "./runtime-guard-DLdnBLFm.js";
import { o as resolvePackageExtensionEntries } from "./manifest-DaiqPlf0.js";
import { r as validatePackageExtensionEntriesForInstall } from "./package-entry-resolution-BvblLBKi.js";
import { c as resolveOfficialExternalPluginInstall, r as getOfficialExternalPluginCatalogManifest, t as getOfficialExternalPluginCatalogEntry } from "./official-external-plugin-catalog-gltTeu6n.js";
import { t as loadPluginManifestRegistryForInstalledIndex } from "./manifest-registry-installed-Dkz3w6u0.js";
import { r as runCommandWithTimeout } from "./exec-DuIacDCM.js";
import { F as asResolvedSourceConfig, I as asRuntimeConfig, o as parseConfigJson5, p as readSourceConfigBestEffort, q as createPreUpdateConfigSnapshot, u as readConfigFileSnapshot } from "./io-By9euW-h.js";
import { a as withPluginInstallRecords, o as withoutPluginInstallRecords } from "./installed-plugin-index-records-B68pYawc.js";
import { a as resolveConfigIncludes } from "./includes-C2irdd0v.js";
...
import { r as mutateConfigFileWithRetry } from "./mutate-DajLmhPa.js";
import { n as quoteCmdScriptArg } from "./cmd-argv-fj4pRVR6.js";
import { r as getSelfAndAncestorPidsSync } from "./restart-stale-pids-BRk5J1_8.js";
import { t as disableCurrentOpenClawUpdateLaunchdJob } from "./launchd-B9ZbU5zh.js";
import { i as resolveGatewayRestartLogPath, n as renderPosixRestartLogSetup, o as shellEscapeRestartLogValue } from "./restart-logs-DuwjWR_h.js";
import "./config-Bzaup9wC.js";
import { i as resolveGatewayService, r as readGatewayServiceState } from "./service-CCe-eBpT.js";
import { n as runDaemonInstall } from "./install-D3au318Z.js";
import { a as recoverInstalledLaunchAgent, t as runDaemonRestart } from "./lifecycle-DeUKrqxQ.js";
import { l as waitForGatewayHealthyRestart, o as renderRestartDiagnostics, s as terminateStaleGatewayPids } from "./restart-health-BjtGIVuW.js";
import { u as trimLogTail } from "./restart-sentinel-C2iY3lrL.js";
import { r as formatDurationPrecise } from "./format-duration-BrZ-AaEJ.js";
import { i as relinkOpenClawPeerDependenciesInManagedNpmRoot, n as auditOpenClawPeerDependencyLink } from "./plugin-peer-link-Ckh-dj0J.js";
import { n as stylePromptMessage } from "./prompt-style-DH7LpiPN.js";
import { a as installCompletion, n as COMPLETION_SKIP_PLUGIN_COMMANDS_ENV } from "./completion-runtime-k7R23upj.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-CSH7gmPR.js";
import { t as formatHelpExamples } from "./help-format-DXVAk021.js";
import { r as commitPluginInstallRecordsWithConfig } from "./plugins-install-record-commit-CxhwUu3W.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-BeZgxRv6.js";
import { c as resolveEffectiveUpdateChannel, i as formatUpdateChannelLabel, l as resolveRegistryUpdateChannel, r as channelToNpmTag, s as normalizeUpdateChannel, u as resolveUpdateChannelDisplay } from "./update-channels-nKAynEOl.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-qUat0xjL.js";
import { i as updateNpmInstalledPlugins, n as resolveTrustedSourceLinkedOfficialNpmSpec, r as syncPluginsForUpdateChannel, t as resolveTrustedSourceLinkedOfficialClawHubSpec } from "./update-BWNjEkxO.js";
import { n as readPackageName, r as readPackageVersion } from "./package-json-BI7u5J9F.js";
import { a as cleanupGlobalRenameDirs, c as detectGlobalInstallManagerForRoot, d as resolveGlobalInstallTarget, f as resolvePnpmGlobalDirFromGlobalRoot, i as canResolveRegistryVersionForPackageTarget, l as globalInstallArgs, n as runGatewayUpdate, o as createGlobalInstallEnv, p as normalizePackageTagInput, r as runGlobalPackageUpdateSteps, s as detectGlobalInstallManagerByPresence, u as resolveGlobalInstallSpec } from "./update-runner-DpJ4MA-N.js";
import { i as fetchNpmTagVersion, n as compareSemverStrings, o as resolveNpmChannelTag, r as fetchNpmPackageTargetStatus, t as checkUpdateStatus } from "./update-check-DqzyOmmE.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-DfLacX3k.js";
import { t as doctorCommand } from "./doctor-v7Wwg_i_.js";
import { n as UPDATE_PARENT_SUPPORTS_DOCTOR_CONFIG_WRITE_ENV, r as UPDATE_POST_CORE_CONVERGENCE_ENV, t as UPDATE_DEFER_CONFIGURED_PLUGIN_INSTALL_REPAIR_ENV } from "./update-phase-D2Gf6c_8.js";
import { t as summarizeGatewayServiceLayout } from "./service-layout-Cs5EWHFI.js";
import { c as writeControlPlaneUpdateRestartSentinel, i as buildControlPlaneUpdateRestartHealthPendingResult, o as markControlPlaneUpdateRestartSentinelFailure, s as readControlPlaneUpdateSentinelMeta } from "./update-control-plane-sentinel-BHq51uha.js";
import { n as cleanupStaleManagedServiceUpdateHandoffs } from "./update-managed-service-handoff-cleanup-BKQxjJf5.js";
import { t as repairMissingConfiguredPluginInstalls } from "./missing-configured-plugin-install-DtYQt63t.js";
import { n as pruneStaleLocalBundledPluginInstallRecords } from "./stale-local-bundled-plugin-install-records-BNzat2VY.js";
...
function inferUpdateFailureHints(result) {
	...
	if ((failedStep.name.startsWith("global update") || failedStep.name.startsWith("global install")) && stderr.includes("eacces")) {
		...
		hints.push("System install outline: openclaw gateway stop -> sudo <system-npm> i -g openclaw@latest -> openclaw gateway install --force -> openclaw gateway restart.");
	}
...
function buildInvalidConfigPostCoreUpdateResult() {
	const guidance = ["Run `openclaw doctor` to inspect the config validation errors.", "Once the config parses, rerun `openclaw update`."];
...
async function maybeRepairLegacyConfigForUpdateChannel(params) {
	...
	const { repairLegacyConfigForUpdateChannel } = await import("./legacy-config-repair-BN3crp3z.js");
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/update", "docs.openclaw.ai/cli/update")}`;
	...
	update.command("finalize", { hidden: true }).description("Run OpenClaw update finalization after an external core runtime change").option("--json", "Output result as JSON", false).option("--channel <stable|beta|dev>", "Persist update channel for finalization").option("--timeout <seconds>", "Timeout for update finalization steps in seconds (default: 1800)").option("--yes", "Skip confirmation prompts (non-interactive)", false).option("--no-restart", "Accepted for update command parity; finalization never restarts").action(async (opts, command) => {
		try {
