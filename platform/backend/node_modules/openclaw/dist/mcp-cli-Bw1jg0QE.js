import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString, f as normalizeStringifiedOptionalString, s as normalizeOptionalLowercaseString } from "./string-coerce-DKw2K5wM.js";
...
import { At as boolean, Rn as string, Tn as object, dn as literal, wn as number, yt as _enum } from "./schemas-Del5uzR8.js";
import { r as extractFirstTextBlock } from "./chat-message-content-CeOacmio.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-y0zc6Ytl.js"),
			import("./client-Bgpe31OB.js"),
			import("./client-start-readiness-B19eq0Co.js"),
			import("./method-scopes-4UWd0pay.js"),
			import("./client-info-CxZJkXf2.js")
		]);
