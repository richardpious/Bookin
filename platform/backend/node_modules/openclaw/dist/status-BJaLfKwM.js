...
import { f as listConfiguredChannelIdsForReadOnlyScope, p as listExplicitConfiguredChannelIdsForConfig } from "./channel-plugin-ids-Di5PV7SC.js";
...
import { s as getConfiguredChannelsCommandSecretTargetIds } from "./command-secret-targets-A-IIV5w2.js";
import { n as formatTimeAgo } from "./format-relative-Bjc3l98W.js";
import { r as withProgress } from "./progress-Dr4m3lDw.js";
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-CHPqOzoU.js";
...
import { n as requireValidConfigSnapshot } from "./config-validation-0DcBuXJL.js";
import { a as buildChannelAccountLine, i as appendTokenSourceBits, n as appendEnabledConfiguredLinkedBits, r as appendModeBit, t as appendBaseUrlBit } from "./shared-CjPnLtRs.js";
import { r as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-DueWDEPk.js";
...
async function channelsStatusCommand(opts, runtime = defaultRuntime) {
	const timeoutMs = parseTimeoutMsWithFallback(opts.timeout, opts.probe ? 3e4 : 1e4);
	const requestedChannel = opts.channel ? normalizeChannelId(opts.channel) : null;
