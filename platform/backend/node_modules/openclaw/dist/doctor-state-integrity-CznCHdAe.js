...
import { _ as resolveOAuthDir, y as resolveStateDir } from "./paths-BQQu4M8v.js";
import { t as asNullableObjectRecord } from "./record-coerce-Btbek4uV.js";
import { t as formatCliCommand } from "./command-format-CItqrBX6.js";
import { _ as uniqueStrings, u as normalizeStringEntriesLower } from "./string-normalization-B8G0vlWE.js";
...
import { u as resolveAgentModelFallbacksOverride } from "./agent-scope-BeI1SY1H.js";
...
import { c as resolveDefaultAgentId, n as listAgentIds, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-CaXAl7-j.js";
...
import { a as resolveSessionFilePathOptions, f as formatSessionArchiveTimestamp, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent, m as isPrimarySessionTranscriptFileName, u as resolveStorePath } from "./paths-CBJPLq30.js";
import { t as loadSessionStore } from "./store-load-BHiTqlRK.js";
import { d as updateSessionStore } from "./store-Dh6bWvq_.js";
import { i as parseModelRef, n as modelKey } from "./model-selection-normalize-DUxQN8bc.js";
import { s as resolveDefaultModelForAgent } from "./model-selection-D0756MDv.js";
import { i as isSubagentRecoveryWedgedEntry, r as formatSubagentRecoveryWedgedReason, t as clearWedgedSubagentRecoveryAbort } from "./subagent-recovery-state-Chw_zLIZ.js";
import "./selection-BMP-JCML.js";
import { n as isHeartbeatOkResponse, r as isHeartbeatUserMessage } from "./heartbeat-filter-B34UDSwJ.js";
import { n as resolveHeartbeatIntervalMs } from "./heartbeat-summary-CA3EsP9j.js";
import { f as listConfiguredChannelIdsForReadOnlyScope } from "./channel-plugin-ids-Di5PV7SC.js";
import { t as resolveHeartbeatDeliveryTarget } from "./targets-BH4keFNV.js";
import { t as resolveOpenClawAgentDir } from "./agent-dir-compat-DQ3Fa3iX.js";
import { t as note } from "./note-C22zwxbl.js";
import { t as resolveMemoryBackendConfig } from "./backend-config-MmRfrnn9.js";
import "./engine-storage-Dkl2KcXA.js";
import { a as listPluginDoctorSessionRouteStateOwners } from "./doctor-contract-registry-KH-hcLvl.js";
...
function scanEntryForOwner(params) {
	...
	if (!routeAllowsOwner && !explicitOwnedOverride) {
		...
		const runtimeRef = runtimeModel ? parseModelRef(runtimeModel, normalizeOptionalString(params.entry.modelProvider) ?? "", {
			allowManifestNormalization: false,
			allowPluginNormalization: false
		}) : null;
...
async function runPluginSessionStateDoctorRepairs(params) {
	...
	for (const [sessionKey, entry] of Object.entries(params.store)) {
		if (!entry || typeof entry !== "object") continue;
		if (!entryMayContainPluginSessionRouteState(entry)) continue;
...
async function noteStateIntegrity(cfg, prompter, configPath) {
	...
	if (entries.length > 0) {
		...
		if (wedgedSubagentSessions.length > 0) {
			...
			const visibleWedgedReasons = uniqueStrings(wedgedSubagentSessions.map(([, entry]) => formatSubagentRecoveryWedgedReason(entry))).slice(0, 2);
