import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-ZfrS0ZQr.js";
import { r as loadCrestodianOverview } from "./overview-CgKSbQHD.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-D55VJXzJ.js")).planCrestodianCommand)({
		input,
		overview
	});
