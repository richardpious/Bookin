...
import { n as transformMessages, o as calculateCost, s as clampThinkingLevel, t as sanitizeSurrogates } from "./sanitize-unicode-8KnR9CZq.js";
import { n as parseStreamingJson } from "./json-parse-BXBkuUPf.js";
import { t as headersToRecord } from "./headers-BBHQnTYI.js";
import { i as resolveOpenAIStrictToolSetting, n as normalizeOpenAIStrictToolParameters, r as resolveOpenAIStrictToolFlagForInventory, t as findOpenAIStrictToolSchemaDiagnostics } from "./openai-tool-schema-Degohoda.js";
...
function convertResponsesTools(tools, options) {
	const strict = resolveResponsesStrictToolFlag(tools, resolveResponsesStrictToolSetting(options), options?.model);
...
function resolveResponsesStrictToolFlag(tools, strictSetting, model) {
...
function applyCommonResponsesParams(params, model, context, options, config) {
	...
	if (context.tools && context.tools.length > 0) params.tools = convertResponsesTools(context.tools, { model });
...
//#endregion
export { resolveResponsesReasoningEffort as a, processResponsesStream as i, convertResponsesMessages as n, runResponsesStreamLifecycle as o, createResponsesAssistantOutput as r, convertResponsesTools as s, applyCommonResponsesParams as t };
