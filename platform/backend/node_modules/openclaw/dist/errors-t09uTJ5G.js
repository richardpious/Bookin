...
import { _ as isRateLimitErrorMessage, a as formatTransportErrorCopy, b as matchesFormatErrorPattern, c as isLikelyHttpErrorText, f as isAuthErrorMessage, g as isPeriodicUsageLimitErrorMessage, h as isOverloadedErrorMessage, i as formatRateLimitOrOverloadedErrorCopy, l as isRawApiErrorPayload, m as isBillingErrorMessage, n as formatBillingErrorMessage, p as isAuthPermanentErrorMessage, r as formatDiskSpaceErrorCopy, s as isInvalidStreamingEventOrderError, u as isStreamingJsonParseError, v as isServerErrorMessage, x as formatExecDeniedUserMessage, y as isTimeoutErrorMessage } from "./sanitize-user-facing-text-CY8fNjm7.js";
import { n as classifyOAuthRefreshFailure } from "./oauth-refresh-failure-Cv2MCfJA.js";
import { t as formatSandboxToolPolicyBlockedMessage } from "./runtime-status-BQYHVOio.js";
...
function classifyFailoverClassificationFromHttpStatus(status, message, messageClassification, explicitStatus, provider) {
...
function classifyFailoverSignal(signal) {
	...
	const statusClassification = classifyFailoverClassificationFromHttpStatus(inferredStatus, signal.message, messageClassification, signal.status, signal.provider);
...
function formatAssistantErrorText(msg, opts) {
	...
	if (isOpenRouterKeyLimitExceededError(raw, opts?.provider) || isOpenRouterKeyBudgetLimitExceededError(raw, opts?.provider)) return formatBillingErrorMessage(opts?.provider, opts?.model ?? msg.model);
	if (isBilling429MessageForProvider(raw, opts?.provider)) return formatBillingErrorMessage(opts?.provider, opts?.model ?? msg.model);
...
//#endregion
export { isModelNotFoundErrorMessage as C, parseImageSizeError as S, isRateLimitAssistantError as _, formatAssistantErrorText as a, isUnclassifiedNoBodyHttpSignal as b, isBillingAssistantError as c, isContextOverflowError as d, isFailoverAssistantError as f, isLikelyContextOverflowError as g, isImageSizeError as h, extractObservedOverflowTokenCount as i, isCloudCodeAssistFormatError as l, isImageDimensionErrorMessage as m, classifyFailoverSignal as n, inferSignalStatus as o, isFailoverErrorMessage as p, classifyProviderRuntimeFailureKind as r, isAuthAssistantError as s, classifyFailoverReason as t, isCompactionFailureError as u, isReasoningConstraintErrorMessage as v, parseImageDimensionError as x, isTransientHttpError as y };
