...
import { a as normalizeStateDirEnv, d as resolveGatewayPort, t as CONFIG_PATH, y as resolveStateDir } from "./paths-BQQu4M8v.js";
...
import { i as GATEWAY_SERVICE_RUNTIME_PID_ENV } from "./constants-BOOZFRBo.js";
import { n as defaultRuntime } from "./runtime-yzlkhCoS.js";
import { r as setVerbose } from "./global-state-BAD7XgmL.js";
import { c as setConsoleTimestampPrefix, s as setConsoleSubsystemFilter } from "./console-B-lIqwpI.js";
import { t as createSubsystemLogger } from "./subsystem-Blo0_rG4.js";
import "./globals-Dc2qfZst.js";
import { t as isContainerEnvironment } from "./container-environment-CNsJSTpY.js";
import { i as isLoopbackHost, p as resolveGatewayBindHost, t as defaultGatewayBindMode } from "./net-ziAus6sd.js";
...
import { a as markGatewayRestartTrace, f as startGatewayRestartTrace, o as measureGatewayRestartTrace, r as createGatewayRestartTraceHandoffEnv, t as captureGatewayRestartTraceHandoff } from "./restart-trace-CgBhUjAl.js";
import { r as withProgress } from "./progress-Dr4m3lDw.js";
import { n as setGatewayWsLogStyle } from "./ws-logging-zK0zdycs.js";
import { n as acquireGatewayLock, t as GatewayLockError } from "./gateway-lock-CQtNAMgg.js";
...
async function resolveGatewayPasswordOption(opts) {
	...
	if (file) {
		const { readSecretFromFile } = await import("./secret-file-Dq8Zkv6t.js");
...
async function maybeLogPendingControlUiBuild(cfg) {
	...
	const { resolveControlUiRootSync } = await import("./control-ui-assets-Bk1l-grI.js");
...
async function maybeWriteGatewayStartupFailureBundle(err) {
	const { writeDiagnosticStabilityBundleForFailureSync } = await import("./diagnostic-stability-bundle-wBCOrm7K.js");
...
async function runGatewayCommand(opts) {
	...
	const { startGatewayServer } = await startupTrace.measure("cli.server-import", () => withProgress({
		...
		indeterminate: true
	}, async () => import("./server-ZL6kYTnQ.js")));
	setConsoleTimestampPrefix(true);
	if (devMode) {
		const { ensureDevGatewayConfig } = await import("./dev-CggcnHuS.js");
	...
	const { formatFutureConfigActionBlock, resolveFutureConfigActionBlock } = await import("./future-version-guard-B8MlHIvY.js");
	...
	if (process.env.OPENCLAW_SERVICE_MARKER?.trim()) {
		const { cleanStaleGatewayProcessesSync } = await import("./restart-stale-pids-VD5tiCJc.js");
	...
	if (opts.force) try {
		const { forceFreePortAndWait, waitForPortBindable } = await import("./ports-CA7IYKMR.js");
	...
	const { resolveGatewayAuth } = await import("./auth-Bx427-s6.js");
	...
	const { detectRespawnSupervisor } = await import("./supervisor-markers-DXJHn5iz.js");
	...
	try {
		...
		if (isGatewayLockError(err)) {
			...
			try {
				const { formatPortDiagnostics, inspectPortUsage } = await import("./ports-V6YQgoDY.js");
				const diagnostics = await inspectPortUsage(port);
				if (diagnostics.status === "busy") for (const line of formatPortDiagnostics(diagnostics)) defaultRuntime.error(line);
			} catch {}
			const { maybeExplainGatewayServiceStop } = await import("./shared-BFA2hp0P.js");
