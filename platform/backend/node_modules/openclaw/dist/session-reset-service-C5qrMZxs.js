...
import { Ri as ErrorCodes, zi as errorShape } from "./src-S72EdpgG.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-BdHeqZIb.js";
...
import { d as updateSessionStore, v as snapshotSessionOrigin } from "./store-Dh6bWvq_.js";
import { t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-CilBPi5j.js";
import { a as canonicalizeAbsoluteSessionFilePath, o as rewriteSessionFileForNewSessionId } from "./sessions-BN2mnV-J.js";
import "./transcript-jsonl-LFU2CQ2E.js";
import { r as runPluginHostCleanup } from "./host-hook-cleanup-DRSlHZi5.js";
import { t as getAcpSessionManager } from "./manager-B_67Qu_1.js";
import { t as getAcpRuntimeBackend } from "./registry-CW2kP1J3.js";
import { i as upsertAcpSessionMeta, n as readAcpSessionEntry } from "./session-meta-BT3CQM3r.js";
import { S as waitForEmbeddedAgentRunEnd, n as abortEmbeddedAgentRun } from "./runs-DMxJUP3Q.js";
import { l as readSessionMessagesAsync } from "./session-utils.fs-clE0lv0B.js";
import { o as resolveStableSessionEndTranscript, r as archiveSessionTranscriptsDetailed } from "./session-transcript-files.fs-WFl2ftAf.js";
import { c as loadSessionEntry, l as migrateAndPruneGatewaySessionStoreKey, m as resolveGatewaySessionStoreTarget, v as resolveSessionModelRef } from "./session-utils-CpM0p9QS.js";
import { n as getSessionBindingService } from "./session-binding-service-DInWFDrJ.js";
import { u as retireSessionMcpRuntime } from "./agent-bundle-mcp-runtime-n24dxm4C.js";
import "./agent-bundle-mcp-tools-DYx8xrZZ.js";
import { t as clearBootstrapSnapshot } from "./bootstrap-cache-Bjoff5B-.js";
import { t as clearAllCliSessions } from "./cli-session-BhuUNiMB.js";
import "./embedded-agent-DqJgypM_.js";
import { i as stopSubagentsForRequester } from "./abort-Dt8gPfFo.js";
import { a as buildSessionStartHookPayload, i as buildSessionEndHookPayload, n as listActiveSessionsForShutdown, r as noteActiveSessionForShutdown, t as forgetActiveSessionForShutdown } from "./active-sessions-shutdown-tracker-BelNJLOw.js";
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-DV-WiXab.js";
import { t as closeTrackedBrowserTabsForSessions } from "./browser-maintenance-CbZUzwjg.js";
...
async function closeChildAcpRuntimesForParent(params) {
	...
	await Promise.allSettled(children.map(({ sessionKey, entry }) => closeAcpRuntimeForSession({
		cfg: params.cfg,
		sessionKey,
		entry,
		reason: params.reason
