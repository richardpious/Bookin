...
// Launch RTL Testbench from Booksim
/*  cout << "Launching RTL simulation via QuestaSim..." << endl;
  int rtl_status = system("../../tb/run_questa.sh");
  if (rtl_status != 0) {
    cerr << "Error: RTL simulation failed to launch or crashed." << endl;
    return -1;
  } */
