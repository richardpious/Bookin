---
name: "update-file-preview-tool-functionality"
description: "Update file-preview SKILL.md to reflect that file_path is used instead of passing data."
---
...
- `file_path`: Absolute path to the file to be previewed. (Note: Data is no longer passed directly; only the file path is required).
