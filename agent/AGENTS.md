...
- **Running Simulations**: Before running simulation, create the appropriate folder in `../logs/<username>/<session>/run_<n>` and place/write the complete, finalized config file for the simulation there. Do NOT use existing config files as a crutch or show base configs asking "how about we edit this".
