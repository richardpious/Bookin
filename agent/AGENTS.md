...
- **Running Simulations**: Before running simulation, create the appropriate folder in the `../logs/<username>/<session>` folder and copy the config file which is used for the simulation to there.
