...
- **Running Simulations**: Before running simulation, create the approppriate folder in the `../logs/<session>` folder and copy the config file which is used for the simulation to there.
