  ...
  tools: (tool) => [
    tool({
      ...
      parameters: typebox_exports.Object({
        config_filepath: typebox_exports.String({ description: "Path to the prepared configuration (.cfg) file." }),
        run_descriptor: typebox_exports.String({ description: "Unique identifier/descriptor for the run folder (e.g. mesh4x4_uniform, rate0.05)." }),
        session_path: typebox_exports.Optional(typebox_exports.String({ description: "User and session path (e.g. richard/topologies). Defaults to default/session if omitted." }))
      }),
        ...
        try {
          ...
          try {
            ...
            try {
              ...
              logErrorSnippet = logContent2.slice(-1500);
